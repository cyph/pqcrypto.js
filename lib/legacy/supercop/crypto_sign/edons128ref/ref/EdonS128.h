...
#define ProjectionDim 64
#define BinarySpan 8
#define ErrorBasisDimension 4
#define mu 3

#define CorruptedCError 2
#define VerificationFailureError 1
...
struct SignatureStruct {
    Kelt    Cbase[mu + 1 + ErrorBasisDimension];
    unsigned char index[NrColumns];
    unsigned char M[crypto_hash_sha256_BYTES];
};
...
/* A global variable for the public key */
/* Workaround the API restriction the function */
/* crypto_sign( ) not to have public key as an argument */ 
