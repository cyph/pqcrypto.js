...
/* To know the number of roots of F */
...
#define findRoots_gf2nx PREFIX_NAME(findRoots_gf2nx)

int PREFIX_NAME(findRootsHFE_gf2nx)(vec_gf2n* root, const complete_sparse_monic_gf2nx F, cst_gf2n U);
