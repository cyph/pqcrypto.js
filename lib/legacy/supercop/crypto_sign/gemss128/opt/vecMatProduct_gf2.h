...
/* (1,n+v)*(n+v,n+v) */
void PREFIX_NAME(vecMatProductnv_64)(vecnv_gf2 res, cst_vecnv_gf2 vec, cst_Mnv_gf2 S);
/* (1,n+v)*(n+v,n) */
void PREFIX_NAME(vecMatProductnvn_64)(vecn_gf2 res, cst_vecnv_gf2 vec, cst_Mnv_n_gf2 S);
/* (1,v)*(v,n) */
void PREFIX_NAME(vecMatProductv_64)(vecn_gf2 res, cst_vecv_gf2 vec, cst_Mv_n_gf2 S);
/* (1,n)*(n,n) */
void PREFIX_NAME(vecMatProductn_64)(vecn_gf2 res, cst_vecv_gf2 vec, cst_Mv_n_gf2 S);
/* (1,n)*(n,n) but the result is (1,m) with m <= n */
void PREFIX_NAME(vecMatProductm_64)(vecn_gf2 res, cst_vecv_gf2 vec, cst_Mv_n_gf2 S);
