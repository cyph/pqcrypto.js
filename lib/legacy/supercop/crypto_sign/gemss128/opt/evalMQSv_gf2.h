...
void PREFIX_NAME(evalMQSv_classical_gf2)(vecm_gf2 c, cst_vecnv_gf2 m, cst_mqsnv_gf2m pk);
#define evalMQSv_classical_gf2 PREFIX_NAME(evalMQSv_classical_gf2)

#if (HFEv>2)
    void PREFIX_NAME(evalMQSv_unrolled_gf2)(vecm_gf2 c, cst_vecnv_gf2 m, cst_mqsnv_gf2m pk);
