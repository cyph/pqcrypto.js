...
const UINT64 rho56[2] = {0x0007060504030201, 0x080F0E0D0C0B0A09};
    #endif
    #define STORE128(a, b)      _mm_storeu_si128((V128 *)&(a), b)
...
#define copyFromStateAndXor1344bits(X, state, input) \
    X##ba = XOR128(LOAD128(state[ 0]), LOAD128u(input[ 0])); \
    X##be = XOR128(LOAD128(state[ 1]), LOAD128u(input[ 1])); \
    X##bi = XOR128(LOAD128(state[ 2]), LOAD128u(input[ 2])); \
    X##bo = XOR128(LOAD128(state[ 3]), LOAD128u(input[ 3])); \
    X##bu = XOR128(LOAD128(state[ 4]), LOAD128u(input[ 4])); \
    X##ga = XOR128(LOAD128(state[ 5]), LOAD128u(input[ 5])); \
    X##ge = XOR128(LOAD128(state[ 6]), LOAD128u(input[ 6])); \
    X##gi = XOR128(LOAD128(state[ 7]), LOAD128u(input[ 7])); \
    X##go = XOR128(LOAD128(state[ 8]), LOAD128u(input[ 8])); \
    X##gu = XOR128(LOAD128(state[ 9]), LOAD128u(input[ 9])); \
    X##ka = XOR128(LOAD128(state[10]), LOAD128u(input[10])); \
    X##ke = XOR128(LOAD128(state[11]), LOAD128u(input[11])); \
    X##ki = XOR128(LOAD128(state[12]), LOAD128u(input[12])); \
    X##ko = XOR128(LOAD128(state[13]), LOAD128u(input[13])); \
    X##ku = XOR128(LOAD128(state[14]), LOAD128u(input[14])); \
    X##ma = XOR128(LOAD128(state[15]), LOAD128u(input[15])); \
    X##me = XOR128(LOAD128(state[16]), LOAD128u(input[16])); \
    X##mi = XOR128(LOAD128(state[17]), LOAD128u(input[17])); \
    X##mo = XOR128(LOAD128(state[18]), LOAD128u(input[18])); \
    X##mu = XOR128(LOAD128(state[19]), LOAD128u(input[19])); \
    X##sa = XOR128(LOAD128(state[20]), LOAD128u(input[20])); \
