...
#define gf2x_mul_base  CRYPTO_NAMESPACE(gf2x_mul_base)
#define gf2x_sqr  CRYPTO_NAMESPACE(gf2x_sqr)
#define gf2x_mod_sqr_in_place  CRYPTO_NAMESPACE(gf2x_mod_sqr_in_place)
#define k_squaring  CRYPTO_NAMESPACE(k_squaring)
#endif
