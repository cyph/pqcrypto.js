...
#define MODCOEFFS {0, 2, 4, 7, 59} //List of "1" coefficients in the polynomial defining the ideal
...
#define FFI_VEC_R_BYTES 107 /**< Number of bytes required to store an NTL vector of size r */
#define FFI_VEC_N_BYTES 790 /**< Number of bytes required to store an NTL vector of size n */
