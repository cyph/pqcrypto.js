...
#define get_seeds  CRYPTO_NAMESPACE(get_seeds)
#define sample_uniform_r_bits  CRYPTO_NAMESPACE(sample_uniform_r_bits)
#define generate_sparse_rep  CRYPTO_NAMESPACE(generate_sparse_rep)
#define generate_error_vector  CRYPTO_NAMESPACE(generate_error_vector)
#define secure_set_bits  CRYPTO_NAMESPACE(seture_set_bits)
#endif
