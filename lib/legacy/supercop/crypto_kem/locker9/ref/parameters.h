...
#define PARAM_M 109 /**< Parameter m of the scheme (finite field GF(2^m)) */
#define PARAM_N 157 /**< Parameter n of the scheme (code length) */
#define PARAM_D 9 /**< Parameter d of the scheme (weight of vectors) */
...
#define MODCOEFFS {7, 9, 10} //List of "1" coefficients in the polynomial defining the ideal
