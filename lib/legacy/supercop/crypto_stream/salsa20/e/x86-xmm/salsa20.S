...
# qhasm: enter crypto_stream_salsa20_e_x86_xmm_ECRYPT_keystream_bytes
.text
.p2align 5
.globl _crypto_stream_salsa20_e_x86_xmm_ECRYPT_keystream_bytes
.globl crypto_stream_salsa20_e_x86_xmm_ECRYPT_keystream_bytes
_crypto_stream_salsa20_e_x86_xmm_ECRYPT_keystream_bytes:
crypto_stream_salsa20_e_x86_xmm_ECRYPT_keystream_bytes:
mov %esp,%eax
and $31,%eax
add $96,%eax
sub %eax,%esp
...
# qhasm: enter crypto_stream_salsa20_e_x86_xmm_ECRYPT_decrypt_bytes
.text
.p2align 5
.globl _crypto_stream_salsa20_e_x86_xmm_ECRYPT_decrypt_bytes
.globl crypto_stream_salsa20_e_x86_xmm_ECRYPT_decrypt_bytes
_crypto_stream_salsa20_e_x86_xmm_ECRYPT_decrypt_bytes:
crypto_stream_salsa20_e_x86_xmm_ECRYPT_decrypt_bytes:
mov %esp,%eax
and $31,%eax
add $96,%eax
sub %eax,%esp
...
# qhasm: enter crypto_stream_salsa20_e_x86_xmm_ECRYPT_encrypt_bytes
.text
.p2align 5
.globl _crypto_stream_salsa20_e_x86_xmm_ECRYPT_encrypt_bytes
.globl crypto_stream_salsa20_e_x86_xmm_ECRYPT_encrypt_bytes
_crypto_stream_salsa20_e_x86_xmm_ECRYPT_encrypt_bytes:
...
# qhasm: enter crypto_stream_salsa20_e_x86_xmm_ECRYPT_init
.text
.p2align 5
.globl _crypto_stream_salsa20_e_x86_xmm_ECRYPT_init
.globl crypto_stream_salsa20_e_x86_xmm_ECRYPT_init
_crypto_stream_salsa20_e_x86_xmm_ECRYPT_init:
crypto_stream_salsa20_e_x86_xmm_ECRYPT_init:
mov %esp,%eax
and $31,%eax
add $96,%eax
sub %eax,%esp
...
# qhasm: enter crypto_stream_salsa20_e_x86_xmm_ECRYPT_keysetup
.text
.p2align 5
.globl _crypto_stream_salsa20_e_x86_xmm_ECRYPT_keysetup
.globl crypto_stream_salsa20_e_x86_xmm_ECRYPT_keysetup
_crypto_stream_salsa20_e_x86_xmm_ECRYPT_keysetup:
...
# qhasm: enter crypto_stream_salsa20_e_x86_xmm_ECRYPT_ivsetup
.text
.p2align 5
.globl _crypto_stream_salsa20_e_x86_xmm_ECRYPT_ivsetup
.globl crypto_stream_salsa20_e_x86_xmm_ECRYPT_ivsetup
_crypto_stream_salsa20_e_x86_xmm_ECRYPT_ivsetup:
