...
void setup_update(crypto_stream_hc128_e_hc_128_200701b_ECRYPT_ctx* ctx)  /*each time 16 steps*/
{
   u32 cc,dd;
   cc = ctx->counter1024 & 0x1ff;
   dd = (cc+16)&0x1ff;
...
void crypto_stream_hc128_e_hc_128_200701b_ECRYPT_ivsetup(crypto_stream_hc128_e_hc_128_200701b_ECRYPT_ctx* ctx, const u8* iv)
{ 
    u32 i;
