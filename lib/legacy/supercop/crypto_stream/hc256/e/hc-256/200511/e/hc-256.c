...
void setup_update(crypto_stream_hc256_e_hc_256_200511_ECRYPT_ctx* ctx)  /*each time 16 steps*/
{
   u32 cc,dd;
   cc = ctx->counter2048 & 0x3ff;
   dd = (cc+16)&0x3ff;
...
void crypto_stream_hc256_e_hc_256_200511_ECRYPT_ivsetup(crypto_stream_hc256_e_hc_256_200511_ECRYPT_ctx* ctx, const u8* iv)
{ 
    u32 i;
