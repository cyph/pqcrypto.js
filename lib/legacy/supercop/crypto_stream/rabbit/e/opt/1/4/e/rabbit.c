...
/* File name: rabbit.c                                                        */
/*----------------------------------------------------------------------------*/
/* Rabbit C source code in crypto_stream_rabbit_e_opt_1_4_ECRYPT format                                      */
/*----------------------------------------------------------------------------*/
...
#if defined(_MSC_VER) && defined(_M_IX86) && (crypto_stream_rabbit_e_opt_1_4_ECRYPT_VARIANT > 2)
...
#elif defined(__GNUC__) && defined(__i386__) && (crypto_stream_rabbit_e_opt_1_4_ECRYPT_VARIANT > 2)
   /* COMPILER : GCC */
   /* PROCESSOR: x86 */

   #if (crypto_stream_rabbit_e_opt_1_4_ECRYPT_VARIANT > 3)
      #define RABBIT_NS_VARS \
...
#elif (crypto_stream_rabbit_e_opt_1_4_ECRYPT_VARIANT > 1) && defined(I64T)
...
/* Key setup */
void crypto_stream_rabbit_e_opt_1_4_ECRYPT_keysetup(crypto_stream_rabbit_e_opt_1_4_ECRYPT_ctx* ctx, const u8* key, u32 keysize, u32 ivsize)
{
   /* Temporary variables */
   u32 k0, k1, k2, k3, i;
   RABBIT_NS_VARS
...
/* IV setup */
void crypto_stream_rabbit_e_opt_1_4_ECRYPT_ivsetup(crypto_stream_rabbit_e_opt_1_4_ECRYPT_ctx* ctx, const u8* iv)
{
   /* Temporary variables */
   u32 i0, i1, i2, i3, i;
   RABBIT_NS_VARS
...
void crypto_stream_rabbit_e_opt_1_4_ECRYPT_process_bytes(int action, crypto_stream_rabbit_e_opt_1_4_ECRYPT_ctx* ctx, const u8* input, 
...
/* Generate keystream */
void crypto_stream_rabbit_e_opt_1_4_ECRYPT_keystream_bytes(crypto_stream_rabbit_e_opt_1_4_ECRYPT_ctx* ctx, u8* keystream, u32 length)
{
   /* Temporary variables */
   u32 i;
   u8 buffer[16];
...
void crypto_stream_rabbit_e_opt_1_4_ECRYPT_process_blocks(int action, crypto_stream_rabbit_e_opt_1_4_ECRYPT_ctx* ctx, const u8* input, 
