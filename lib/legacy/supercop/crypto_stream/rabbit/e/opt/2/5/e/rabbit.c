...
/* File name: rabbit.c                                                        */
/*----------------------------------------------------------------------------*/
/* Rabbit C optimized source code in crypto_stream_rabbit_e_opt_2_5_ECRYPT format                            */
/*----------------------------------------------------------------------------*/
...
#if (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 4) && !(defined(RABBIT_GCC) || defined(RABBIT_MSC))
#error this variant does not compile on this platform
#endif

/* -------------------------------------------------------------------------- */
/* 32-bit G function macros */
/* Used in crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT 1 */
...
/* Used in crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT 2 */
...
#if defined(RABBIT_MSC) && (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 2)
...
#elif defined(RABBIT_GCC) && (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 2)
   /* COMPILER : GCC */
   /* PROCESSOR: x86 */

   #if (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 2)
      #define RABBIT_NS_VARS \
...
//   #if (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 3)
...
#elif (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 1) && defined(I64T)
...
#if defined(RABBIT_MSC) && (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 3)
   /* COMPILER : MICROSOFT OR INTEL */
   /* PROCESSOR: x86 */
...
#elif defined(RABBIT_GCC) && (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 4)
   /* COMPILER : GCC */
   /* PROCESSOR: x86 */
...
/* Key setup */
void crypto_stream_rabbit_e_opt_2_5_ECRYPT_keysetup(crypto_stream_rabbit_e_opt_2_5_ECRYPT_ctx* ctx, const u8* key, u32 keysize, u32 ivsize)
{
   /* Temporary variables */
   u32 k0, k1, k2, k3;
#if crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT < 5
   u32 i;
#endif
   RABBIT_NS_VARS
...
#if ((defined(RABBIT_MSC)) || defined(RABBIT_GCC)) && (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT > 4)
...
/* IV setup */
void crypto_stream_rabbit_e_opt_2_5_ECRYPT_ivsetup(crypto_stream_rabbit_e_opt_2_5_ECRYPT_ctx* ctx, const u8* iv)
{
   /* Temporary variables */
   u32 i0, i1, i2, i3;
#if (crypto_stream_rabbit_e_opt_2_5_ECRYPT_VARIANT < 5) || !((defined(RABBIT_MSC)))
   u32 i;
   RABBIT_NS_VARS
#endif
   RABBIT_ctx *p_instance;
...
void crypto_stream_rabbit_e_opt_2_5_ECRYPT_process_bytes(int action, crypto_stream_rabbit_e_opt_2_5_ECRYPT_ctx* ctx, const u8* input, 
          u8* output, u32 msglen)
{
   u32 i;
   u8 buffer[16];
   /* crypto_stream_rabbit_e_opt_2_5_ECRYPT_ctx* temp = ctx; */
...
/* Generate keystream */
void crypto_stream_rabbit_e_opt_2_5_ECRYPT_keystream_bytes(crypto_stream_rabbit_e_opt_2_5_ECRYPT_ctx* ctx, u8* keystream, u32 length)
{
   /* Temporary variables */
   u32 i;
   u8 buffer[16];
...
void crypto_stream_rabbit_e_opt_2_5_ECRYPT_process_blocks(int action, crypto_stream_rabbit_e_opt_2_5_ECRYPT_ctx* ctx, const u8* input, 
