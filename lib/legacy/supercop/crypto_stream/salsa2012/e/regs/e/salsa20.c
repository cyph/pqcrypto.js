...
void crypto_stream_salsa2012_e_regs_ECRYPT_init(void)
{
  return;
}
...
void crypto_stream_salsa2012_e_regs_ECRYPT_keysetup(crypto_stream_salsa2012_e_regs_ECRYPT_ctx *x,const u8 *k,u32 kbits,u32 ivbits)
{
...
void crypto_stream_salsa2012_e_regs_ECRYPT_ivsetup(crypto_stream_salsa2012_e_regs_ECRYPT_ctx *x,const u8 *iv)
{
...
void crypto_stream_salsa2012_e_regs_ECRYPT_encrypt_bytes(crypto_stream_salsa2012_e_regs_ECRYPT_ctx *x,const u8 *m,u8 *c,u32 bytes)
{
  u8 output[64];
  int i;
...
void crypto_stream_salsa2012_e_regs_ECRYPT_decrypt_bytes(crypto_stream_salsa2012_e_regs_ECRYPT_ctx *x,const u8 *c,u8 *m,u32 bytes)
{
  crypto_stream_salsa2012_e_regs_ECRYPT_encrypt_bytes(x,c,m,bytes);
}

void crypto_stream_salsa2012_e_regs_ECRYPT_keystream_bytes(crypto_stream_salsa2012_e_regs_ECRYPT_ctx *x,u8 *stream,u32 bytes)
{
  u32 i;
  for (i = 0;i < bytes;++i) stream[i] = 0;
  crypto_stream_salsa2012_e_regs_ECRYPT_encrypt_bytes(x,stream,stream,bytes);
}
