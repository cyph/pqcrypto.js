...
void aes128_enc_block(u32* x,u8* output, crypto_stream_aes128estream_e_hongjun_v0_ECRYPT_ctx* ctx) {
	u32 y0,y1,y2,y3;
	u32 z0,z1,z2,z3;
	u32 a0,a1,a2,a3;
	u32 b0,b1,b2,b3;
...
void partial_precompute_tworounds(crypto_stream_aes128estream_e_hongjun_v0_ECRYPT_ctx* ctx)
{
