...
This file provides an implementation for Lilliput-TBC where the encryption
process generates sub-tweakeys on the fly for each round. This saves on RAM
since it avoids storing all subtweakeys.
*/
