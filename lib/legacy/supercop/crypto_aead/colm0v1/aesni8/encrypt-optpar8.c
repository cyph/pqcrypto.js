 ...
 * for pipeline depth 8 (Sandy Bridge, Haswell, ...)
 *
 * colm@colm.ae
 */
...
#define AES_DECRYPT8(block1,block2,block3,block4,block5,block6,block7,block8,expkey) do { \
	int r; \
	BSWAP_BLOCKS8(block1,block2,block3,block4,block5,block6,block7,block8); \
	block1 ^=  expkey[0]; \
	block2 ^=  expkey[0]; \
	...
	for(r = 1; r < 10; r++){ \
		...
		block3 = _mm_aesdec_si128 (block3,expkey[r]); \
		block4 = _mm_aesdec_si128 (block4,expkey[r]); \
		block5 = _mm_aesdec_si128 (block5, expkey[r]); \
		block6 = _mm_aesdec_si128 (block6, expkey[r]); \
		block7 = _mm_aesdec_si128 (block7, expkey[r]); \
		block8 = _mm_aesdec_si128 (block8, expkey[r]); \
	} \
	block1 = _mm_aesdeclast_si128 (block1,expkey[10]); \
	block2 = _mm_aesdeclast_si128 (block2,expkey[10]); \
	block3 = _mm_aesdeclast_si128 (block3,expkey[10]); \
	block4 = _mm_aesdeclast_si128 (block4,expkey[10]); \
	block5 = _mm_aesdeclast_si128 (block5 ,expkey[10]); \
	block6 = _mm_aesdeclast_si128 (block6 ,expkey[10]); \
	block7 = _mm_aesdeclast_si128 (block7 ,expkey[10]); \
	block8 = _mm_aesdeclast_si128 (block8 ,expkey[10]); \
	BSWAP_BLOCKS8(block1,block2,block3,block4,block5,block6,block7,block8); \
} while (0)
