...
var dilithium	= __webpack_require__(1);
...
var __dirname = "/";
var dilithium=function(){var A,I,g,B={};function C(A,I){if(0===A)return I;throw new Error("Dilithium error: "+A)}function Q(A,I){return new Uint8Array(new Uint8Array(B.HEAPU8.buffer,A,I))}function i(A){try{B._free(A)}catch(A){setTimeout((function(){throw A}),0)}}B.ready=new Promise((function(A,I){function g(A){return g="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(A){return typeof A}:function(A){return A&&"function"==typeof Symbol&&A.constructor===Symbol&&A!==Symbol.prototype?"symbol":typeof A},g(A)}(n={}).onAbort=I,n.onRuntimeInitialized=function(){try{n._dilithiumjs_public_key_bytes(),A(n)}catch(A){I(A)}};var B,C,Q,i,E,o,n=void 0!==n?n:{},t=Object.assign({},n),r=[],a=function(A,I){throw I},e="object"==("undefined"==typeof window?"undefined":g(window)),f="function"==typeof importScripts,D="object"==("undefined"==typeof process?"undefined":g(process))&&"object"==g(process.versions)&&"string"==typeof process.versions.node,c="";D?(c=f?eval("require")("path").dirname(c)+"/":__dirname+"/",o=function(){E||(i=eval("require")("fs"),E=eval("require")("path"))},B=function(A,I){var g=j(A);return g?I?g:g.toString():(o(),A=E.normalize(A),i.readFileSync(A,I?void 0:"utf8"))},Q=function(A){var I=B(A,!0);return I.buffer||(I=new Uint8Array(I)),I},C=function(A,I,g){var B=j(A);B&&I(B),o(),A=E.normalize(A),i.readFile(A,(function(A,B){A?g(A):I(B.buffer)}))},process.argv.length>1&&process.argv[1].replace(/\\/g,"/"),r=process.argv.slice(2), true&&(module.exports=n),process.on("uncaughtException",(function(A){if(!(A instanceof V))throw A})),process.on("unhandledRejection",(function(A){throw A})),a=function(A,I){if(U())throw process.exitCode=A,I;var g;(g=I)instanceof V||h("exiting due to exception: "+g),process.exit(A)},n.inspect=function(){return"[Emscripten Module object]"}):(e||f)&&(f?c=self.location.href:"undefined"!=typeof document&&document.currentScript&&(c=document.currentScript.src),c=0!==c.indexOf("blob:")?c.substr(0,c.replace(/[?#].*/,"").lastIndexOf("/")+1):"",B=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.send(null),I.responseText}catch(I){var g=j(A);if(g)return function(A){for(var I=[],g=0;g<A.length;g++){var B=A[g];B>255&&(B&=255),I.push(String.fromCharCode(B))}return I.join("")}(g);throw I}},f&&(Q=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.responseType="arraybuffer",I.send(null),new Uint8Array(I.response)}catch(I){var g=j(A);if(g)return g;throw I}}),C=function(A,I,g){var B=new XMLHttpRequest;B.open("GET",A,!0),B.responseType="arraybuffer",B.onload=function(){if(200==B.status||0==B.status&&B.response)I(B.response);else{var C=j(A);C?I(C.buffer):g()}},B.onerror=g,B.send(null)});n.print||console.log.bind(console);var G,h=n.printErr||console.warn.bind(console);Object.assign(n,t),t=null,n.arguments&&(r=n.arguments),n.thisProgram&&n.thisProgram,n.quit&&(a=n.quit),n.wasmBinary&&(G=n.wasmBinary);var y,s=n.noExitRuntime||!0;"object"!=("undefined"==typeof WebAssembly?"undefined":g(WebAssembly))&&J("no native wasm support detected");var u,F,w,Y,N=!1;n.INITIAL_MEMORY;var S=[],k=[],d=[];function U(){return s}var H=0,R=null,q=null;function J(A){throw n.onAbort&&n.onAbort(A),h(A="Aborted("+A+")"),N=!0,1,A+=". Build with -sASSERTIONS for more info.",new WebAssembly.RuntimeError(A)}var l,M,L="data:application/octet-stream;base64,";function m(A){return A.startsWith(L)}function p(A){return A.startsWith("file://")}function b(A){try{if(A==l&&G)return new Uint8Array(G);var I=j(A);if(I)return I;if(Q)return Q(A);throw"both async and sync fetching of the wasm failed"}catch(A){J(A)}}m(l="data:application/octet-stream;base64,")||(M=l,l=n.locateFile?n.locateFile(M,c):c+M);var K={2340:function(){return n.getRandomValue()},2376:function(){if(void 0===n.getRandomValue)try{var A="object"===("undefined"==typeof window?"undefined":g(window))?window:self,I=void 0!==A.crypto?A.crypto:A.msCrypto,B=function(){var A=new Uint32Array(1);return I.getRandomValues(A),A[0]>>>0};B(),n.getRandomValue=B}catch(A){try{var C=eval("require")("crypto"),Q=function(){var A=C.randomBytes(4);return(A[0]<<24|A[1]<<16|A[2]<<8|A[3])>>>0};Q(),n.getRandomValue=Q}catch(A){throw"No secure random number generator found"}}}};function v(A){for(;A.length>0;)A.shift()(n)}var O=[];var x="function"==typeof atob?atob:function(A){var I,g,B,C,Q,i,E="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",o="",n=0;A=A.replace(/[^A-Za-z0-9\+\/\=]/g,"");do{I=E.indexOf(A.charAt(n++))<<2|(C=E.indexOf(A.charAt(n++)))>>4,g=(15&C)<<4|(Q=E.indexOf(A.charAt(n++)))>>2,B=(3&Q)<<6|(i=E.indexOf(A.charAt(n++))),o+=String.fromCharCode(I),64!==Q&&(o+=String.fromCharCode(g)),64!==i&&(o+=String.fromCharCode(B))}while(n<A.length);return o};function j(A){if(m(A))return function(A){if("boolean"==typeof D&&D){var I=Buffer.from(A,"base64");return new Uint8Array(I.buffer,I.byteOffset,I.byteLength)}try{for(var g=x(A),B=new Uint8Array(g.length),C=0;C<g.length;++C)B[C]=g.charCodeAt(C);return B}catch(A){throw new Error("Converting base64 string to bytes failed.")}}(A.slice(L.length))}var W,T={b:function(A,I,g){var B=function(A,I){var g;for(O.length=0,I>>=2;g=F[A++];)I+=105!=g&I,O.push(105==g?w[I]:Y[I++>>1]),++I;return O}(I,g);return K[A].apply(null,B)},d:function(A,I,g){F.copyWithin(A,I,I+g)},c:function(A){F.length,J("OOM")},a:function(A){!function(A,I){A,function(A){A,U()||(n.onExit&&n.onExit(A),N=!0);a(A,new V(A))}(A)}(A)}};(function(){var A={a:T};function I(A,I){var g,B,C=A.exports;n.asm=C,y=n.asm.e,g=y.buffer,g,n.HEAP8=u=new Int8Array(g),n.HEAP16=new Int16Array(g),n.HEAP32=w=new Int32Array(g),n.HEAPU8=F=new Uint8Array(g),n.HEAPU16=new Uint16Array(g),n.HEAPU32=new Uint32Array(g),n.HEAPF32=new Float32Array(g),n.HEAPF64=Y=new Float64Array(g),n.asm.g,B=n.asm.f,k.unshift(B),function(A){if(H--,n.monitorRunDependencies&&n.monitorRunDependencies(H),0==H&&(null!==R&&(clearInterval(R),R=null),q)){var I=q;q=null,I()}}()}function g(A){I(A.instance)}function B(I){return function(){if(!G&&(e||f)){if("function"==typeof fetch&&!p(l))return fetch(l,{credentials:"same-origin"}).then((function(A){if(!A.ok)throw"failed to load wasm binary file at '"+l+"'";return A.arrayBuffer()})).catch((function(){return b(l)}));if(C)return new Promise((function(A,I){C(l,(function(I){A(new Uint8Array(I))}),I)}))}return Promise.resolve().then((function(){return b(l)}))}().then((function(I){return WebAssembly.instantiate(I,A)})).then((function(A){return A})).then(I,(function(A){h("failed to asynchronously prepare wasm: "+A),J(A)}))}if(H++,n.monitorRunDependencies&&n.monitorRunDependencies(H),n.instantiateWasm)try{return n.instantiateWasm(A,I)}catch(A){return h("Module.instantiateWasm callback failed with error: "+A),!1}G||"function"!=typeof WebAssembly.instantiateStreaming||m(l)||p(l)||D||"function"!=typeof fetch?B(g):fetch(l,{credentials:"same-origin"}).then((function(I){return WebAssembly.instantiateStreaming(I,A).then(g,(function(A){return h("wasm streaming compile failed: "+A),h("falling back to ArrayBuffer instantiation"),B(g)}))}))})(),n.___wasm_call_ctors=function(){return(n.___wasm_call_ctors=n.asm.f).apply(null,arguments)},n._malloc=function(){return(n._malloc=n.asm.h).apply(null,arguments)},n._free=function(){return(n._free=n.asm.i).apply(null,arguments)},n._dilithiumjs_init=function(){return(n._dilithiumjs_init=n.asm.j).apply(null,arguments)},n._dilithiumjs_public_key_bytes=function(){return(n._dilithiumjs_public_key_bytes=n.asm.k).apply(null,arguments)},n._dilithiumjs_secret_key_bytes=function(){return(n._dilithiumjs_secret_key_bytes=n.asm.l).apply(null,arguments)},n._dilithiumjs_signature_bytes=function(){return(n._dilithiumjs_signature_bytes=n.asm.m).apply(null,arguments)},n._dilithiumjs_keypair=function(){return(n._dilithiumjs_keypair=n.asm.n).apply(null,arguments)},n._dilithiumjs_sign=function(){return(n._dilithiumjs_sign=n.asm.o).apply(null,arguments)},n._dilithiumjs_verify=function(){return(n._dilithiumjs_verify=n.asm.p).apply(null,arguments)};function V(A){this.name="ExitStatus",this.message="Program terminated with exit("+A+")",this.status=A}function P(A){function I(){W||(W=!0,n.calledRun=!0,N||(!0,v(k),n.onRuntimeInitialized&&n.onRuntimeInitialized(),function(){if(n.postRun)for("function"==typeof n.postRun&&(n.postRun=[n.postRun]);n.postRun.length;)A=n.postRun.shift(),d.unshift(A);var A;v(d)}()))}A=A||r,H>0||(!function(){if(n.preRun)for("function"==typeof n.preRun&&(n.preRun=[n.preRun]);n.preRun.length;)A=n.preRun.shift(),S.unshift(A);var A;v(S)}(),H>0||(n.setStatus?(n.setStatus("Running..."),setTimeout((function(){setTimeout((function(){n.setStatus("")}),1),I()}),1)):I()))}if(n.writeArrayToMemory=function(A,I){u.set(A,I)},q=function A(){W||P(),W||(q=A)},n.run=P,n.preInit)for("function"==typeof n.preInit&&(n.preInit=[n.preInit]);n.preInit.length>0;)n.preInit.pop()();P()})).catch((function(){function A(I){return A="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(A){return typeof A}:function(A){return A&&"function"==typeof Symbol&&A.constructor===Symbol&&A!==Symbol.prototype?"symbol":typeof A},A(I)}var I,g,B,C,Q,i,E=void 0!==(E={})?E:{},o=Object.assign({},E),n=[],t=function(A,I){throw I},r="object"==("undefined"==typeof window?"undefined":A(window)),a="function"==typeof importScripts,e="object"==("undefined"==typeof process?"undefined":A(process))&&"object"==A(process.versions)&&"string"==typeof process.versions.node,f="";e?(f=a?eval("require")("path").dirname(f)+"/":__dirname+"/",i=function(){Q||(C=eval("require")("fs"),Q=eval("require")("path"))},I=function(A,I){var g=T(A);return g?I?g:g.toString():(i(),A=Q.normalize(A),C.readFileSync(A,I?void 0:"utf8"))},B=function(A){var g=I(A,!0);return g.buffer||(g=new Uint8Array(g)),g},g=function(A,I,g){var B=T(A);B&&I(B),i(),A=Q.normalize(A),C.readFile(A,(function(A,B){A?g(A):I(B.buffer)}))},process.argv.length>1&&process.argv[1].replace(/\\/g,"/"),n=process.argv.slice(2), true&&(module.exports=E),process.on("uncaughtException",(function(A){if(!(A instanceof X))throw A})),process.on("unhandledRejection",(function(A){throw A})),t=function(A,I){if(R())throw process.exitCode=A,I;var g;(g=I)instanceof X||c("exiting due to exception: "+g),process.exit(A)},E.inspect=function(){return"[Emscripten Module object]"}):(r||a)&&(a?f=self.location.href:"undefined"!=typeof document&&document.currentScript&&(f=document.currentScript.src),f=0!==f.indexOf("blob:")?f.substr(0,f.replace(/[?#].*/,"").lastIndexOf("/")+1):"",I=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.send(null),I.responseText}catch(I){var g=T(A);if(g)return function(A){for(var I=[],g=0;g<A.length;g++){var B=A[g];B>255&&(B&=255),I.push(String.fromCharCode(B))}return I.join("")}(g);throw I}},a&&(B=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.responseType="arraybuffer",I.send(null),new Uint8Array(I.response)}catch(I){var g=T(A);if(g)return g;throw I}}),g=function(A,I,g){var B=new XMLHttpRequest;B.open("GET",A,!0),B.responseType="arraybuffer",B.onload=function(){if(200==B.status||0==B.status&&B.response)I(B.response);else{var C=T(A);C?I(C.buffer):g()}},B.onerror=g,B.send(null)});E.print||console.log.bind(console);var D,c=E.printErr||console.warn.bind(console);Object.assign(E,o),o=null,E.arguments&&(n=E.arguments),E.thisProgram&&E.thisProgram,E.quit&&(t=E.quit),E.wasmBinary&&(D=E.wasmBinary);var G,h=E.noExitRuntime||!0,y={Memory:function(A){this.buffer=new ArrayBuffer(65536*A.initial)},Module:function(A){},Instance:function(A,I){this.exports=function(A){for(var I,g=new Uint8Array(123),B=25;B>=0;--B)g[48+B]=52+B,g[65+B]=B,g[97+B]=26+B;function C(A,I,B){for(var C,Q,i=0,E=I,o=B.length,n=I+(3*o>>2)-("="==B[o-2])-("="==B[o-1]);i<o;i+=4)C=g[B.charCodeAt(i+1)],Q=g[B.charCodeAt(i+2)],A[E++]=g[B.charCodeAt(i)]<<2|C>>4,E<n&&(A[E++]=C<<4|Q>>2),E<n&&(A[E++]=Q<<6|g[B.charCodeAt(i+3)])}return g[43]=62,g[47]=63,function(A){var g=A.a.buffer,B=new Int8Array(g),Q=new Int16Array(g),i=new Int32Array(g),E=new Uint8Array(g),o=new Uint16Array(g),n=new Uint32Array(g),t=(new Float32Array(g),new Float64Array(g),Math.imul),r=(Math.fround,Math.abs,Math.clz32,Math.min,Math.max,Math.floor,Math.ceil,Math.trunc,Math.sqrt,A.abort),a=A.b,e=A.c,f=A.d,D=8392208,c=0;function G(A){var I,g=0,B=0,C=0,Q=0,o=0,t=0,r=0,a=0,e=0,f=0;D=I=D-16|0;A:{I:{g:{B:{C:{Q:{i:{E:{o:{n:{t:{if((A|=0)>>>0<=244){if(3&(g=(Q=i[776])>>>(B=(r=A>>>0<11?16:A+11&-8)>>>3|0)|0)){g=(A=(B=B+(1&(-1^g))|0)<<3)+3144|0,C=i[A+3152>>2],(0|g)!=(0|(A=i[C+8>>2]))?(i[A+12>>2]=g,i[g+8>>2]=A):i[776]=QA(B)&Q,A=C+8|0,g=B<<3,i[C+4>>2]=3|g,i[(g=g+C|0)+4>>2]=1|i[g+4>>2];break A}if((f=i[778])>>>0>=r>>>0)break t;if(g){B=A=(g=(0-(A=(0-(A=2<<B)|A)&g<<B)&A)-1|0)>>>12&16,B|=A=(g=g>>>A|0)>>>5&8,B|=A=(g=g>>>A|0)>>>2&4,g=(A=(C=((B|=A=(g=g>>>A|0)>>>1&2)|(A=(g=g>>>A|0)>>>1&1))+(g>>>A|0)|0)<<3)+3144|0,t=i[A+3152>>2],(0|g)!=(0|(A=i[t+8>>2]))?(i[A+12>>2]=g,i[g+8>>2]=A):(Q=QA(C)&Q,i[776]=Q),i[t+4>>2]=3|r,C=(A=C<<3)-r|0,i[(B=t+r|0)+4>>2]=1|C,i[A+t>>2]=C,f&&(g=3144+(-8&f)|0,o=i[781],(A=1<<(f>>>3))&Q?A=i[g+8>>2]:(i[776]=A|Q,A=g),i[g+8>>2]=o,i[A+12>>2]=o,i[o+12>>2]=g,i[o+8>>2]=A),A=t+8|0,i[781]=B,i[778]=C;break A}if(!(e=i[777]))break t;for(B=A=(g=(0-e&e)-1|0)>>>12&16,B|=A=(g=g>>>A|0)>>>5&8,B|=A=(g=g>>>A|0)>>>2&4,B=i[3408+(((B|=A=(g=g>>>A|0)>>>1&2)|(A=(g=g>>>A|0)>>>1&1))+(g>>>A|0)<<2)>>2],o=(-8&i[B+4>>2])-r|0,g=B;(A=i[g+16>>2])||(A=i[g+20>>2]);)o=(C=(g=(-8&i[A+4>>2])-r|0)>>>0<o>>>0)?g:o,B=C?A:B,g=A;if(a=i[B+24>>2],(0|(C=i[B+12>>2]))!=(0|B)){A=i[B+8>>2],i[A+12>>2]=C,i[C+8>>2]=A;break I}if(!(A=i[(g=B+20|0)>>2])){if(!(A=i[B+16>>2]))break n;g=B+16|0}for(;t=g,C=A,(A=i[(g=A+20|0)>>2])||(g=C+16|0,A=i[C+16>>2]););i[t>>2]=0;break I}if(r=-1,!(A>>>0>4294967231)&&(r=-8&(A=A+11|0),e=i[777])){o=0-r|0,Q=0,r>>>0<256||(Q=31,r>>>0>16777215||(A=A>>>8|0,A<<=t=A+1048320>>>16&8,Q=28+((A=((A<<=B=A+520192>>>16&4)<<(g=A+245760>>>16&2)>>>15|0)-(g|B|t)|0)<<1|r>>>A+21&1)|0));r:{a:{if(g=i[3408+(Q<<2)>>2])for(A=0,B=r<<(31==(0|Q)?0:25-(Q>>>1|0)|0);;){if(!((t=(-8&i[g+4>>2])-r|0)>>>0>=o>>>0||(C=g,o=t))){o=0,A=g;break a}if(t=i[g+20>>2],g=i[16+((B>>>29&4)+g|0)>>2],A=t?(0|t)==(0|g)?A:t:A,B<<=1,!g)break}else A=0;if(!(A|C)){if(C=0,!(A=(0-(A=2<<Q)|A)&e))break t;B=A=(g=(A&0-A)-1|0)>>>12&16,B|=A=(g=g>>>A|0)>>>5&8,B|=A=(g=g>>>A|0)>>>2&4,A=i[3408+(((B|=A=(g=g>>>A|0)>>>1&2)|(A=(g=g>>>A|0)>>>1&1))+(g>>>A|0)<<2)>>2]}if(!A)break r}for(;o=(B=(g=(-8&i[A+4>>2])-r|0)>>>0<o>>>0)?g:o,C=B?A:C,A=(g=i[A+16>>2])||i[A+20>>2];);}if(!(!C|i[778]-r>>>0<=o>>>0)){if(Q=i[C+24>>2],(0|C)!=(0|(B=i[C+12>>2]))){A=i[C+8>>2],i[A+12>>2]=B,i[B+8>>2]=A;break g}if(!(A=i[(g=C+20|0)>>2])){if(!(A=i[C+16>>2]))break o;g=C+16|0}for(;t=g,B=A,(A=i[(g=A+20|0)>>2])||(g=B+16|0,A=i[B+16>>2]););i[t>>2]=0;break g}}}if((B=i[778])>>>0>=r>>>0){C=i[781],(g=B-r|0)>>>0>=16?(i[778]=g,A=C+r|0,i[781]=A,i[A+4>>2]=1|g,i[B+C>>2]=g,i[C+4>>2]=3|r):(i[781]=0,i[778]=0,i[C+4>>2]=3|B,i[(A=B+C|0)+4>>2]=1|i[A+4>>2]),A=C+8|0;break A}if((a=i[779])>>>0>r>>>0){g=a-r|0,i[779]=g,A=(B=i[782])+r|0,i[782]=A,i[A+4>>2]=1|g,i[B+4>>2]=3|r,A=B+8|0;break A}if(A=0,e=r+47|0,i[894]?B=i[896]:(i[897]=-1,i[898]=-1,i[895]=4096,i[896]=4096,i[894]=I+12&-16^1431655768,i[899]=0,i[887]=0,B=4096),(g=(t=e+B|0)&(o=0-B|0))>>>0<=r>>>0)break A;if((C=i[886])&&C>>>0<(Q=(B=i[884])+g|0)>>>0|B>>>0>=Q>>>0)break A;if(4&E[3548])break Q;t:{r:{if(C=i[782])for(A=3552;;){if((B=i[A>>2])>>>0<=C>>>0&C>>>0<B+i[A+4>>2]>>>0)break r;if(!(A=i[A+8>>2]))break}if(-1==(0|(B=x(0))))break i;if(Q=g,(A=(C=i[895])-1|0)&B&&(Q=(g-B|0)+(A+B&0-C)|0),Q>>>0<=r>>>0|Q>>>0>2147483646)break i;if((C=i[886])&&C>>>0<(o=(A=i[884])+Q|0)>>>0|A>>>0>=o>>>0)break i;if((0|B)!=(0|(A=x(Q))))break t;break C}if((Q=o&t-a)>>>0>2147483646)break i;if((0|(B=x(Q)))==(i[A>>2]+i[A+4>>2]|0))break E;A=B}if(!(-1==(0|A)|r+48>>>0<=Q>>>0)){if((B=(B=i[896])+(e-Q|0)&0-B)>>>0>2147483646){B=A;break C}if(-1!=(0|x(B))){Q=B+Q|0,B=A;break C}x(0-Q|0);break i}if(B=A,-1!=(0|A))break C;break i}C=0;break I}B=0;break g}if(-1!=(0|B))break C}i[887]=4|i[887]}if(g>>>0>2147483646)break B;if(-1==(0|(B=x(g)))|-1==(0|(A=x(0)))|A>>>0<=B>>>0)break B;if((Q=A-B|0)>>>0<=r+40>>>0)break B}A=i[884]+Q|0,i[884]=A,A>>>0>n[885]&&(i[885]=A);C:{Q:{i:{if(t=i[782]){for(A=3552;;){if(((C=i[A>>2])+(g=i[A+4>>2])|0)==(0|B))break i;if(!(A=i[A+8>>2]))break}break Q}for((A=i[780])>>>0<=B>>>0&&A||(i[780]=B),A=0,i[889]=Q,i[888]=B,i[784]=-1,i[785]=i[894],i[891]=0;g=(C=A<<3)+3144|0,i[C+3152>>2]=g,i[C+3156>>2]=g,32!=(0|(A=A+1|0)););g=(C=Q-40|0)-(A=B+8&7?-8-B&7:0)|0,i[779]=g,A=A+B|0,i[782]=A,i[A+4>>2]=1|g,i[4+(B+C|0)>>2]=40,i[783]=i[898];break C}if(!(8&E[A+12|0]|C>>>0>t>>>0|B>>>0<=t>>>0)){i[A+4>>2]=g+Q,B=(A=t+8&7?-8-t&7:0)+t|0,i[782]=B,A=(g=i[779]+Q|0)-A|0,i[779]=A,i[B+4>>2]=1|A,i[4+(g+t|0)>>2]=40,i[783]=i[898];break C}}n[780]>B>>>0&&(i[780]=B),g=B+Q|0,A=3552;Q:{i:{E:{o:{n:{t:{for(;;){if((0|g)!=i[A>>2]){if(A=i[A+8>>2])continue;break t}break}if(!(8&E[A+12|0]))break n}for(A=3552;;){if((g=i[A>>2])>>>0<=t>>>0&&(o=g+i[A+4>>2]|0)>>>0>t>>>0)break o;A=i[A+8>>2]}}if(i[A>>2]=B,i[A+4>>2]=i[A+4>>2]+Q,i[(e=(B+8&7?-8-B&7:0)+B|0)+4>>2]=3|r,A=(Q=g+(g+8&7?-8-g&7:0)|0)-(a=r+e|0)|0,(0|Q)==(0|t)){i[782]=a,A=i[779]+A|0,i[779]=A,i[a+4>>2]=1|A;break i}if(i[781]==(0|Q)){i[781]=a,A=i[778]+A|0,i[778]=A,i[a+4>>2]=1|A,i[A+a>>2]=A;break i}if(1==(3&(o=i[Q+4>>2]))){t=-8&o;n:if(o>>>0<=255){if(C=i[Q+8>>2],g=o>>>3|0,(0|(B=i[Q+12>>2]))==(0|C)){i[776]=i[776]&QA(g);break n}i[C+12>>2]=B,i[B+8>>2]=C}else{if(r=i[Q+24>>2],(0|Q)==(0|(B=i[Q+12>>2])))if((g=i[(o=Q+20|0)>>2])||(g=i[(o=Q+16|0)>>2])){for(;C=o,B=g,(g=i[(o=g+20|0)>>2])||(o=B+16|0,g=i[B+16>>2]););i[C>>2]=0}else B=0;else g=i[Q+8>>2],i[g+12>>2]=B,i[B+8>>2]=g;if(r){C=i[Q+28>>2];t:{if(i[(g=3408+(C<<2)|0)>>2]==(0|Q)){if(i[g>>2]=B,B)break t;i[777]=i[777]&QA(C);break n}if(i[r+(i[r+16>>2]==(0|Q)?16:20)>>2]=B,!B)break n}i[B+24>>2]=r,(g=i[Q+16>>2])&&(i[B+16>>2]=g,i[g+24>>2]=B),(g=i[Q+20>>2])&&(i[B+20>>2]=g,i[g+24>>2]=B)}}o=i[(Q=Q+t|0)+4>>2],A=A+t|0}if(i[Q+4>>2]=-2&o,i[a+4>>2]=1|A,i[A+a>>2]=A,A>>>0<=255){g=3144+(-8&A)|0,(B=i[776])&(A=1<<(A>>>3))?A=i[g+8>>2]:(i[776]=A|B,A=g),i[g+8>>2]=a,i[A+12>>2]=a,i[a+12>>2]=g,i[a+8>>2]=A;break i}if(o=31,A>>>0<=16777215&&(g=A>>>8|0,g<<=o=g+1048320>>>16&8,o=28+((g=((g<<=C=g+520192>>>16&4)<<(B=g+245760>>>16&2)>>>15|0)-(B|C|o)|0)<<1|A>>>g+21&1)|0),i[a+28>>2]=o,i[a+16>>2]=0,i[a+20>>2]=0,g=3408+(o<<2)|0,(C=i[777])&(B=1<<o)){for(o=A<<(31==(0|o)?0:25-(o>>>1|0)|0),B=i[g>>2];;){if((-8&i[(g=B)+4>>2])==(0|A))break E;if(B=o>>>29|0,o<<=1,!(B=i[(C=(4&B)+g|0)+16>>2]))break}i[C+16>>2]=a}else i[777]=B|C,i[g>>2]=a;i[a+24>>2]=g,i[a+12>>2]=a,i[a+8>>2]=a;break i}for(g=(C=Q-40|0)-(A=B+8&7?-8-B&7:0)|0,i[779]=g,A=A+B|0,i[782]=A,i[A+4>>2]=1|g,i[4+(B+C|0)>>2]=40,i[783]=i[898],i[(C=(A=(o+(o-39&7?39-o&7:0)|0)-47|0)>>>0<t+16>>>0?t:A)+4>>2]=27,A=i[891],i[C+16>>2]=i[890],i[C+20>>2]=A,A=i[889],i[C+8>>2]=i[888],i[C+12>>2]=A,i[890]=C+8,i[889]=Q,i[888]=B,i[891]=0,A=C+24|0;i[A+4>>2]=7,g=A+8|0,A=A+4|0,g>>>0<o>>>0;);if((0|C)==(0|t))break C;if(i[C+4>>2]=-2&i[C+4>>2],o=C-t|0,i[t+4>>2]=1|o,i[C>>2]=o,o>>>0<=255){g=3144+(-8&o)|0,(B=i[776])&(A=1<<(o>>>3))?A=i[g+8>>2]:(i[776]=A|B,A=g),i[g+8>>2]=t,i[A+12>>2]=t,i[t+12>>2]=g,i[t+8>>2]=A;break C}if(A=31,o>>>0<=16777215&&(A=o>>>8|0,A<<=C=A+1048320>>>16&8,A=28+((A=((A<<=B=A+520192>>>16&4)<<(g=A+245760>>>16&2)>>>15|0)-(g|B|C)|0)<<1|o>>>A+21&1)|0),i[t+28>>2]=A,i[t+16>>2]=0,i[t+20>>2]=0,g=3408+(A<<2)|0,(C=i[777])&(B=1<<A)){for(A=o<<(31==(0|A)?0:25-(A>>>1|0)|0),C=i[g>>2];;){if((0|o)==(-8&i[(g=C)+4>>2]))break Q;if(B=A>>>29|0,A<<=1,!(C=i[(B=(4&B)+g|0)+16>>2]))break}i[B+16>>2]=t}else i[777]=B|C,i[g>>2]=t;i[t+24>>2]=g,i[t+12>>2]=t,i[t+8>>2]=t;break C}A=i[g+8>>2],i[A+12>>2]=a,i[g+8>>2]=a,i[a+24>>2]=0,i[a+12>>2]=g,i[a+8>>2]=A}A=e+8|0;break A}A=i[g+8>>2],i[A+12>>2]=t,i[g+8>>2]=t,i[t+24>>2]=0,i[t+12>>2]=g,i[t+8>>2]=A}if(!((A=i[779])>>>0<=r>>>0)){g=A-r|0,i[779]=g,A=(B=i[782])+r|0,i[782]=A,i[A+4>>2]=1|g,i[B+4>>2]=3|r,A=B+8|0;break A}}i[775]=48,A=0;break A}g:if(Q){g=i[C+28>>2];B:{if(i[(A=3408+(g<<2)|0)>>2]==(0|C)){if(i[A>>2]=B,B)break B;e=QA(g)&e,i[777]=e;break g}if(i[Q+(i[Q+16>>2]==(0|C)?16:20)>>2]=B,!B)break g}i[B+24>>2]=Q,(A=i[C+16>>2])&&(i[B+16>>2]=A,i[A+24>>2]=B),(A=i[C+20>>2])&&(i[B+20>>2]=A,i[A+24>>2]=B)}g:if(o>>>0<=15)A=o+r|0,i[C+4>>2]=3|A,i[(A=A+C|0)+4>>2]=1|i[A+4>>2];else if(i[C+4>>2]=3|r,i[(Q=C+r|0)+4>>2]=1|o,i[Q+o>>2]=o,o>>>0<=255)g=3144+(-8&o)|0,(B=i[776])&(A=1<<(o>>>3))?A=i[g+8>>2]:(i[776]=A|B,A=g),i[g+8>>2]=Q,i[A+12>>2]=Q,i[Q+12>>2]=g,i[Q+8>>2]=A;else{A=31,o>>>0<=16777215&&(A=o>>>8|0,A<<=t=A+1048320>>>16&8,A=28+((A=((A<<=B=A+520192>>>16&4)<<(g=A+245760>>>16&2)>>>15|0)-(g|B|t)|0)<<1|o>>>A+21&1)|0),i[Q+28>>2]=A,i[Q+16>>2]=0,i[Q+20>>2]=0,g=3408+(A<<2)|0;B:{if((B=1<<A)&e){for(A=o<<(31==(0|A)?0:25-(A>>>1|0)|0),r=i[g>>2];;){if((-8&i[(g=r)+4>>2])==(0|o))break B;if(B=A>>>29|0,A<<=1,!(r=i[(B=(4&B)+g|0)+16>>2]))break}i[B+16>>2]=Q}else i[777]=B|e,i[g>>2]=Q;i[Q+24>>2]=g,i[Q+12>>2]=Q,i[Q+8>>2]=Q;break g}A=i[g+8>>2],i[A+12>>2]=Q,i[g+8>>2]=Q,i[Q+24>>2]=0,i[Q+12>>2]=g,i[Q+8>>2]=A}A=C+8|0;break A}I:if(a){g=i[B+28>>2];g:{if(i[(A=3408+(g<<2)|0)>>2]==(0|B)){if(i[A>>2]=C,C)break g;i[777]=QA(g)&e;break I}if(i[a+(i[a+16>>2]==(0|B)?16:20)>>2]=C,!C)break I}i[C+24>>2]=a,(A=i[B+16>>2])&&(i[C+16>>2]=A,i[A+24>>2]=C),(A=i[B+20>>2])&&(i[C+20>>2]=A,i[A+24>>2]=C)}o>>>0<=15?(A=o+r|0,i[B+4>>2]=3|A,i[(A=A+B|0)+4>>2]=1|i[A+4>>2]):(i[B+4>>2]=3|r,i[(C=B+r|0)+4>>2]=1|o,i[C+o>>2]=o,f&&(g=3144+(-8&f)|0,t=i[781],(A=1<<(f>>>3))&Q?A=i[g+8>>2]:(i[776]=A|Q,A=g),i[g+8>>2]=t,i[A+12>>2]=t,i[t+12>>2]=g,i[t+8>>2]=A),i[781]=C,i[778]=o),A=B+8|0}return D=I+16|0,0|A}function h(A){var I=0,g=0,B=0,C=0,Q=0,E=0,o=0,n=0,t=0,r=0,a=0,e=0,f=0,D=0,G=0,h=0,y=0,s=0,u=0,F=0,w=0,Y=0,N=0,S=0,d=0,U=0,H=0,R=0,q=0,J=0,l=0,M=0,L=0,m=0,p=0,b=0,K=0,v=0,O=0,x=0,j=0,W=0,T=0,V=0,P=0,X=0,Z=0,_=0,z=0,$=0,AA=0,IA=0,gA=0,BA=0,CA=0,QA=0,iA=0,EA=0,oA=0,nA=0,tA=0,rA=0,aA=0,eA=0,fA=0,DA=0,cA=0,GA=0,hA=0,yA=0,sA=0,uA=0,FA=0,wA=0,YA=0,NA=0,SA=0,kA=0,dA=0,UA=0,HA=0,RA=0,qA=0,JA=0,lA=0,MA=0,LA=0,mA=0,pA=0,bA=0,KA=0,vA=0,OA=0,xA=0,jA=0;for(_=i[A+192>>2],b=i[A+196>>2],z=i[A+184>>2],$=i[A+188>>2],s=i[A+176>>2],O=i[A+180>>2],u=i[A+168>>2],x=i[A+172>>2],j=i[A+160>>2],F=i[A+164>>2],w=i[A+152>>2],E=i[A+156>>2],Y=i[A+144>>2],N=i[A+148>>2],S=i[A+136>>2],W=i[A+140>>2],AA=i[A+128>>2],IA=i[A+132>>2],d=i[A+120>>2],T=i[A+124>>2],U=i[A+112>>2],t=i[A+116>>2],o=i[A+104>>2],r=i[A+108>>2],V=i[A+96>>2],H=i[A+100>>2],g=i[A+88>>2],B=i[A+92>>2],R=i[A+80>>2],P=i[A+84>>2],n=i[A+72>>2],a=i[A+76>>2],G=i[A+64>>2],e=i[A+68>>2],h=i[A+56>>2],C=i[A+60>>2],y=i[A+48>>2],q=i[A+52>>2],Q=i[A+40>>2],J=i[A+44>>2],oA=i[A+32>>2],gA=i[A+36>>2],l=i[A+24>>2],M=i[A+28>>2],f=i[A+16>>2],L=i[A+20>>2],I=i[A+8>>2],D=i[A+12>>2],K=i[A>>2],m=i[A+4>>2];cA>>>0<=23;)BA=X=m^J^P^F^T,iA=l^G^o^Y^z,X=k(Z=K^Q^R^d^j,X,1)^iA,p=k(oA^X,gA^(EA=(aA=M^e^r^N^$)^c),27),CA=c,nA=v=L^C^H^W^O,Z=k(eA=f^h^V^S^s,v,1)^Z,v=k(g^Z,B^(BA^=c),10),QA=c,fA=B=D^q^B^x^IA,tA=oA^n^U^w^_,g=k(DA=I^y^g^u^AA,B,1)^tA,Q=k(Q^g,J^(B=(gA=gA^a^t^E^b)^c),36),GA=c,J=k(I^Z,D^BA,1),oA=c,D=o,o=k(tA,gA,1)^eA,gA=k(D^o,(rA=r)^(r=c^nA),25),I=c,rA=h,h=k(iA,aA,1)^DA,D=k(rA^h,(nA=C)^(C=c^fA),6),aA=c,l=k(o^l,r^M,28),M=c,R=k(g^R,B^P,3),P=c,iA=k(n^X,a^EA,20),nA=n=c,a=k(f^h,C^L,62),f=c,U=k(U^X,t^EA,39),t=c,L=k(o^G,e^r,55),eA=G=c,tA=i[(e=(hA=cA<<3)+1120|0)>>2],e=i[e+4>>2],V=k(h^V,C^H,43),H=c,y=k(y^Z,q^BA,44),e=n=(yA=(fA=B^m)^(-1^(q=c))&H^e)^(sA=(-1^G)&t^f)^(uA=(-1^n)&P^M)^(FA=(-1^GA)&QA^CA)^(wA=(-1^aA)&I^oA),n=k(G=(YA=(rA=tA)^(tA=g^K)^(-1^y)&V)^(NA=(-1^L)&U^a)^(SA=(-1^iA)&R^l)^(kA=(-1^Q)&v^p)^(dA=(-1^D)&gA^J),n,1),K=c,S=k(S^h,C^W,15),W=c,z=k(o^z,r^$,56),DA=m=c,$=k(o^Y,r^N,21),Y=c,_=k(_^X,b^EA,14),o=c,b=k(g^d,B^T,41),N=c,u=k(u^Z,x^BA,2),d=c,x=k(w^X,E^EA,8),w=c,j=k(g^j,B^F,18),T=c,F=k(Z^AA,IA^BA,45),E=c,UA=(-1^z)&p^S,HA=(-1^_)&tA^$,AA=(-1^u)&a^b,RA=(-1^j)&J^x,s=k(h^s,C^O,61),K=k((n^=r=UA^HA^AA^RA^(IA=(-1^s)&l^F))^(g=(-1^a)&L^u),(a=(LA=(qA=(-1^m)&CA^W)^(JA=(-1^o)&fA^Y)^(B=(-1^d)&f^N)^(lA=(-1^T)&oA^w)^(MA=(-1^(O=c))&M^E))^K)^(C=(-1^f)&eA^d),14),m=c,G=k(u=(mA=gA^(-1^x)&j)^(f=V^(-1^$)&_)^(pA=(-1^b)&u^U)^(bA=R^(-1^F)&s)^(KA=(-1^S)&z^v),d=(vA=I^(-1^w)&T)^(OA=H^(-1^Y)&o)^(xA=(-1^N)&d^t)^(jA=P^(-1^E)&O)^(rA=(-1^W)&DA^QA),1)^G,X=k(G^(F=(-1^R)&F^iA),(e^=c)^(E=(-1^P)&E^nA),44),EA=c,N=eA^(-1^t)&N,R=aA^(-1^I)&w,I=(-1^H)&Y^q,h=(_=(p=z^(-1^p)&Q)^(iA=s^(-1^l)&iA)^(Y=j^(-1^J)&D)^g^(t=(-1^tA)&y^_))^k(z=(b=L^(-1^U)&b)^(H=D^(-1^gA)&x)^(v=Q^(-1^v)&S)^(g=(-1^V)&$^y)^F,w=N^R^(QA=GA^(-1^QA)&W)^I^E,1),BA=s=(C=($=(Q=DA^(-1^CA)&GA)^(J=O^(-1^M)&nA)^(S=T^(-1^oA)&aA)^C^(U=(-1^fA)&q^o))^c)^yA,oA=(-1^(Z=h^YA))&X^K,gA=(-1^s)&EA^m,s=k(G^b,e^N,2),O=c,l=k(_,$,1)^u,j=k(IA^l,MA^(M=d^c),55),F=c,nA=f,f=k(r,LA,1)^z,_=(-1^(w=k(nA^f,(L=w^c)^OA,62)))&j^s,b=(-1^(E=b=c))&F^O,z=(u=k(h^kA,C^FA,41))^(-1^s)&w,$=(x=c)^(-1^O)&E,s=(Y=k(n^Y,a^S,39))^(-1^u)&s,O=(N=c)^(-1^x)&O,u=j^(-1^Y)&u,x=F^(-1^N)&x,j=w^(-1^j)&Y,F=E^(-1^F)&N,S=k(l^AA,B^M,56),W=c,d=k(h^SA,C^uA,36),T=c,U=k(t^n,a^U,27),t=E=c,w=(-1^U)&d^S,E=(-1^E)&T^W,Y=(AA=k(f^KA,L^rA,15))^(-1^S)&U,N=(IA=c)^(-1^W)&t,S=(o=k(H^G,e^R,10))^(-1^AA)&S,W=(r=c)^(-1^IA)&W,AA=d^(-1^o)&AA,IA=T^(-1^r)&IA,d=(-1^d)&o^U,T=(-1^T)&r^t,V=k(h^NA,C^sA,18),H=c,R=k(f^bA,L^jA,6),P=c,y=k(g^G,I^e,1),q=t=c,U=(-1^y)&R^V,t=(-1^t)&P^H,o=(g=k(n^p,Q^a,8))^(-1^V)&y,r=(B=c)^(-1^H)&q,V=(Q=k(l^RA,M^lA,25))^(-1^g)&V,H=(I=c)^(-1^B)&H,g=R^(-1^Q)&g,B=P^(-1^I)&B,R=(-1^R)&Q^y,P=(-1^P)&I^q,y=k(f^pA,L^xA,61),q=c,Q=k(n^iA,a^J,20),J=c,I=k(l^HA,M^JA,28),D=a=c,n=(-1^I)&Q^y,a=(-1^a)&J^q,G=(p=k(G^v,e^QA,45))^(-1^y)&I,e=(CA=c)^(-1^q)&D,h=(v=k(h^dA,C^wA,3))^(-1^p)&y,C=(QA=c)^(-1^CA)&q,y=(-1^v)&p^Q,q=(-1^QA)&CA^J,Q=I^(-1^Q)&v,J=D^(-1^J)&QA,l=(I=k(l^UA,M^qA,21))^(-1^K)&Z,M=(D=c)^(-1^m)&BA,f=(p=k(f^mA,L^vA,43))^(-1^I)&K,L=(K=CA=c)^(-1^D)&m,I=(-1^p)&I^X,D=(-1^K)&D^EA,K=(-1^X)&p^i[(m=1120+(8|hA)|0)>>2]^Z,m=(-1^EA)&CA^i[m+4>>2]^BA,cA=cA+2|0;i[A+192>>2]=_,i[A+196>>2]=b,i[A+184>>2]=z,i[A+188>>2]=$,i[A+176>>2]=s,i[A+180>>2]=O,i[A+168>>2]=u,i[A+172>>2]=x,i[A+160>>2]=j,i[A+164>>2]=F,i[A+152>>2]=w,i[A+156>>2]=E,i[A+144>>2]=Y,i[A+148>>2]=N,i[A+136>>2]=S,i[A+140>>2]=W,i[A+128>>2]=AA,i[A+132>>2]=IA,i[A+120>>2]=d,i[A+124>>2]=T,i[A+112>>2]=U,i[A+116>>2]=t,i[A+104>>2]=o,i[A+108>>2]=r,i[A+96>>2]=V,i[A+100>>2]=H,i[A+88>>2]=g,i[A+92>>2]=B,i[A+80>>2]=R,i[A+84>>2]=P,i[A+72>>2]=n,i[A+76>>2]=a,i[A+64>>2]=G,i[A+68>>2]=e,i[A+56>>2]=h,i[A+60>>2]=C,i[A+48>>2]=y,i[A+52>>2]=q,i[A+40>>2]=Q,i[A+44>>2]=J,i[A+32>>2]=oA,i[A+36>>2]=gA,i[A+24>>2]=l,i[A+28>>2]=M,i[A+16>>2]=f,i[A+20>>2]=L,i[A+8>>2]=I,i[A+12>>2]=D,i[A>>2]=K,i[A+4>>2]=m}function y(A){var I=0,g=0,B=0,C=0,Q=0,E=0,o=0;A:if(A|=0){Q=(B=A-8|0)+(A=-8&(I=i[A-4>>2]))|0;I:if(!(1&I)){if(!(3&I))break A;if((B=B-(I=i[B>>2])|0)>>>0<n[780])break A;if(A=A+I|0,i[781]==(0|B)){if(3==(3&(I=i[Q+4>>2])))return i[778]=A,i[Q+4>>2]=-2&I,i[B+4>>2]=1|A,void(i[A+B>>2]=A)}else{if(I>>>0<=255){if(C=i[B+8>>2],I=I>>>3|0,(0|(g=i[B+12>>2]))==(0|C)){i[776]=i[776]&QA(I);break I}i[C+12>>2]=g,i[g+8>>2]=C;break I}if(o=i[B+24>>2],(0|B)==(0|(I=i[B+12>>2])))if((g=i[(C=B+20|0)>>2])||(g=i[(C=B+16|0)>>2])){for(;E=C,(g=i[(C=(I=g)+20|0)>>2])||(C=I+16|0,g=i[I+16>>2]););i[E>>2]=0}else I=0;else g=i[B+8>>2],i[g+12>>2]=I,i[I+8>>2]=g;if(!o)break I;C=i[B+28>>2];g:{if(i[(g=3408+(C<<2)|0)>>2]==(0|B)){if(i[g>>2]=I,I)break g;i[777]=i[777]&QA(C);break I}if(i[o+(i[o+16>>2]==(0|B)?16:20)>>2]=I,!I)break I}if(i[I+24>>2]=o,(g=i[B+16>>2])&&(i[I+16>>2]=g,i[g+24>>2]=I),!(g=i[B+20>>2]))break I;i[I+20>>2]=g,i[g+24>>2]=I}}if(!(B>>>0>=Q>>>0)&&1&(I=i[Q+4>>2])){I:{if(!(2&I)){if(i[782]==(0|Q)){if(i[782]=B,A=i[779]+A|0,i[779]=A,i[B+4>>2]=1|A,i[781]!=(0|B))break A;return i[778]=0,void(i[781]=0)}if(i[781]==(0|Q))return i[781]=B,A=i[778]+A|0,i[778]=A,i[B+4>>2]=1|A,void(i[A+B>>2]=A);A=(-8&I)+A|0;g:if(I>>>0<=255){if(C=i[Q+8>>2],I=I>>>3|0,(0|(g=i[Q+12>>2]))==(0|C)){i[776]=i[776]&QA(I);break g}i[C+12>>2]=g,i[g+8>>2]=C}else{if(o=i[Q+24>>2],(0|Q)==(0|(I=i[Q+12>>2])))if((g=i[(C=Q+20|0)>>2])||(g=i[(C=Q+16|0)>>2])){for(;E=C,(g=i[(C=(I=g)+20|0)>>2])||(C=I+16|0,g=i[I+16>>2]););i[E>>2]=0}else I=0;else g=i[Q+8>>2],i[g+12>>2]=I,i[I+8>>2]=g;if(o){C=i[Q+28>>2];B:{if(i[(g=3408+(C<<2)|0)>>2]==(0|Q)){if(i[g>>2]=I,I)break B;i[777]=i[777]&QA(C);break g}if(i[o+(i[o+16>>2]==(0|Q)?16:20)>>2]=I,!I)break g}i[I+24>>2]=o,(g=i[Q+16>>2])&&(i[I+16>>2]=g,i[g+24>>2]=I),(g=i[Q+20>>2])&&(i[I+20>>2]=g,i[g+24>>2]=I)}}if(i[B+4>>2]=1|A,i[A+B>>2]=A,i[781]!=(0|B))break I;return void(i[778]=A)}i[Q+4>>2]=-2&I,i[B+4>>2]=1|A,i[A+B>>2]=A}if(A>>>0<=255)return I=3144+(-8&A)|0,(g=i[776])&(A=1<<(A>>>3))?A=i[I+8>>2]:(i[776]=A|g,A=I),i[I+8>>2]=B,i[A+12>>2]=B,i[B+12>>2]=I,void(i[B+8>>2]=A);C=31,A>>>0<=16777215&&(I=A>>>8|0,I<<=E=I+1048320>>>16&8,C=28+((I=((I<<=C=I+520192>>>16&4)<<(g=I+245760>>>16&2)>>>15|0)-(g|C|E)|0)<<1|A>>>I+21&1)|0),i[B+28>>2]=C,i[B+16>>2]=0,i[B+20>>2]=0,E=3408+(C<<2)|0;I:{g:{if((g=i[777])&(I=1<<C)){for(C=A<<(31==(0|C)?0:25-(C>>>1|0)|0),I=i[E>>2];;){if(g=I,(-8&i[I+4>>2])==(0|A))break g;if(I=C>>>29|0,C<<=1,!(I=i[(E=g+(4&I)|0)+16>>2]))break}i[E+16>>2]=B,i[B+24>>2]=g}else i[777]=I|g,i[E>>2]=B,i[B+24>>2]=E;i[B+12>>2]=B,i[B+8>>2]=B;break I}A=i[g+8>>2],i[A+12>>2]=B,i[g+8>>2]=B,i[B+24>>2]=0,i[B+12>>2]=g,i[B+8>>2]=A}A=i[784]-1|0,i[784]=A||-1}}}function s(A,I,g,C){var Q,o,n,e,f=0,y=0,s=0,u=0,F=0;for(D=o=D-160|0,e=o+8|0,n=G(200),i[e>>2]=n,n||(a(111),r()),D=Q=D-208|0;;){if(25==(0|f)){for(;;){if(f=0,C>>>0<136){for(y=0;;){if(136==(0|f)){for(;(0|C)!=(0|y);)B[y+Q|0]=E[g+y|0],y=y+1|0;break}B[f+Q|0]=0,f=f+1|0}for(B[C+Q|0]=31,B[Q+135|0]=128|E[Q+135|0],f=0;17!=(0|f);)y=i[(g=(C=f<<3)+n|0)>>2],s=i[g+4>>2],i[g>>2]=L(C+Q|0)^y,i[g+4>>2]=c^s,f=f+1|0;D=Q+208|0;break}for(;17!=(0|f);)u=i[(y=(s=f<<3)+n|0)>>2],F=i[y+4>>2],i[y>>2]=L(g+s|0)^u,i[y+4>>2]=c^F,f=f+1|0;h(n),g=g+136|0,C=C-136|0}break}i[(y=(f<<3)+n|0)>>2]=0,i[y+4>>2]=0,f=f+1|0}R(A,g=(I>>>0)/136|0,e);A:if((0|(g=t(g,136)))!=(0|I))for(C=I-g|0,A=A+g|0,R(o+16|0,1,o+8|0),I=0;;){if((0|I)==(0|C))break A;B[A+I|0]=E[(o+16|0)+I|0],I=I+1|0}rA(o+8|0),D=o+160|0}function u(A,I,g,B){for(var C=0,Q=0,o=0,n=0,t=0,r=0,a=0,e=0,f=0,D=0,c=0;;){A:{if(e=0,n=0,C=I,t=i[A+204>>2],!(!(a=(Q=B+(o=i[A+200>>2])|0)>>>0<B>>>0?t+1|0:t)&C>>>0>Q>>>0)){for(;!(!n&(C=I-o|0)>>>0<=e>>>0|0!=(0|n));)Q=n+t|0,a=o=(C=o)+e|0,o=C=(-8&o)+A|0,t=i[C+4>>2],o=C,c=i[C>>2],D=E[g+e|0],Q=31&(C=(Q=a)<<3),(63&C)>>>0>=32?(C=D<<Q,a=0):(C=(1<<Q)-1&D>>>32-Q,a=D<<Q),i[o>>2]=c^a,i[o+4>>2]=C^t,n=(C=e+1|0)?n:n+1|0,e=C,o=i[A+200>>2],t=i[A+204>>2];i[A+200>>2]=0,i[A+204>>2]=0,h(A),g=g+C|0,B=B-C|0;continue}for(;;){if(!r&(0|B)==(0|f))break A;n=(I=f)+i[A+200>>2]|0,C=r+i[A+204>>2]|0,n=I=(-8&(Q=n))+A|0,o=i[I+4>>2],a=I,e=i[I>>2],t=E[g+f|0],C=31&(I=(C=Q)<<3),(63&I)>>>0>=32?(I=t<<C,C=0):(I=(1<<C)-1&t>>>32-C,C=t<<C),i[a>>2]=e^C,i[n+4>>2]=I^o,r=(I=f+1|0)?r:r+1|0,f=I}}break}r=i[A+204>>2],r=(I=B+i[A+200>>2]|0)>>>0<B>>>0?r+1|0:r,i[A+200>>2]=I,i[A+204>>2]=r}function F(A,I,g,C){var Q=0,E=0,o=0,n=0,t=0,r=0,a=0,e=0,f=0;r=I;A:{for(;;){if(n=i[g+200>>2],a=i[g+204>>2],!o&(0|t)==(0|r)){E=I;break A}if(!((0|o)==(0|a)&n>>>0>(E=t)>>>0|o>>>0<a>>>0))break;f=A+E|0,a=Q=t+((E=C)-n|0)|0,E=i[(Q=(-8&Q)+g|0)>>2],e=i[Q+4>>2],Q=31&(n=(Q=a)<<3),B[0|f]=(63&n)>>>0>=32?e>>>Q|0:((1<<Q)-1&e)<<32-Q|E>>>Q,o=(t=t+1|0)?o:o+1|0}r=t}for(t=n-r|0,o=a-((n>>>0<r>>>0)+0|0)|0,Q=I-E|0,I=A+E|0;i[g+200>>2]=t,i[g+204>>2]=o,Q;){for(h(g),n=C>>>0>Q>>>0?Q:C,E=0;(0|n)!=(0|E);)A=i[(r=(-8&E)+g|0)>>2],t=i[r+4>>2],r=A,o=31&(A=E<<3&56),B[I+E|0]=(63&A)>>>0>=32?t>>>o|0:((1<<o)-1&t)<<32-o|r>>>o,E=E+1|0;Q=Q-n|0,I=I+n|0,t=C-n|0,o=0}}function w(A,I){var g,B=0,C=0,Q=0,o=0,n=0,t=0;for(D=g=D-160|0,O(Q=g+8|0),nA(Q,I,32),tA(Q),oA(g+16|0,136,Q);;){if(!B&8==(0|C)){for(I=0;;){if(256==(0|I)){for(I=8,C=196;256!=(0|C);){for(;I>>>0>=136&&(oA(g+16|0,136,g+8|0),I=0),B=(g+16|0)+I|0,I=I+1|0,(B=E[0|B])>>>0>C>>>0;);B=(B<<2)+A|0,i[(C<<2)+A>>2]=i[B>>2],i[B>>2]=1-(n<<1&2),C=C+1|0,n=(1&t)<<31|n>>>1,t=t>>>1|0}rA(g+8|0),D=g+160|0;break}i[(I<<2)+A>>2]=0,I=I+1|0}break}Q=E[(g+16|0)+C|0],I=31&(o=(I=C)<<3),(63&o)>>>0>=32?(o=Q<<I,I=0):(o=(1<<I)-1&Q>>>32-I,I=Q<<I),n|=I,t|=o,B=(I=C+1|0)?B:B+1|0,C=I}}function Y(A,I){for(var g=0,C=0,Q=0,o=0,n=0,r=0,a=0,e=0,f=0,c=0,G=0;8!=(0|r);){for(c=r<<8,G=t(r,7168)+A|0,n=0;7!=(0|n);){for(D=g=(D=Q=D-864|0)-16|0,C=n+c|0,B[g+14|0]=C,B[g+15|0]=C>>>8,O(C=Q+8|0),EA(C,I,32),EA(C,g+14|0,2),U(i[C>>2],168),D=g+16|0,g=840,iA(o=Q+16|0,840,C),C=M(e=(n<<10)+G|0,256,o,840);C>>>0<=255;){for(a=g-(o=(g>>>0)%3|0)|0,g=0;(0|g)!=(0|o);)B[(f=Q+16|0)+g|0]=E[(g+a|0)+f|0],g=g+1|0;iA((g=Q+16|0)|o,168,Q+8|0),C=M((C<<2)+e|0,256-C|0,a=g,g=168|o)+C|0}rA(Q+8|0),D=Q+864|0,n=n+1|0}r=r+1|0}}function N(A){var I=0,g=0,B=0,C=0,Q=0,E=0,o=0,n=0,t=0,r=0;Q=256,B=1;A:for(;;){I:{if(I=0,B>>>0>255)for(;;){if(256==(0|E))break I;g=I=(E<<2)+A|0,I=i[I>>2],i[g>>2]=z(m(I,I>>31,41978,0),c),E=E+1|0}for(;;){g:{if(I>>>0<=255)for(o=I>>>0>(g=I+B|0)>>>0?I:g,n=g=0-i[1312+((Q=Q-1|0)<<2)>>2]|0,t=g>>31;;){if((0|I)==(0|o))break g;C=i[(g=(I<<2)+A|0)>>2],r=g,g=(I+B<<2)+A|0,i[r>>2]=C+i[g>>2],C=C-i[g>>2]|0,i[g>>2]=C,i[g>>2]=z(m(C,C>>31,n,t),c),I=I+1|0}B<<=1;continue A}I=B+o|0}}break}}function S(A,I){for(var g=0,B=0,C=0,Q=0,o=0,n=0,r=0,a=0,e=0,f=0;32!=(0|C);)g=(C<<5)+A|0,B=t(C,3)+I|0,Q=7&E[0|B],i[g>>2]=Q,o=E[0|B]>>>3&7,i[g+4>>2]=o,n=E[B+1|0]<<2&4|E[0|B]>>>6,i[g+8>>2]=n,r=E[B+1|0]>>>1&7,i[g+12>>2]=r,a=E[B+1|0]>>>4&7,i[g+16>>2]=a,e=E[B+2|0]<<1&6|E[B+1|0]>>>7,i[g+20>>2]=e,f=E[B+2|0]>>>2&7,i[g+24>>2]=f,B=E[B+2|0],i[g+4>>2]=2-o,i[g>>2]=2-Q,i[g+8>>2]=2-n,i[g+12>>2]=2-r,i[g+16>>2]=2-a,i[g+20>>2]=2-e,i[g+24>>2]=2-f,i[g+28>>2]=2-(B>>>5|0),C=C+1|0}function k(A,I,g){var B=0,C=0,Q=0,i=0;return C=31&(Q=i=63&g),Q=Q>>>0>=32?-1>>>C|0:(B=-1>>>C|0)|(1<<C)-1<<32-C,Q&=A,B&=I,C=31&i,i>>>0>=32?(B=Q<<C,i=0):(B=(1<<C)-1&Q>>>32-C|B<<C,i=Q<<C),Q=B,B=31&(C=0-g&63),C>>>0>=32?(B=-1<<B,g=0):B=(g=-1<<B)|(1<<B)-1&-1>>>32-B,A&=g,I&=B,B=31&C,C>>>0>=32?(g=0,A=I>>>B|0):(g=I>>>B|0,A=((1<<B)-1&I)<<32-B|A>>>B),c=g|Q,A|=i}function d(A){var I=0,g=0,B=0,C=0,Q=0,E=0,o=0,n=0,t=0,r=0;for(B=128;I=0,B;){for(;I>>>0<=255;){for(C=I>>>0>(C=I+B|0)>>>0?I:C,n=g=i[1312+((E=E+1|0)<<2)>>2],t=g>>31;(0|I)!=(0|C);)g=z(m(g=i[(Q=(I+B<<2)+A|0)>>2],g>>31,n,t),c),r=Q,o=i[(Q=(I<<2)+A|0)>>2],i[r>>2]=o-g,i[Q>>2]=g+o,I=I+1|0;I=B+C|0}B=B>>>1|0}}function U(A,I){var g,B=0,C=0,Q=0;B=i[A+200>>2],g=i[(C=A+(-8&B)|0)+4>>2],B=31&(Q=B<<3),(63&Q)>>>0>=32?(Q=31<<B,B=0):(Q=(1<<B)-1&31>>>32-B,B=31<<B),i[C>>2]=B^i[C>>2],i[C+4>>2]=Q^g,Q=i[(I=(-8&(C=I-1|0))+A|0)+4>>2],C=31&(B=C<<3&56),(63&B)>>>0>=32?(B=128<<C,C=0):(B=(1<<C)-1&128>>>32-C,C=128<<C),i[I>>2]=C^i[I>>2],i[I+4>>2]=B^Q,i[A+200>>2]=0,i[A+204>>2]=0}function H(A,I){for(var g=0,C=0,Q=0,E=0,o=0,n=0,r=0,a=0,e=0;32!=(0|C);)n=i[(g=(C<<5)+I|0)+16>>2],r=i[g+12>>2],Q=i[g+28>>2],a=i[g+20>>2],e=i[g+24>>2],E=t(C,3)+A|0,o=16-(i[g+4>>2]<<3)|2-i[g>>2],g=2-i[g+8>>2]|0,B[0|E]=o|g<<6,o=64-(Q<<5)|0,Q=2-a|0,B[E+2|0]=o|8-(e<<2)|(254&Q)>>>1,B[E+1|0]=32-(n<<4)|4-(r<<1)|(252&g)>>>2|Q<<7,C=C+1|0}function R(A,I,g){var C,Q=0,E=0,o=0,n=0,t=0,r=0,a=0;C=i[g>>2];A:for(;;){if(I)for(h(C),g=0;;){if(17==(0|g)){I=I-1|0,A=A+136|0;continue A}for(r=(Q=g<<3)+A|0,a=i[(Q=Q+C|0)>>2],n=i[Q+4>>2],E=0,Q=0;8!=(0|E)|Q;)o=31&(t=E<<3),B[E+r|0]=(63&t)>>>0>=32?n>>>o|0:((1<<o)-1&n)<<32-o|a>>>o,Q=(E=E+1|0)?Q:Q+1|0;g=g+1|0}break}}function q(A,I){for(var g=0,B=0,C=0,Q=0,o=0;128!=(0|o);)C=(o<<3)+A|0,g=t(o,5)+I|0,B=E[0|g],i[C>>2]=B,B|=E[g+1|0]<<8,i[C>>2]=B,B|=E[g+2|0]<<16&983040,i[C>>2]=B,Q=E[g+2|0]>>>4|0,i[C+4>>2]=Q,Q|=E[g+3|0]<<4,i[C+4>>2]=Q,g=E[g+4|0],i[C>>2]=524288-B,i[C+4>>2]=524288-(Q|g<<12),o=o+1|0}function J(A,I,g){for(var B=0,C=0,Q=0,o=0;!(I>>>0<=B>>>0|Q>>>0>135);)o=(C=E[g+Q|0])>>>4|0,Q=Q+1|0,15!=(0|(C&=15))&&(i[(B<<2)+A>>2]=2+(t(t(C,205)>>>10|0,5)-C|0),B=B+1|0),15==(0|o)|I>>>0<=B>>>0||(i[(B<<2)+A>>2]=2+(t(t(o,205)>>>10|0,5)-o|0),B=B+1|0);return B}function l(A,I,g){for(var B=0,C=0,Q=0,i=0,E=0,o=0;8!=(0|B);){for(D=C=D-1024|0,W(i=(B<<10)+A|0,E=t(B,7168)+I|0,g),Q=1;7!=(0|Q);)W(C,(o=Q<<10)+E|0,g+o|0),Z(i,i,C),Q=Q+1|0;D=C+1024|0,B=B+1|0}}function M(A,I,g,B){for(var C=0,Q=0,o=0,n=0;!(I>>>0<=Q>>>0||(C=n+3|0)>>>0>B>>>0);)o=g+n|0,n=C,(C=E[o+2|0]<<16&8323072|E[0|o]|E[o+1|0]<<8)>>>0>8380416||(i[(Q<<2)+A>>2]=C,Q=Q+1|0);return Q}function L(A){for(var I=0,g=0,B=0,C=0,Q=0,i=0,o=0;;){if(!C&8==(0|g)){A=i;break}Q=E[A+g|0],I=31&(B=g<<3),(63&B)>>>0>=32?(B=Q<<I,I=0):(B=(1<<I)-1&Q>>>32-I,I=Q<<I),i|=I,o|=B,C=(g=g+1|0)?C:C+1|0}return c=o,A}function m(A,I,g,B){var C,Q,i,E,o=0,n=0;return E=t(o=g>>>16|0,n=A>>>16|0),o=(65535&(n=((i=t(C=65535&g,Q=65535&A))>>>16|0)+t(n,C)|0))+t(o,Q)|0,c=(t(I,g)+E|0)+t(A,B)+(n>>>16)+(o>>>16)|0,65535&i|o<<16}function p(A,I,g){for(var B=0,C=0,Q=0,E=0,o=0,n=0;8!=(0|C);){for(E=(B=C<<10)+A|0,o=I+B|0,n=g+B|0,B=0;256!=(0|B);)i[E+(Q=B<<2)>>2]=i[Q+o>>2]-i[Q+n>>2],B=B+1|0;C=C+1|0}}function b(A,I,g){var B,C;for(D=B=D-160|0,_(C=B+8|0,I,g),oA(I=B+16|0,136,C),g=J(A,256,I);g>>>0<=255;)oA(I=B+16|0,136,B+8|0),g=J((g<<2)+A|0,256-g|0,I)+g|0;rA(B+8|0),D=B+160|0}function K(A,I){for(var g=0,C=0,Q=0,E=0,o=0;8!=(0|C);){for(E=(C<<7)+A|0,o=(C<<10)+I|0,g=0;128!=(0|g);)Q=(g<<3)+o|0,B[g+E|0]=i[Q+4>>2]<<4|i[Q>>2],g=g+1|0;C=C+1|0}}function v(A){for(var I=0,g=0,B=0,C=0,Q=0;8!=(0|g);){for(Q=(g<<10)+A|0,I=0;256!=(0|I);)C=i[(B=(I<<2)+Q|0)>>2],i[B>>2]=C+(C>>31&8380417),I=I+1|0;g=g+1|0}}function O(A){var I=0,g=0;for(I=A,A=G(208),i[I>>2]=A,A||(a(111),r());25!=(0|g);)i[(I=A+(g<<3)|0)>>2]=0,i[I+4>>2]=0,g=g+1|0;i[A+200>>2]=0,i[A+204>>2]=0}function x(A){var I,B;return(A=(I=i[584])+(B=A+3&-4)|0)>>>0<=I>>>0&&B||A>>>0>(g.byteLength/65536|0)<<16>>>0&&!(0|f(0|A))?(i[775]=48,-1):(i[584]=A,I)}function j(A,I){var g=0,B=0;if((0|I)<=1047552)for(;;){if(256==(0|B))return 0;if(g=B<<2,B=B+1|0,!((((g=i[A+g>>2])>>31&0-(g<<1))+g|0)<(0|I)))break}return 1}function W(A,I,g){for(var B=0,C=0,Q=0,E=0;256!=(0|C);)Q=i[(B=C<<2)+g>>2],E=A+B|0,B=i[I+B>>2],i[E>>2]=z(m(Q,Q>>31,B,B>>31),c),C=C+1|0}function T(A){for(var I=0,g=0,B=0;256!=(0|I);)B=i[(g=(I<<2)+A|0)>>2],i[g>>2]=B+t(B+4194304>>23,-8380417),I=I+1|0}function V(A,I){var g;return g=A,A=t(I+127>>7,1025)+2097152>>>22&15,I=t(A,-523776)+I|0,i[g>>2]=((0|I)>4190208?-8380417:0)+I,A}function P(A){for(var I=0,g=0;;){if(7==(0|I))return 0;if(g=I<<10,I=I+1|0,j(A+g|0,524168))break}return 1}function X(A,I){for(var g=0,B=0;;){if(8==(0|g))return 0;if(B=g<<10,g=g+1|0,j(A+B|0,I))break}return 1}function Z(A,I,g){for(var B=0,C=0;256!=(0|B);)i[(C=B<<2)+A>>2]=i[g+C>>2]+i[I+C>>2],B=B+1|0}function _(A,I,g){var C;D=C=D-16|0,B[C+14|0]=g,B[C+15|0]=g>>>8,O(A),nA(A,I,64),nA(A,C+14|0,2),tA(A),D=C+16|0}function z(A,I){var g=0;return m(A,I,0,58728449),g=m(g=c,g>>31,-8380417,-1)+A|0,I=I+c|0,A>>>0>g>>>0?I+1|0:I}function $(A,I,g){for(var B=0,C=0;8!=(0|B);)Z((C=B<<10)+A|0,I+C|0,g+C|0),B=B+1|0}function AA(A,I,g){for(var B=0,C=0;8!=(0|B);)W((C=B<<10)+A|0,I,g+C|0),B=B+1|0}function IA(A,I){var g=0;for(g=7168;B[0|A]=E[0|I],A=A+1|0,I=I+1|0,g=g-1|0;);}function gA(A,I){for(var g=0;(0|I)!=(0|g);)d((g<<10)+A|0),g=g+1|0}function BA(A){for(var I=0;8!=(0|I);)T((I<<10)+A|0),I=I+1|0}function CA(A){for(var I=0;8!=(0|I);)N((I<<10)+A|0),I=I+1|0}function QA(A){var I;return(-1>>>(I=31&A)&-2)<<I|(-1<<(A=0-A&31)&-2)>>>A}function iA(A,I,g){F(A,I,i[g>>2],168)}function EA(A,I,g){u(i[A>>2],168,I,g)}function oA(A,I,g){F(A,I,i[g>>2],136)}function nA(A,I,g){u(i[A>>2],136,I,g)}function tA(A){U(i[A>>2],136)}function rA(A){y(i[A>>2])}function aA(A){gA(A,8)}function eA(A){gA(A,7)}C(I=E,1024,"cmFuZG9tYnl0ZXMAbGlic29kaXVtL3NyYy9saWJzb2RpdW0vcmFuZG9tYnl0ZXMvcmFuZG9tYnl0ZXMuYwBidWZfbGVuIDw9IFNJWkVfTUFY"),C(I,1120,""),C(I,2336,"EA6A");var fA,DA=((fA=[]).set=function(A,I){this[A]=I},fA.get=function(A){return this[A]},fA);return{e:function(){},f:DA,g:G,h:y,i:function(){var A;D=A=D-16|0,B[A+15|0]=0,e(2376,A+15|0,0),D=A+16|0},j:function(){return 2592},k:function(){return 4864},l:function(){return 4597},m:function(A,I){A|=0,I|=0;var g,C=0,Q=0,o=0,n=0,r=0,a=0,f=0,c=0,G=0,h=0,y=0,u=0,F=0;for(D=g=D-96416|0,r=g+96288|0;32!=(0|Q);)D=n=D-16|0,B[n+15|0]=0,a=0|e(2340,n+15|0,0),D=n+16|0,B[Q+r|0]=a,Q=Q+1|0;for(s(r,128,r,32),Y(n=g+38912|0,r),c=g+31744|0,Q=g+96320|0;7!=(0|C);)b(c+(C<<10)|0,Q,65535&o),C=C+1|0,o=o+1|0;for(G=g+16384|0,C=0,o=7;8!=(0|C);)b(G+(C<<10)|0,Q,65535&o),C=C+1|0,o=o+1|0;for(IA(C=g+24576|0,c),eA(C),l(o=g- -8192|0,n,C),BA(o),CA(o),$(o,o,G),v(o),C=0;8!=(0|C);){for(h=(Q=C<<10)+o|0,y=Q+g|0,u=Q+o|0,Q=0;256!=(0|Q);)a=(f=i[(n=Q<<2)+u>>2])+4095|0,i[n+y>>2]=f-(-8192&a),i[n+h>>2]=a>>13,Q=Q+1|0;C=C+1|0}for(C=0;32!=(0|C);)B[A+C|0]=E[C+r|0],C=C+1|0;for(h=A+32|0,C=0;8!=(0|C);){for(y=h+t(C,320)|0,u=o+(C<<10)|0,n=0;64!=(0|n);)a=y+t(n,5)|0,Q=u+(n<<4)|0,B[0|a]=i[Q>>2],B[a+1|0]=i[Q+4>>2]<<2|i[Q>>2]>>>8,B[a+2|0]=i[Q+8>>2]<<4|i[Q+4>>2]>>>6,B[a+3|0]=i[Q+12>>2]<<6|i[Q+8>>2]>>>4,B[a+4|0]=i[Q+12>>2]>>>2,n=n+1|0;C=C+1|0}for(s(o=g+96256|0,32,A,2592),A=g+96384|0,C=0;32!=(0|C);)B[I+C|0]=E[C+r|0],C=C+1|0;for(Q=I+32|0,C=0;32!=(0|C);)B[C+Q|0]=E[A+C|0],C=C+1|0;for(A=I- -64|0,C=0;32!=(0|C);)B[A+C|0]=E[C+o|0],C=C+1|0;for(A=I+96|0,C=0;7!=(0|C);)H(A+t(C,96)|0,c+(C<<10)|0),C=C+1|0;for(A=I+768|0,C=0;8!=(0|C);)H(A+t(C,96)|0,G+(C<<10)|0),C=C+1|0;for(a=I+1536|0,C=0;8!=(0|C);){for(c=a+t(C,416)|0,G=(C<<10)+g|0,o=0;32!=(0|o);)h=i[(I=G+(o<<5)|0)+8>>2],y=i[I+20>>2],n=i[I+4>>2],r=i[I+12>>2],Q=i[I+16>>2],u=i[I+24>>2],f=i[I+28>>2],A=c+t(o,13)|0,F=4096-i[I>>2]|0,B[0|A]=F,f=4096-f|0,B[A+12|0]=f>>>5,I=4096-u|0,B[A+10|0]=I>>>2,Q=4096-Q|0,B[A+7|0]=Q>>>4,r=4096-r|0,B[A+5|0]=r>>>1,n=4096-n|0,B[A+2|0]=n>>>3,B[A+11|0]=f<<3|I>>>10,f=I<<6,I=4096-y|0,B[A+9|0]=f|I>>>7,B[A+8|0]=I<<1|Q>>>12,B[A+6|0]=Q<<4|r>>>9,I=4096-h|0,B[A+4|0]=r<<7|I>>>6,B[A+3|0]=I<<2|n>>>11,B[A+1|0]=n<<5|F>>>8,o=o+1|0;C=C+1|0}return D=g+96416|0,0},n:function(A,I,g,C){I|=0,g|=0,C|=0;var o,n,r,a=0,e=0,f=0,c=0,G=0,h=0,y=0,u=0,F=0,k=0,U=0,H=0,R=0,J=0,M=0,L=0,m=0,b=0,x=0,j=0;for(n=(A|=0)+2|0,D=o=(D=r=D-16|0)-121072|0,e=H=o+120848|0,f=R=o+120880|0,c=o+120912|0,G=o+33808|0,h=o+56336|0,y=o+25616|0;32!=(0|a);)B[a+e|0]=E[C+a|0],a=a+1|0;for(e=C+32|0,a=0;32!=(0|a);)B[a+c|0]=E[a+e|0],a=a+1|0;for(e=C- -64|0,a=0;32!=(0|a);)B[a+f|0]=E[a+e|0],a=a+1|0;for(e=C+96|0,a=0;7!=(0|a);)S(h+(a<<10)|0,e+t(a,96)|0),a=a+1|0;for(e=C+768|0,a=0;8!=(0|a);)S(y+(a<<10)|0,e+t(a,96)|0),a=a+1|0;for(m=C+1536|0,a=0;8!=(0|a);){for(b=G+(a<<10)|0,x=m+t(a,416)|0,f=0;32!=(0|f);)C=b+(f<<5)|0,e=x+t(f,13)|0,J=E[0|e],i[C>>2]=J,J|=E[e+1|0]<<8&7936,i[C>>2]=J,u=E[e+1|0]>>>5|0,i[C+4>>2]=u,u|=E[e+2|0]<<3,i[C+4>>2]=u,u|=E[e+3|0]<<11&6144,i[C+4>>2]=u,M=E[e+3|0]>>>2|0,i[C+8>>2]=M,M|=E[e+4|0]<<6&8128,i[C+8>>2]=M,F=E[e+4|0]>>>7|0,i[C+12>>2]=F,F|=E[e+5|0]<<1,i[C+12>>2]=F,F|=E[e+6|0]<<9&7680,i[C+12>>2]=F,k=E[e+6|0]>>>4|0,i[C+16>>2]=k,k|=E[e+7|0]<<4,i[C+16>>2]=k,k|=E[e+8|0]<<12&4096,i[C+16>>2]=k,L=E[e+8|0]>>>1|0,i[C+20>>2]=L,L|=E[e+9|0]<<7&8064,i[C+20>>2]=L,U=E[e+9|0]>>>6|0,i[C+24>>2]=U,U|=E[e+10|0]<<2,i[C+24>>2]=U,U|=E[e+11|0]<<10&7168,i[C+24>>2]=U,j=E[e+11|0]>>>3|0,i[C+28>>2]=j,e=E[e+12|0],i[C+4>>2]=4096-u,i[C>>2]=4096-J,i[C+8>>2]=4096-M,i[C+12>>2]=4096-F,i[C+16>>2]=4096-k,i[C+20>>2]=4096-L,i[C+24>>2]=4096-U,i[C+28>>2]=4096-(e<<5|j),f=f+1|0;a=a+1|0}for(O(C=o+8|0),nA(C,R,32),nA(C,I,g),tA(C),oA(R=o+120944|0,64,C),rA(C),s(m=o+121008|0,64,c,96),Y(o+63504|0,H),eA(h),aA(y),aA(G),a=0;;){for(e=o+49168|0,f=t(65535&a,7),I=0;7!=(0|I);)D=g=D-704|0,_(C=g+8|0,m,I+f&65535),oA(c=g+16|0,680,C),rA(C),q(e+(I<<10)|0,c),D=g+704|0,I=I+1|0;for(IA(C=o+42e3|0,e),eA(C),l(I=o+17424|0,o+63504|0,C),BA(I),CA(I),v(I),G=o+9232|0,g=0;8!=(0|g);){for(h=(f=g<<10)+I|0,y=f+G|0,H=I+f|0,f=0;256!=(0|f);)i[(c=f<<2)+h>>2]=V(c+y|0,i[c+H>>2]),f=f+1|0;g=g+1|0}for(K(n,I),O(I=o+8|0),nA(I,R,64),nA(I,n,1024),tA(I),oA(n,32,I),rA(I),w(I=o+16|0,n),a=a+1|0,d(I),f=o+56336|0,g=0;7!=(0|g);)W((c=g<<10)+C|0,I,f+c|0),g=g+1|0;for(I=0;7!=(0|I);)N(C+(I<<10)|0),I=I+1|0;for(I=0;7!=(0|I);)Z((g=I<<10)+C|0,g+C|0,g+e|0),I=I+1|0;for(g=0;7!=(0|g);)T(C+(g<<10)|0),g=g+1|0;if(!P(C)&&(AA(g=o+1040|0,o+16|0,o+25616|0),CA(g),p(I=o+9232|0,I,g),BA(I),!X(I,261768)&&(AA(I=o+1040|0,o+16|0,o+33808|0),CA(I),BA(I),!X(I,261888)))){for($(e=o+9232|0,e,h=o+1040|0),y=o+17424|0,I=0,g=0;8!=(0|I);){for(H=(C=I<<10)+h|0,b=C+e|0,x=C+y|0,C=0,f=0;256!=(0|C);)G=-261888==(0|(G=i[(c=C<<2)+b>>2]))&0!=i[c+x>>2]|G-261889>>>0<4294443519,i[c+H>>2]=G,f=f+G|0,C=C+1|0;g=g+f|0,I=I+1|0}if(!(g>>>0>75))break}}for(f=o+42e3|0,c=o+1040|0,I=0;32!=(0|I);)B[0|(g=I+n|0)]=E[0|g],I=I+1|0;for(G=n+32|0,I=0;7!=(0|I);){for(h=G+t(I,640)|0,y=f+(I<<10)|0,g=0;128!=(0|g);)e=i[(a=y+(g<<3)|0)+4>>2],C=h+t(g,5)|0,a=524288-i[a>>2]|0,B[0|C]=a,B[C+1|0]=a>>>8,e=524288-e|0,B[C+4|0]=e>>>12,B[C+3|0]=e>>>4,B[C+2|0]=e<<4|a>>>16,g=g+1|0;I=I+1|0}for(a=n+4512|0,g=0,I=0;;){if(83==(0|I)){for(C=0;8!=(0|g);){for(e=c+(g<<10)|0,I=0;256!=(0|I);)i[e+(I<<2)>>2]&&(B[C+a|0]=I,C=C+1|0),I=I+1|0;B[75+(g+a|0)|0]=C,g=g+1|0}break}B[I+a|0]=0,I=I+1|0}return i[r+12>>2]=4595,D=o+121072|0,Q[A>>1]=i[r+12>>2],D=r+16|0,0},o:function(A,I,g,C){A|=0,I|=0,C|=0;var Q,n=0,r=0,a=0,e=0,f=0,c=0,G=0,h=0,y=0,u=0,F=0;a=(g|=0)+2|0,n=o[g>>1],f=A,r=I,g=0,D=Q=D-91312|0,u=-1;A:if(4595==(0|n)){for(A=Q+90256|0,h=Q+16400|0,I=0;32!=(0|I);)B[A+I|0]=E[I+C|0],I=I+1|0;for(c=C+32|0,I=0;8!=(0|I);){for(G=h+(I<<10)|0,y=c+t(I,320)|0,n=0;64!=(0|n);)e=G+(n<<4)|0,A=t(n,5)+y|0,i[e>>2]=E[A+1|0]<<8&768|E[0|A],i[e+4>>2]=E[A+2|0]<<6&960|E[A+1|0]>>>2,i[e+8>>2]=E[A+3|0]<<4&1008|E[A+2|0]>>>4,i[e+12>>2]=E[A+4|0]<<2|E[A+3|0]>>>6,n=n+1|0;I=I+1|0}for(A=Q+90160|0,I=Q+24592|0,h=Q+16|0;32!=(0|g);)B[A+g|0]=E[g+a|0],g=g+1|0;for(A=a+32|0,g=0;7!=(0|g);)q(I+(g<<10)|0,A+t(g,640)|0),g=g+1|0;a=a+4512|0,n=0,A=0;I:{for(;;){g:if(8!=(0|n)){for(e=h+(n<<10)|0,g=0;256!=(0|g);)i[e+(g<<2)>>2]=0,g=g+1|0;if(!((I=E[(c=n+a|0)+75|0])>>>0>75||(g=A,I>>>0<A>>>0))){for(;I>>>0>g>>>0;){if(A>>>0<g>>>0&(I=E[0|(G=g+a|0)])>>>0<=E[G-1|0])break g;i[e+(I<<2)>>2]=1,g=g+1|0,I=E[c+75|0]}n=n+1|0,A=I;continue}}else for(g=A>>>0>75?A:75;;){if(I=0,(0|A)==(0|g))break I;if(I=A+a|0,A=A+1|0,E[0|I])break}break}I=1}if(!I&&!P(Q+24592|0)){for(s(n=Q+90192|0,32,C,2592),O(A=Q+8|0),nA(A,n,32),nA(A,f,r),tA(A),oA(n,64,A),rA(A),w(r=Q+89104|0,Q+90160|0),Y(I=Q+31760|0,Q+90256|0),eA(C=Q+24592|0),l(g=Q+8208|0,I,C),d(r),C=Q+16400|0,I=0;8!=(0|I);){for(a=C+(I<<10)|0,f=0;256!=(0|f);)i[(e=a+(f<<2)|0)>>2]=i[e>>2]<<13,f=f+1|0;I=I+1|0}for(aA(C),AA(C,r,C),p(g,g,C),BA(g),CA(g),v(g),e=Q+16|0,C=0;8!=(0|C);){for(h=(I=C<<10)+g|0,c=I+g|0,G=I+e|0,I=0;256!=(0|I);)y=(r=I<<2)+h|0,F=i[r+G>>2],D=f=D-16|0,r=a=V(f+12|0,i[r+c>>2]),F&&(r=a+1&15,i[f+12>>2]>0||(r=a-1&15)),D=f+16|0,i[y>>2]=r,I=I+1|0;C=C+1|0}for(K(I=Q+90288|0,g),O(A),nA(A,n,64),nA(A,I,1024),tA(A),oA(Q+90128|0,32,A),rA(A),I=0;;){if(32==(0|I)){u=0;break A}if(A=(Q+90128|0)+I|0,g=(Q+90160|0)+I|0,I=I+1|0,E[0|g]!=E[0|A])break}}}return D=Q+91312|0,0|u}}}(A)}(P)},instantiate:function(A,I){return{then:function(I){var g=new y.Module(A);I({instance:new y.Instance(g)})}}},RuntimeError:Error};D=[],"object"!=A(y)&&M("no native wasm support detected");var s,u,F,w,Y,N=!1;var S,k=E.INITIAL_MEMORY||16777216;(G=E.wasmMemory?E.wasmMemory:new y.Memory({initial:k/65536,maximum:k/65536}))&&(s=G.buffer),k=s.byteLength,s=S=s,E.HEAP8=u=new Int8Array(S),E.HEAP16=new Int16Array(S),E.HEAP32=w=new Int32Array(S),E.HEAPU8=F=new Uint8Array(S),E.HEAPU16=new Uint16Array(S),E.HEAPU32=new Uint32Array(S),E.HEAPF32=new Float32Array(S),E.HEAPF64=Y=new Float64Array(S);var d=[],U=[],H=[];function R(){return h}var q=0,J=null,l=null;function M(A){throw E.onAbort&&E.onAbort(A),c(A="Aborted("+A+")"),N=!0,1,A+=". Build with -sASSERTIONS for more info.",new y.RuntimeError(A)}var L,m,p="data:application/octet-stream;base64,";function b(A){return A.startsWith(p)}function K(A){return A.startsWith("file://")}function v(A){try{if(A==L&&D)return new Uint8Array(D);var I=T(A);if(I)return I;if(B)return B(A);throw"both async and sync fetching of the wasm failed"}catch(A){M(A)}}b(L="<<< WASM_BINARY_FILE >>>")||(m=L,L=E.locateFile?E.locateFile(m,f):f+m);var O={2340:function(){return E.getRandomValue()},2376:function(){if(void 0===E.getRandomValue)try{var I="object"===("undefined"==typeof window?"undefined":A(window))?window:self,g=void 0!==I.crypto?I.crypto:I.msCrypto,B=function(){var A=new Uint32Array(1);return g.getRandomValues(A),A[0]>>>0};B(),E.getRandomValue=B}catch(A){try{var C=eval("require")("crypto"),Q=function(){var A=C.randomBytes(4);return(A[0]<<24|A[1]<<16|A[2]<<8|A[3])>>>0};Q(),E.getRandomValue=Q}catch(A){throw"No secure random number generator found"}}}};function x(A){for(;A.length>0;)A.shift()(E)}var j=[];var W="function"==typeof atob?atob:function(A){var I,g,B,C,Q,i,E="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",o="",n=0;A=A.replace(/[^A-Za-z0-9\+\/\=]/g,"");do{I=E.indexOf(A.charAt(n++))<<2|(C=E.indexOf(A.charAt(n++)))>>4,g=(15&C)<<4|(Q=E.indexOf(A.charAt(n++)))>>2,B=(3&Q)<<6|(i=E.indexOf(A.charAt(n++))),o+=String.fromCharCode(I),64!==Q&&(o+=String.fromCharCode(g)),64!==i&&(o+=String.fromCharCode(B))}while(n<A.length);return o};function T(A){if(b(A))return function(A){if("boolean"==typeof e&&e){var I=Buffer.from(A,"base64");return new Uint8Array(I.buffer,I.byteOffset,I.byteLength)}try{for(var g=W(A),B=new Uint8Array(g.length),C=0;C<g.length;++C)B[C]=g.charCodeAt(C);return B}catch(A){throw new Error("Converting base64 string to bytes failed.")}}(A.slice(p.length))}var V,P={c:function(A,I,g){var B=function(A,I){var g;for(j.length=0,I>>=2;g=F[A++];)I+=105!=g&I,j.push(105==g?w[I]:Y[I++>>1]),++I;return j}(I,g);return O[A].apply(null,B)},d:function(A){F.length,M("OOM")},b:function(A){!function(A,I){A,function(A){A,R()||(E.onExit&&E.onExit(A),N=!0);t(A,new X(A))}(A)}(A)},a:G};(function(){var A={a:P};function I(A,I){var g,B=A.exports;E.asm=B,E.asm.f,g=E.asm.e,U.unshift(g),function(A){if(q--,E.monitorRunDependencies&&E.monitorRunDependencies(q),0==q&&(null!==J&&(clearInterval(J),J=null),l)){var I=l;l=null,I()}}()}function B(A){I(A.instance)}function C(I){return function(){if(!D&&(r||a)){if("function"==typeof fetch&&!K(L))return fetch(L,{credentials:"same-origin"}).then((function(A){if(!A.ok)throw"failed to load wasm binary file at '"+L+"'";return A.arrayBuffer()})).catch((function(){return v(L)}));if(g)return new Promise((function(A,I){g(L,(function(I){A(new Uint8Array(I))}),I)}))}return Promise.resolve().then((function(){return v(L)}))}().then((function(I){return y.instantiate(I,A)})).then((function(A){return A})).then(I,(function(A){c("failed to asynchronously prepare wasm: "+A),M(A)}))}if(q++,E.monitorRunDependencies&&E.monitorRunDependencies(q),E.instantiateWasm)try{return E.instantiateWasm(A,I)}catch(A){return c("Module.instantiateWasm callback failed with error: "+A),!1}D||"function"!=typeof y.instantiateStreaming||b(L)||K(L)||e||"function"!=typeof fetch?C(B):fetch(L,{credentials:"same-origin"}).then((function(I){return y.instantiateStreaming(I,A).then(B,(function(A){return c("wasm streaming compile failed: "+A),c("falling back to ArrayBuffer instantiation"),C(B)}))}))})(),E.___wasm_call_ctors=function(){return(E.___wasm_call_ctors=E.asm.e).apply(null,arguments)},E._malloc=function(){return(E._malloc=E.asm.g).apply(null,arguments)},E._free=function(){return(E._free=E.asm.h).apply(null,arguments)},E._dilithiumjs_init=function(){return(E._dilithiumjs_init=E.asm.i).apply(null,arguments)},E._dilithiumjs_public_key_bytes=function(){return(E._dilithiumjs_public_key_bytes=E.asm.j).apply(null,arguments)},E._dilithiumjs_secret_key_bytes=function(){return(E._dilithiumjs_secret_key_bytes=E.asm.k).apply(null,arguments)},E._dilithiumjs_signature_bytes=function(){return(E._dilithiumjs_signature_bytes=E.asm.l).apply(null,arguments)},E._dilithiumjs_keypair=function(){return(E._dilithiumjs_keypair=E.asm.m).apply(null,arguments)},E._dilithiumjs_sign=function(){return(E._dilithiumjs_sign=E.asm.n).apply(null,arguments)},E._dilithiumjs_verify=function(){return(E._dilithiumjs_verify=E.asm.o).apply(null,arguments)};function X(A){this.name="ExitStatus",this.message="Program terminated with exit("+A+")",this.status=A}function Z(A){function I(){V||(V=!0,E.calledRun=!0,N||(!0,x(U),E.onRuntimeInitialized&&E.onRuntimeInitialized(),function(){if(E.postRun)for("function"==typeof E.postRun&&(E.postRun=[E.postRun]);E.postRun.length;)A=E.postRun.shift(),H.unshift(A);var A;x(H)}()))}A=A||n,q>0||(!function(){if(E.preRun)for("function"==typeof E.preRun&&(E.preRun=[E.preRun]);E.preRun.length;)A=E.preRun.shift(),d.unshift(A);var A;x(d)}(),q>0||(E.setStatus?(E.setStatus("Running..."),setTimeout((function(){setTimeout((function(){E.setStatus("")}),1),I()}),1)):I()))}if(E.writeArrayToMemory=function(A,I){u.set(A,I)},l=function A(){V||Z(),V||(l=A)},E.run=Z,E.preInit)for("function"==typeof E.preInit&&(E.preInit=[E.preInit]);E.preInit.length>0;)E.preInit.pop()();return Z(),new Promise((function(A,I){E.onAbort=I,E.onRuntimeInitialized=function(){A(E)}}))})).then((function(A){Object.keys(A).forEach((function(I){B[I]=A[I]}))}));var E=B.ready.then((function(){B._dilithiumjs_init(),A=B._dilithiumjs_public_key_bytes(),I=B._dilithiumjs_secret_key_bytes(),g=B._dilithiumjs_signature_bytes()})),o={publicKeyBytes:E.then((function(){return A})),privateKeyBytes:E.then((function(){return I})),bytes:E.then((function(){return g})),keyPair:function(){return E.then((function(){var g=B._malloc(A),E=B._malloc(I);try{return C(B._dilithiumjs_keypair(g,E),{publicKey:Q(g,A),privateKey:Q(E,I)})}finally{i(g),i(E)}}))},sign:function(A,I){return o.signDetached(A,I).then((function(I){var B=new Uint8Array(g+A.length);return B.set(I),B.set(A,g),B}))},signDetached:function(A,o){return E.then((function(){var E=B._malloc(g),n=B._malloc(A.length),t=B._malloc(I);B.writeArrayToMemory(new Uint8Array(g),E),B.writeArrayToMemory(A,n),B.writeArrayToMemory(o,t);try{return C(B._dilithiumjs_sign(E,n,A.length,t),Q(E,g))}finally{i(E),i(n),i(t)}}))},open:function(A,I){return E.then((function(){var B=new Uint8Array(A.buffer,A.byteOffset,g),C=new Uint8Array(A.buffer,A.byteOffset+g);return o.verifyDetached(B,C,I).then((function(A){if(A)return C;throw new Error("Failed to open Dilithium signed message.")}))}))},verifyDetached:function(I,C,Q){return E.then((function(){var E=B._malloc(g),o=B._malloc(C.length),n=B._malloc(A);B.writeArrayToMemory(I,E),B.writeArrayToMemory(C,o),B.writeArrayToMemory(Q,n);try{return 0===B._dilithiumjs_verify(o,C.length,E,n)}finally{i(E),i(o),i(n)}}))}};return o}(); true&&module.exports?(dilithium.dilithium=dilithium,module.exports=dilithium):self.dilithium=dilithium;
...
/******/ 	superDilithium = __webpack_exports__;
/******/ 	
/******/ })()
;