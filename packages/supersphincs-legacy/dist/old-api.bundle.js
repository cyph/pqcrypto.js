...
var sha512		= __webpack_require__(1);
var rsaSign		= __webpack_require__(2);
var sodiumUtil	= __webpack_require__(26);
var sphincs		= __webpack_require__(27);
...
asn1.define = (__webpack_require__(7).define);
...
Entity.prototype._createNamed = function createNamed(base) {
  var named;
  try {
    named = (__webpack_require__(9).runInThisContext)(
...
base.Reporter = (__webpack_require__(11).Reporter);
...
var __dirname = "/";
var sphincs=function(){var A,I,g,B,C,Q=function(){var A={};return A.ready=new Promise((function(A,I){function g(A){return g="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(A){return typeof A}:function(A){return A&&"function"==typeof Symbol&&A.constructor===Symbol&&A!==Symbol.prototype?"symbol":typeof A},g(A)}(n={}).onAbort=I,n.onRuntimeInitialized=function(){try{n._sphincsjs_public_key_bytes(),A(n)}catch(A){I(A)}};var B,C,Q,i,E,o,n=void 0!==n?n:{},r=Object.assign({},n),t=[],e="object"==("undefined"==typeof window?"undefined":g(window)),a="function"==typeof importScripts,D="object"==("undefined"==typeof process?"undefined":g(process))&&"object"==g(process.versions)&&"string"==typeof process.versions.node,c="";D?(c=a?eval("require")("path").dirname(c)+"/":__dirname+"/",o=function(){E||(i=eval("require")("fs"),E=eval("require")("path"))},B=function(A,I){var g=W(A);return g?I?g:g.toString():(o(),A=E.normalize(A),i.readFileSync(A,I?void 0:"utf8"))},Q=function(A){var I=B(A,!0);return I.buffer||(I=new Uint8Array(I)),I},C=function(A,I,g){var B=W(A);B&&I(B),o(),A=E.normalize(A),i.readFile(A,(function(A,B){A?g(A):I(B.buffer)}))},process.argv.length>1&&process.argv[1].replace(/\\/g,"/"),t=process.argv.slice(2), true&&(module.exports=n),process.on("uncaughtException",(function(A){if(!(A instanceof v))throw A})),process.on("unhandledRejection",(function(A){throw A})),function(A,I){if(s)throw process.exitCode=A,I;var g;(g=I)instanceof v||y("exiting due to exception: "+g),process.exit(A)},n.inspect=function(){return"[Emscripten Module object]"}):(e||a)&&(a?c=self.location.href:"undefined"!=typeof document&&document.currentScript&&(c=document.currentScript.src),c=0!==c.indexOf("blob:")?c.substr(0,c.replace(/[?#].*/,"").lastIndexOf("/")+1):"",B=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.send(null),I.responseText}catch(I){var g=W(A);if(g)return function(A){for(var I=[],g=0;g<A.length;g++){var B=A[g];B>255&&(B&=255),I.push(String.fromCharCode(B))}return I.join("")}(g);throw I}},a&&(Q=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.responseType="arraybuffer",I.send(null),new Uint8Array(I.response)}catch(I){var g=W(A);if(g)return g;throw I}}),C=function(A,I,g){var B=new XMLHttpRequest;B.open("GET",A,!0),B.responseType="arraybuffer",B.onload=function(){if(200==B.status||0==B.status&&B.response)I(B.response);else{var C=W(A);C?I(C.buffer):g()}},B.onerror=g,B.send(null)});n.print||console.log.bind(console);var f,y=n.printErr||console.warn.bind(console);Object.assign(n,r),r=null,n.arguments&&(t=n.arguments),n.thisProgram&&n.thisProgram,n.quit&&n.quit,n.wasmBinary&&(f=n.wasmBinary);var w,s=n.noExitRuntime||!0;"object"!=("undefined"==typeof WebAssembly?"undefined":g(WebAssembly))&&p("no native wasm support detected");var h,F,k,G,u=!1;n.INITIAL_MEMORY;var R=[],M=[],S=[];var N=0,H=null,Y=null;function p(A){throw n.onAbort&&n.onAbort(A),y(A="Aborted("+A+")"),u=!0,1,A+=". Build with -sASSERTIONS for more info.",new WebAssembly.RuntimeError(A)}var U,d,l="data:application/octet-stream;base64,";function q(A){return A.startsWith(l)}function J(A){return A.startsWith("file://")}function L(A){try{if(A==U&&f)return new Uint8Array(f);var I=W(A);if(I)return I;if(Q)return Q(A);throw"both async and sync fetching of the wasm failed"}catch(A){p(A)}}q(U="data:application/octet-stream;base64,")||(d=U,U=n.locateFile?n.locateFile(d,c):c+d);var K={2088:function(){return n.getRandomValue()},2124:function(){if(void 0===n.getRandomValue)try{var A="object"===("undefined"==typeof window?"undefined":g(window))?window:self,I=void 0!==A.crypto?A.crypto:A.msCrypto,B=function(){var A=new Uint32Array(1);return I.getRandomValues(A),A[0]>>>0};B(),n.getRandomValue=B}catch(A){try{var C=eval("require")("crypto"),Q=function(){var A=C.randomBytes(4);return(A[0]<<24|A[1]<<16|A[2]<<8|A[3])>>>0};Q(),n.getRandomValue=Q}catch(A){throw"No secure random number generator found"}}}};function b(A){for(;A.length>0;)A.shift()(n)}var m=[];var O="function"==typeof atob?atob:function(A){var I,g,B,C,Q,i,E="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",o="",n=0;A=A.replace(/[^A-Za-z0-9\+\/\=]/g,"");do{I=E.indexOf(A.charAt(n++))<<2|(C=E.indexOf(A.charAt(n++)))>>4,g=(15&C)<<4|(Q=E.indexOf(A.charAt(n++)))>>2,B=(3&Q)<<6|(i=E.indexOf(A.charAt(n++))),o+=String.fromCharCode(I),64!==Q&&(o+=String.fromCharCode(g)),64!==i&&(o+=String.fromCharCode(B))}while(n<A.length);return o};function W(A){if(q(A))return function(A){if("boolean"==typeof D&&D){var I=Buffer.from(A,"base64");return new Uint8Array(I.buffer,I.byteOffset,I.byteLength)}try{for(var g=O(A),B=new Uint8Array(g.length),C=0;C<g.length;++C)B[C]=g.charCodeAt(C);return B}catch(A){throw new Error("Converting base64 string to bytes failed.")}}(A.slice(l.length))}var j,P={a:function(A,I,g){var B=function(A,I){var g;for(m.length=0,I>>=2;g=F[A++];)I+=105!=g&I,m.push(105==g?k[I]:G[I++>>1]),++I;return m}(I,g);return K[A].apply(null,B)},c:function(A,I,g){F.copyWithin(A,I,I+g)},b:function(A){F.length,p("OOM")}};(function(){var A={a:P};function I(A,I){var g,B,C=A.exports;n.asm=C,w=n.asm.d,g=w.buffer,g,n.HEAP8=h=new Int8Array(g),n.HEAP16=new Int16Array(g),n.HEAP32=k=new Int32Array(g),n.HEAPU8=F=new Uint8Array(g),n.HEAPU16=new Uint16Array(g),n.HEAPU32=new Uint32Array(g),n.HEAPF32=new Float32Array(g),n.HEAPF64=G=new Float64Array(g),n.asm.f,B=n.asm.e,M.unshift(B),function(A){if(N--,n.monitorRunDependencies&&n.monitorRunDependencies(N),0==N&&(null!==H&&(clearInterval(H),H=null),Y)){var I=Y;Y=null,I()}}()}function g(A){I(A.instance)}function B(I){return function(){if(!f&&(e||a)){if("function"==typeof fetch&&!J(U))return fetch(U,{credentials:"same-origin"}).then((function(A){if(!A.ok)throw"failed to load wasm binary file at '"+U+"'";return A.arrayBuffer()})).catch((function(){return L(U)}));if(C)return new Promise((function(A,I){C(U,(function(I){A(new Uint8Array(I))}),I)}))}return Promise.resolve().then((function(){return L(U)}))}().then((function(I){return WebAssembly.instantiate(I,A)})).then((function(A){return A})).then(I,(function(A){y("failed to asynchronously prepare wasm: "+A),p(A)}))}if(N++,n.monitorRunDependencies&&n.monitorRunDependencies(N),n.instantiateWasm)try{return n.instantiateWasm(A,I)}catch(A){return y("Module.instantiateWasm callback failed with error: "+A),!1}f||"function"!=typeof WebAssembly.instantiateStreaming||q(U)||J(U)||D||"function"!=typeof fetch?B(g):fetch(U,{credentials:"same-origin"}).then((function(I){return WebAssembly.instantiateStreaming(I,A).then(g,(function(A){return y("wasm streaming compile failed: "+A),y("falling back to ArrayBuffer instantiation"),B(g)}))}))})(),n.___wasm_call_ctors=function(){return(n.___wasm_call_ctors=n.asm.e).apply(null,arguments)},n._sphincsjs_init=function(){return(n._sphincsjs_init=n.asm.g).apply(null,arguments)},n._sphincsjs_public_key_bytes=function(){return(n._sphincsjs_public_key_bytes=n.asm.h).apply(null,arguments)},n._sphincsjs_secret_key_bytes=function(){return(n._sphincsjs_secret_key_bytes=n.asm.i).apply(null,arguments)},n._sphincsjs_signature_bytes=function(){return(n._sphincsjs_signature_bytes=n.asm.j).apply(null,arguments)},n._sphincsjs_keypair=function(){return(n._sphincsjs_keypair=n.asm.k).apply(null,arguments)},n._sphincsjs_open=function(){return(n._sphincsjs_open=n.asm.l).apply(null,arguments)},n._sphincsjs_sign=function(){return(n._sphincsjs_sign=n.asm.m).apply(null,arguments)},n._malloc=function(){return(n._malloc=n.asm.n).apply(null,arguments)},n._free=function(){return(n._free=n.asm.o).apply(null,arguments)};function v(A){this.name="ExitStatus",this.message="Program terminated with exit("+A+")",this.status=A}function Z(A){function I(){j||(j=!0,n.calledRun=!0,u||(!0,b(M),n.onRuntimeInitialized&&n.onRuntimeInitialized(),function(){if(n.postRun)for("function"==typeof n.postRun&&(n.postRun=[n.postRun]);n.postRun.length;)A=n.postRun.shift(),S.unshift(A);var A;b(S)}()))}A=A||t,N>0||(!function(){if(n.preRun)for("function"==typeof n.preRun&&(n.preRun=[n.preRun]);n.preRun.length;)A=n.preRun.shift(),R.unshift(A);var A;b(R)}(),N>0||(n.setStatus?(n.setStatus("Running..."),setTimeout((function(){setTimeout((function(){n.setStatus("")}),1),I()}),1)):I()))}if(n.writeArrayToMemory=function(A,I){h.set(A,I)},Y=function A(){j||Z(),j||(Y=A)},n.run=Z,n.preInit)for("function"==typeof n.preInit&&(n.preInit=[n.preInit]);n.preInit.length>0;)n.preInit.pop()();Z()})).catch((function(){function A(I){return A="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(A){return typeof A}:function(A){return A&&"function"==typeof Symbol&&A.constructor===Symbol&&A!==Symbol.prototype?"symbol":typeof A},A(I)}var I,g,B,C,Q,i,E=void 0!==(E={})?E:{},o=Object.assign({},E),n=[],r="object"==("undefined"==typeof window?"undefined":A(window)),t="function"==typeof importScripts,e="object"==("undefined"==typeof process?"undefined":A(process))&&"object"==A(process.versions)&&"string"==typeof process.versions.node,a="";e?(a=t?eval("require")("path").dirname(a)+"/":__dirname+"/",i=function(){Q||(C=eval("require")("fs"),Q=eval("require")("path"))},I=function(A,I){var g=P(A);return g?I?g:g.toString():(i(),A=Q.normalize(A),C.readFileSync(A,I?void 0:"utf8"))},B=function(A){var g=I(A,!0);return g.buffer||(g=new Uint8Array(g)),g},g=function(A,I,g){var B=P(A);B&&I(B),i(),A=Q.normalize(A),C.readFile(A,(function(A,B){A?g(A):I(B.buffer)}))},process.argv.length>1&&process.argv[1].replace(/\\/g,"/"),n=process.argv.slice(2), true&&(module.exports=E),process.on("uncaughtException",(function(A){if(!(A instanceof X))throw A})),process.on("unhandledRejection",(function(A){throw A})),function(A,I){if(y)throw process.exitCode=A,I;var g;(g=I)instanceof X||c("exiting due to exception: "+g),process.exit(A)},E.inspect=function(){return"[Emscripten Module object]"}):(r||t)&&(t?a=self.location.href:"undefined"!=typeof document&&document.currentScript&&(a=document.currentScript.src),a=0!==a.indexOf("blob:")?a.substr(0,a.replace(/[?#].*/,"").lastIndexOf("/")+1):"",I=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.send(null),I.responseText}catch(I){var g=P(A);if(g)return function(A){for(var I=[],g=0;g<A.length;g++){var B=A[g];B>255&&(B&=255),I.push(String.fromCharCode(B))}return I.join("")}(g);throw I}},t&&(B=function(A){try{var I=new XMLHttpRequest;return I.open("GET",A,!1),I.responseType="arraybuffer",I.send(null),new Uint8Array(I.response)}catch(I){var g=P(A);if(g)return g;throw I}}),g=function(A,I,g){var B=new XMLHttpRequest;B.open("GET",A,!0),B.responseType="arraybuffer",B.onload=function(){if(200==B.status||0==B.status&&B.response)I(B.response);else{var C=P(A);C?I(C.buffer):g()}},B.onerror=g,B.send(null)});E.print||console.log.bind(console);var D,c=E.printErr||console.warn.bind(console);Object.assign(E,o),o=null,E.arguments&&(n=E.arguments),E.thisProgram&&E.thisProgram,E.quit&&E.quit,E.wasmBinary&&(D=E.wasmBinary);var f,y=E.noExitRuntime||!0,w={Memory:function(A){this.buffer=new ArrayBuffer(65536*A.initial)},Module:function(A){},Instance:function(A,I){this.exports=function(A){for(var I,g=new Uint8Array(123),B=25;B>=0;--B)g[48+B]=52+B,g[65+B]=B,g[97+B]=26+B;function C(A,I,B){for(var C,Q,i=0,E=I,o=B.length,n=I+(3*o>>2)-("="==B[o-2])-("="==B[o-1]);i<o;i+=4)C=g[B.charCodeAt(i+1)],Q=g[B.charCodeAt(i+2)],A[E++]=g[B.charCodeAt(i)]<<2|C>>4,E<n&&(A[E++]=C<<4|Q>>2),E<n&&(A[E++]=Q<<6|g[B.charCodeAt(i+3)])}return g[43]=62,g[47]=63,function(A){var g=A.a.buffer,B=new Int8Array(g),Q=(new Int16Array(g),new Int32Array(g)),i=new Uint8Array(g),E=new Uint16Array(g),o=new Uint32Array(g),n=(new Float32Array(g),new Float64Array(g),Math.imul),r=(Math.fround,Math.abs,Math.clz32,Math.min,Math.max,Math.floor,Math.ceil,Math.trunc,Math.sqrt,A.abort,A.b),t=A.c,e=8391968,a=0;function D(A,I){var g,B=0,C=0,E=0,o=0,n=0,r=0,t=0,D=0,c=0,f=0,y=0,w=0,s=0,h=0,F=0,k=0,G=0,u=0,M=0,S=0,N=0,H=0,Y=0,p=0,U=0,d=0,l=0,q=0,J=0,L=0,K=0,b=0,m=0,O=0,W=0,j=0,P=0,v=0,Z=0,X=0,z=0,x=0,T=0,V=0,_=0,$=0,AA=0,IA=0,gA=0;for(e=g=e-256|0;;){if(!E&16==(0|f)){for(;!(!D&8==(0|C));)B=(I=C<<3)+(g+128|0)|0,y=Q[(I=A+I|0)+4>>2],Q[B>>2]=Q[I>>2],Q[B+4>>2]=y,B=D,C=I=C+1|0,D=B=I?B:B+1|0;for(B=Q[A+64>>2],y=Q[A+68>>2],D=Q[A+88>>2],E=Q[A+92>>2],C=Q[A+80>>2],w=Q[A+84>>2],H=Q[A+72>>2],J=Q[A+76>>2],Q[A+116>>2]?(p=887688300,t=-1101764913,c=-914599715,z=-1253635817,U=1065670069,L=953160567,h=1160258022,I=-1062458953):(p=887688300^(h=Q[A+96>>2]),t=-1101764913^(u=Q[A+100>>2]),z=-1253635817^(I=Q[A+104>>2]),U=1065670069^(M=Q[A+108>>2]),c=-914599715^I,L=953160567^h,h=1160258022^u,I=-1062458953^M),x=-2052912941^B,u=608135816^y,_=-330404727^D,M=137296536^E,l=698298832^C,w^=-1542899678,s=57701188^H,H=320440878^J,J=0,y=0,N=Q[g+152>>2],K=Q[g+156>>2],C=Q[g+184>>2],D=Q[g+188>>2],Y=Q[g+144>>2],m=Q[g+148>>2],f=Q[g+176>>2],E=Q[g+180>>2],G=Q[g+136>>2],d=Q[g+140>>2],F=Q[g+168>>2],r=Q[g+172>>2],b=Q[g+128>>2],O=Q[g+132>>2],o=Q[g+160>>2],n=Q[g+164>>2];;){if(!y&16==(0|J)){for(Q[g+224>>2]=L,Q[g+228>>2]=h,Q[g+128>>2]=b,Q[g+132>>2]=O,Q[g+160>>2]=o,Q[g+164>>2]=n,Q[g+192>>2]=x,Q[g+196>>2]=u,Q[g+168>>2]=F,Q[g+172>>2]=r,Q[g+232>>2]=p,Q[g+236>>2]=t,Q[g+136>>2]=G,Q[g+140>>2]=d,Q[g+200>>2]=s,Q[g+204>>2]=H,Q[g+176>>2]=f,Q[g+180>>2]=E,Q[g+240>>2]=c,Q[g+244>>2]=I,Q[g+144>>2]=Y,Q[g+148>>2]=m,Q[g+208>>2]=l,Q[g+212>>2]=w,Q[g+184>>2]=C,Q[g+188>>2]=D,Q[g+248>>2]=z,Q[g+252>>2]=U,Q[g+152>>2]=N,Q[g+156>>2]=K,Q[g+216>>2]=_,Q[g+220>>2]=M,J=0,y=0,C=0,D=0;;){if(!D&16==(0|C)){for(;!(!y&8==(0|J));)B=Q[(I=(J<<3)+A|0)>>2],E=Q[(D=(((3&J)<<3)+A|0)- -64|0)>>2],D=Q[I+4>>2]^Q[D+4>>2],Q[I>>2]=B^E,Q[I+4>>2]=D,B=y,J=I=J+1|0,y=B=I?B:B+1|0;e=g+256|0;break}B=Q[(I=((7&C)<<3)+A|0)>>2],h=Q[(E=(g+128|0)+(C<<3)|0)>>2],E=Q[I+4>>2]^Q[E+4>>2],Q[I>>2]=B^h,Q[I+4>>2]=E,I=D,C=B=C+1|0,D=I=B?I:I+1|0}break}B=(S=i[(k=1504+(J<<4)|0)+10|0]<<3)+1824|0,v=(j=i[k+11|0]<<3)+g|0,q=Q[B>>2]^Q[v>>2],v=Q[B+4>>2]^Q[v+4>>2],W=f,Z=l,X=c,B=(l=i[k+5|0]<<3)+1824|0,P=(T=i[k+4|0]<<3)+g|0,c=f+(Q[B>>2]^Q[P>>2])|0,B=E+(Q[B+4>>2]^Q[P+4>>2])|0,B=(B=f>>>0>c>>>0?B+1|0:B)+m|0,m=R(X^(f=c+Y|0),I^(B=f>>>0<Y>>>0?B+1|0:B),32),I=(c=a)+w|0,P=R(W^(w=Y=Z+m|0),(I=w>>>0<m>>>0?I+1|0:I)^E,39),B=B+(V=a)|0,B=(E=P+f|0)>>>0<f>>>0?B+1|0:B,Y=g+l|0,E=(l=Q[(f=T+1824|0)>>2]^Q[Y>>2])+E|0,B=(Q[f+4>>2]^Q[Y+4>>2])+B|0,Y=E,T=R(f=m^E,c^(m=E>>>0<l>>>0?B+1|0:B),48),B=I+($=a)|0,B=(E=w+T|0)>>>0<w>>>0?B+1|0:B,w=E,c=B,E=R(P^E,V^B,53),f=I=a,W=q,Z=F,q=s,X=p,B=(p=i[k+3|0]<<3)+1824|0,s=(l=i[k+2|0]<<3)+g|0,I=F+(Q[B>>2]^Q[s>>2])|0,B=r+(Q[B+4>>2]^Q[s+4>>2])|0,B=I>>>0<F>>>0?B+1|0:B,F=I+G|0,I=B+d|0,t=q+(G=s=R(X^F,(I=F>>>0<G>>>0?I+1|0:I)^t,32))|0,B=(q=a)+H|0,P=R(Z^(H=t),(t=t>>>0<G>>>0?B+1|0:B)^r,39),B=I+(V=a)|0,B=(r=P+F|0)>>>0<F>>>0?B+1|0:B,I=r,r=g+p|0,I=I+(G=Q[(F=l+1824|0)>>2]^Q[r>>2])|0,B=(Q[F+4>>2]^Q[r+4>>2])+B|0,l=I,r=I,F=B=I>>>0<G>>>0?B+1|0:B,B=B+f|0,B=(I=I+E|0)>>>0<r>>>0?B+1|0:B,G=g+S|0,r=(r=I)+(d=Q[(I=j+1824|0)>>2]^Q[G>>2])|0,I=(Q[I+4>>2]^Q[G+4>>2])+B|0,I=r>>>0<d>>>0?I+1|0:I,d=r,G=r,B=I+v|0,S=r=W+r|0,r=r>>>0<G>>>0?B+1|0:B,G=I,W=d,Z=o,X=L,B=(L=i[k+1|0]<<3)+1824|0,p=(d=i[0|k]<<3)+g|0,I=o+(Q[B>>2]^Q[p>>2])|0,B=n+(Q[B+4>>2]^Q[p+4>>2])|0,B=(B=I>>>0<o>>>0?B+1|0:B)+O|0,o=I=I+b|0,b=R(X^I,(B=I>>>0<b>>>0?B+1|0:B)^h,32),I=(O=a)+u|0,x=h=b+x|0,j=R(Z^h,(u=h>>>0<b>>>0?I+1|0:I)^n,39),B=B+(v=a)|0,B=(I=j+o|0)>>>0<o>>>0?B+1|0:B,o=g+L|0,I=(n=Q[(h=d+1824|0)>>2]^Q[o>>2])+I|0,B=(Q[h+4>>2]^Q[o+4>>2])+B|0,o=I,p=R(b^I,O^(n=I>>>0<n>>>0?B+1|0:B),48),L=R(W^p,(AA=a)^G,32),h=I=a,W=S,Z=E,S=C,B=(G=i[k+7|0]<<3)+1824|0,E=(d=i[k+6|0]<<3)+g|0,I=C+(Q[B>>2]^Q[E>>2])|0,B=D+(Q[B+4>>2]^Q[E+4>>2])|0,B=(B=I>>>0<C>>>0?B+1|0:B)+K|0,E=B=(I=I+N|0)>>>0<N>>>0?B+1|0:B,U=R(I^z,B^U,32),B=(K=a)+M|0,N=D,D=B=(C=U+_|0)>>>0<U>>>0?B+1|0:B,S=R(S^C,N^B,39),B=I,I=E+(IA=a)|0,I=B>>>0>(M=S+B|0)>>>0?I+1|0:I,E=M,M=g+G|0,E=E+(N=Q[(B=d+1824|0)>>2]^Q[M>>2])|0,B=(Q[B+4>>2]^Q[M+4>>2])+I|0,X=E,U=R(U^E,K^(N=E>>>0<N>>>0?B+1|0:B),48),B=D+(b=a)|0,gA=I=C+U|0,E=I,D=B=I>>>0<C>>>0?B+1|0:B,B=B+h|0,E=B=(I=I+L|0)>>>0<E>>>0?B+1|0:B,M=R(Z^I,B^f,39),B=(f=a)+r|0,G=C=W+M|0,L=R(L^C,h^(d=C>>>0<M>>>0?B+1|0:B),48),B=E+(h=a)|0,_=C=I+L|0,f=R(E=M^C,f^(M=I>>>0>C>>>0?B+1|0:B),53),E=a,I=(C=i[k+8|0]<<3)+1824|0,B=(r=i[k+9|0]<<3)+g|0,K=Q[I>>2]^Q[B>>2],O=Q[I+4>>2]^Q[B+4>>2],W=K,s=R(s^l,F^q,48),B=t+(q=a)|0,B=(I=H+s|0)>>>0<H>>>0?B+1|0:B,H=I,K=B,t=R(P^I,V^B,53),I=n+(F=a)|0,I=(B=o+t|0)>>>0<o>>>0?I+1|0:I,n=B,B=r+1824|0,r=g+C|0,C=n+(o=Q[B>>2]^Q[r>>2])|0,B=(Q[B+4>>2]^Q[r+4>>2])+I|0,r=C,I=B=C>>>0<o>>>0?B+1|0:B,B=B+O|0,o=C=W+C|0,C=C>>>0<r>>>0?B+1|0:B,U=R(r^U,I^b,32),B=c+(r=a)|0,B=(I=w+U|0)>>>0<w>>>0?B+1|0:B,w=I,F=R(t^I,B^F,39),I=(I=C)+(C=a)|0,b=t=F+o|0,z=R(U^t,r^(O=t>>>0<F>>>0?I+1|0:I),48),B=B+(U=a)|0,l=I=w+z|0,F=R(F^I,C^(w=I>>>0<w>>>0?B+1|0:B),53),r=a,I=(C=i[k+12|0]<<3)+1824|0,B=(t=i[k+13|0]<<3)+g|0,o=Q[I>>2]^Q[B>>2],n=Q[I+4>>2]^Q[B+4>>2],c=o,o=R(S^gA,D^IA,53),B=m+(D=a)|0,B=(I=Y+o|0)>>>0<Y>>>0?B+1|0:B,C=g+C|0,I=(Y=Q[(t=t+1824|0)>>2]^Q[C>>2])+I|0,B=(Q[t+4>>2]^Q[C+4>>2])+B|0,t=I,C=c+I|0,I=(B=I>>>0<Y>>>0?B+1|0:B)+n|0,I=C>>>0<t>>>0?I+1|0:I,n=C,t=R(t^s,B^q,32),c=B=a,C=B,Y=n,s=o,B=u+AA|0,n=o=p+x|0,u=o+t|0,o=B=o>>>0<p>>>0?B+1|0:B,B=B+C|0,s=R(s^(C=u),(S=D)^(D=n>>>0>C>>>0?B+1|0:B),39),B=(S=a)+I|0,Y=u=Y+s|0,m=B=u>>>0<s>>>0?B+1|0:B,p=R(t^u,c^B,48),I=D+(t=a)|0,x=B=C+p|0,C=R(s^B,S^(u=B>>>0<C>>>0?I+1|0:I),53),D=a,I=(c=i[k+14|0]<<3)+1824|0,B=(k=i[k+15|0]<<3)+g|0,s=Q[I>>2]^Q[B>>2],S=Q[I+4>>2]^Q[B+4>>2],q=s,s=R(n^j,o^v,53),B=(I=a)+N|0,B=(o=(n=s)+X|0)>>>0<n>>>0?B+1|0:B,N=g+c|0,o=(c=Q[(n=k+1824|0)>>2]^Q[N>>2])+o|0,B=(Q[n+4>>2]^Q[N+4>>2])+B|0,N=o,n=q+o|0,B=(o=o>>>0<c>>>0?B+1|0:B)+S|0,B=n>>>0<N>>>0?B+1|0:B,c=n,n=I,q=c,c=R(N^T,o^$,32),I=K+(k=a)|0,I=(o=H+c|0)>>>0<H>>>0?I+1|0:I,H=o,o=I,S=R(H^s,I^n,39),B=(j=a)+B|0,N=I=q+(n=S)|0,c=R(c^I,k^(K=I>>>0<n>>>0?B+1|0:B),48),B=o+(I=a)|0,s=n=H+c|0,o=R(S^n,j^(H=n>>>0<H>>>0?B+1|0:B),53),n=a,B=y,J=y=J+1|0,y=B=y?B:B+1|0}break}u=(B=f<<3)+g|0,y=i[(B=I+B|0)+4|0]|i[B+5|0]<<8|i[B+6|0]<<16|i[B+7|0]<<24,M=(w=h=i[0|B]|i[B+1|0]<<8|i[B+2|0]<<16|i[B+3|0]<<24)<<24|w<<8&16711680,Q[u>>2]=-16777216&((255&y)<<24|w>>>8)|16711680&((16777215&y)<<8|w>>>24)|y>>>8&65280|y>>>24,B=0,Q[u+4>>2]=65280&(y<<24|w>>>8)|255&(y<<8|w>>>24)|M|B|B,B=E,f=y=f+1|0,E=B=y?B:B+1|0}}function c(A,I,g,C){var o,n,r,t,a=0,D=0,c=0,f=0;for(e=r=e-256|0,Q[(o=r+8|0)+56>>2]=327033209,Q[o+60>>2]=1541459225,Q[o+48>>2]=-79577749,Q[o+52>>2]=528734635,Q[o+40>>2]=725511199,Q[o+44>>2]=-1694144372,Q[o+32>>2]=-1377402159,Q[o+36>>2]=1359893119,Q[o+24>>2]=1595750129,Q[o+28>>2]=-1521486534,Q[o+16>>2]=-23791573,Q[o+20>>2]=1013904242,Q[o+8>>2]=-2067093701,Q[o+12>>2]=-1150833019,Q[o>>2]=-205731576,Q[o+4>>2]=1779033703,a=o- -64|0,c=56;B[0|a]=0,a=a+1|0,c=c-1|0;);k(o,D=I,(I=g)<<3,g=C<<3|I>>>29),e=C=e-32|0,B[C+15|0]=1,B[C+14|0]=129,f=Q[o+104>>2],c=Q[o+108>>2],a=(g=Q[o+96>>2])+(I=D=Q[o+112>>2])|0,I=(n=Q[o+100>>2])+(I>>31)|0,I=a>>>0<D>>>0?I+1|0:I,B[C+31|0]=a,B[C+30|0]=(255&I)<<24|a>>>8,B[C+29|0]=(65535&I)<<16|a>>>16,B[C+28|0]=(16777215&I)<<8|a>>>24,B[C+27|0]=I,B[C+26|0]=I>>>8,B[C+25|0]=I>>>16,B[C+24|0]=I>>>24,t=f,f=(0|I)==(0|n)&g>>>0>a>>>0|I>>>0<n>>>0,I=c,I=(a=t+f|0)>>>0<f>>>0?I+1|0:I,B[C+23|0]=a,B[C+22|0]=(255&I)<<24|a>>>8,B[C+21|0]=(65535&I)<<16|a>>>16,B[C+20|0]=(16777215&I)<<8|a>>>24,B[C+19|0]=I,B[C+18|0]=I>>>8,B[C+17|0]=I>>>16,B[C+16|0]=I>>>24,888!=(0|D)?((0|D)<=887?(D||(Q[o+116>>2]=1),I=888-D|0,Q[o+96>>2]=g-I,Q[o+100>>2]=n-(I>>>0>g>>>0),k(o,1952,I,0)):(I=1024-D|0,Q[o+96>>2]=g-I,a=I>>31,Q[o+100>>2]=n-(a+(I>>>0>g>>>0)|0),k(o,1952,I,a),I=Q[o+96>>2],g=Q[o+100>>2]-(I>>>0<888)|0,Q[o+96>>2]=I-888,Q[o+100>>2]=g,k(o,1953,888,0),Q[o+116>>2]=1),k(o,C+15|0,8,0),I=(g=Q[o+96>>2])-8|0,g=Q[o+100>>2]-(g>>>0<8)|0):(Q[o+96>>2]=g-8,Q[o+100>>2]=n-(g>>>0<8),k(o,C+14|0,8,0),I=Q[o+96>>2],g=Q[o+100>>2]),Q[o+96>>2]=I-128,Q[o+100>>2]=g-(I>>>0<128),k(o,C+16|0,128,0),B[0|A]=i[o+7|0],B[A+1|0]=E[o+6>>1],B[A+2|0]=Q[o+4>>2]>>>8,B[A+3|0]=Q[o+4>>2],B[A+4|0]=(16777215&Q[o+4>>2])<<8|Q[o>>2]>>>24,B[A+5|0]=(65535&Q[o+4>>2])<<16|Q[o>>2]>>>16,B[A+6|0]=(255&Q[o+4>>2])<<24|Q[o>>2]>>>8,B[A+7|0]=Q[o>>2],B[A+8|0]=i[o+15|0],B[A+9|0]=E[o+14>>1],B[A+10|0]=Q[o+12>>2]>>>8,B[A+11|0]=Q[o+12>>2],B[A+12|0]=(16777215&Q[o+12>>2])<<8|Q[o+8>>2]>>>24,B[A+13|0]=(65535&Q[o+12>>2])<<16|Q[o+8>>2]>>>16,B[A+14|0]=(255&Q[o+12>>2])<<24|Q[o+8>>2]>>>8,B[A+15|0]=Q[o+8>>2],B[A+16|0]=i[o+23|0],B[A+17|0]=E[o+22>>1],B[A+18|0]=Q[o+20>>2]>>>8,B[A+19|0]=Q[o+20>>2],B[A+20|0]=(16777215&Q[o+20>>2])<<8|Q[o+16>>2]>>>24,B[A+21|0]=(65535&Q[o+20>>2])<<16|Q[o+16>>2]>>>16,B[A+22|0]=(255&Q[o+20>>2])<<24|Q[o+16>>2]>>>8,B[A+23|0]=Q[o+16>>2],B[A+24|0]=i[o+31|0],B[A+25|0]=E[o+30>>1],B[A+26|0]=Q[o+28>>2]>>>8,B[A+27|0]=Q[o+28>>2],B[A+28|0]=(16777215&Q[o+28>>2])<<8|Q[o+24>>2]>>>24,B[A+29|0]=(65535&Q[o+28>>2])<<16|Q[o+24>>2]>>>16,B[A+30|0]=(255&Q[o+28>>2])<<24|Q[o+24>>2]>>>8,B[A+31|0]=Q[o+24>>2],B[A+32|0]=i[o+39|0],B[A+33|0]=E[o+38>>1],B[A+34|0]=Q[o+36>>2]>>>8,B[A+35|0]=Q[o+36>>2],B[A+36|0]=(16777215&Q[o+36>>2])<<8|Q[o+32>>2]>>>24,B[A+37|0]=(65535&Q[o+36>>2])<<16|Q[o+32>>2]>>>16,B[A+38|0]=(255&Q[o+36>>2])<<24|Q[o+32>>2]>>>8,B[A+39|0]=Q[o+32>>2],B[A+40|0]=i[o+47|0],B[A+41|0]=E[o+46>>1],B[A+42|0]=Q[o+44>>2]>>>8,B[A+43|0]=Q[o+44>>2],B[A+44|0]=(16777215&Q[o+44>>2])<<8|Q[o+40>>2]>>>24,B[A+45|0]=(65535&Q[o+44>>2])<<16|Q[o+40>>2]>>>16,B[A+46|0]=(255&Q[o+44>>2])<<24|Q[o+40>>2]>>>8,B[A+47|0]=Q[o+40>>2],B[A+48|0]=i[o+55|0],B[A+49|0]=E[o+54>>1],B[A+50|0]=Q[o+52>>2]>>>8,B[A+51|0]=Q[o+52>>2],B[A+52|0]=(16777215&Q[o+52>>2])<<8|Q[o+48>>2]>>>24,B[A+53|0]=(65535&Q[o+52>>2])<<16|Q[o+48>>2]>>>16,B[A+54|0]=(255&Q[o+52>>2])<<24|Q[o+48>>2]>>>8,B[A+55|0]=Q[o+48>>2],B[A+56|0]=i[o+63|0],B[A+57|0]=E[o+62>>1],B[A+58|0]=Q[o+60>>2]>>>8,B[A+59|0]=Q[o+60>>2],B[A+60|0]=(16777215&Q[o+60>>2])<<8|Q[o+56>>2]>>>24,B[A+61|0]=(65535&Q[o+60>>2])<<16|Q[o+56>>2]>>>16,B[A+62|0]=(255&Q[o+60>>2])<<24|Q[o+56>>2]>>>8,B[A+63|0]=Q[o+56>>2],e=C+32|0,e=r+256|0}function f(A,I,g){var C,E,o=0,n=0,r=0,t=0,a=0,D=0,c=0,f=0,y=0,w=0,s=0,h=0,F=0,k=0,G=0,u=0,R=0,M=0,S=0,N=0,H=0,Y=0,p=0,d=0,l=0;for(e=C=e+-64|0,Q[C+16>>2]=i[0|g]|i[g+1|0]<<8|i[g+2|0]<<16|i[g+3|0]<<24,Q[C+20>>2]=i[g+4|0]|i[g+5|0]<<8|i[g+6|0]<<16|i[g+7|0]<<24,Q[C+24>>2]=i[g+8|0]|i[g+9|0]<<8|i[g+10|0]<<16|i[g+11|0]<<24,Q[C+28>>2]=i[g+12|0]|i[g+13|0]<<8|i[g+14|0]<<16|i[g+15|0]<<24,Q[C+32>>2]=i[g+16|0]|i[g+17|0]<<8|i[g+18|0]<<16|i[g+19|0]<<24,Q[C+36>>2]=i[g+20|0]|i[g+21|0]<<8|i[g+22|0]<<16|i[g+23|0]<<24,Q[C+40>>2]=i[g+24|0]|i[g+25|0]<<8|i[g+26|0]<<16|i[g+27|0]<<24,g=i[g+28|0]|i[g+29|0]<<8|i[g+30|0]<<16|i[g+31|0]<<24,Q[C+12>>2]=1797285236,Q[C+8>>2]=2036477234,Q[C+4>>2]=857760878,Q[C>>2]=1634760805,Q[C+44>>2]=g,Q[C+48>>2]=0,Q[C+52>>2]=0,Q[C+56>>2]=i[2848]|i[2849]<<8|i[2850]<<16|i[2851]<<24,Q[C+60>>2]=i[2852]|i[2853]<<8|i[2854]<<16|i[2855]<<24;a|(0|I)!=(0|o);)B[A+o|0]=0,a=(o=o+1|0)?a:a+1|0;g=A,e=E=e+-64|0;A:if(I)for(;;){for(r=0,n=e+-64|0;;){if(16==(0|r)){for(y=Q[n+44>>2],a=Q[n+60>>2],r=Q[n+28>>2],G=Q[n+12>>2],c=Q[n+40>>2],u=Q[n+56>>2],t=Q[n+24>>2],w=Q[n+8>>2],S=Q[n+36>>2],s=Q[n+52>>2],D=Q[n+20>>2],R=Q[n+4>>2],M=Q[n+32>>2],h=Q[n+48>>2],f=Q[n+16>>2],o=Q[n>>2],H=12;;){if(!H){for(Q[n+48>>2]=h,Q[n+16>>2]=f,Q[n>>2]=o,Q[n+32>>2]=M,Q[n+52>>2]=s,Q[n+20>>2]=D,Q[n+4>>2]=R,Q[n+36>>2]=S,Q[n+56>>2]=u,Q[n+24>>2]=t,Q[n+8>>2]=w,Q[n+40>>2]=c,Q[n+60>>2]=a,Q[n+28>>2]=r,Q[n+12>>2]=G,Q[n+44>>2]=y,r=0,t=0;;){if(16==(0|t)){for(;16!=(0|r);)o=(t=r<<2)+E|0,t=Q[n+t>>2],B[0|o]=t,B[o+1|0]=t>>>8,B[o+2|0]=t>>>16,B[o+3|0]=t>>>24,r=r+1|0;break}Q[(a=(o=t<<2)+n|0)>>2]=Q[o+C>>2]+Q[a>>2],t=t+1|0}break}N=r,F=y,y=U((r=r+G|0)^a,16),p=(Y=U(N^(k=F+y|0),12))+r|0,r=U((o=o+f|0)^h,16),f=U((a=r+M|0)^f,12),h=U((d=o+f|0)^r,8),o=p+(f=U(f^(M=h+a|0),7))|0,a=U((r=t+w|0)^u,16),t=U((c=a+c|0)^t,12),l=U((w=r+t|0)^a,8),r=U(o^l,16),F=D,G=U((D=D+R|0)^s,16),a=U(F^(u=G+S|0),12),F=f,s=U((D=a+D|0)^G,8),R=U(F^(f=r+(N=s+u|0)|0),12),u=U(r^(G=o+R|0),8),f=U((S=u+f|0)^R,7),F=k,k=U(y^p,8),r=U((y=F+k|0)^Y,7),s=U(s^(w=w+r|0),16),r=U((o=s+M|0)^r,12),s=U(s^(w=w+r|0),8),r=U((M=o+s|0)^r,7),F=D,t=U((D=c+l|0)^t,7),h=U((c=F+t|0)^h,16),t=U((o=y+h|0)^t,12),h=U(h^(R=c+t|0),8),t=U((y=o+h|0)^t,7),o=U(a^N,7),c=U((a=o+d|0)^k,16),k=U(o^(D=c+D|0),12),a=U(c^(o=a+k|0),8),D=U((c=D+a|0)^k,7),H=H-2|0}break}Q[(o=r<<2)+n>>2]=Q[o+C>>2],r=r+1|0}if(o=Q[C+48>>2]+1|0,Q[C+48>>2]=o,o||(Q[C+52>>2]=Q[C+52>>2]+1),o=0,I>>>0<=64)for(;;){if(I>>>0<=o>>>0)break A;B[g+o|0]=i[o+E|0]^i[A+o|0],o=o+1|0}else{for(;64!=(0|o);)B[g+o|0]=i[o+E|0]^i[A+o|0],o=o+1|0;A=A- -64|0,g=g- -64|0,I=I+-64|0}}e=E- -64|0,e=C- -64|0}function y(A,I){var g,B=0,C=0,E=0,o=0,n=0,r=0,t=0,a=0,D=0,c=0,f=0,y=0,w=0,s=0,h=0,F=0,k=0,G=0,u=0,R=0,M=0,S=0,N=0,H=0,Y=0;for(g=e-128|0;;){if(16==(0|r)){for(;8!=(0|E);)Q[(I=E<<2)+(g- -64|0)>>2]=Q[A+I>>2],E=E+1|0;for(I=Q[A+32>>2],B=Q[A+44>>2],r=Q[A+40>>2],D=Q[A+36>>2],Q[A+60>>2]?(o=698298832,C=137296536,f=-330404727,E=-1542899678):(o=698298832^(E=Q[A+48>>2]),f=-330404727^(C=Q[A+52>>2]),C^=137296536,E^=-1542899678),M=608135816^I,h=57701188^B,t=320440878^r,n=-2052912941^D,r=0,F=Q[g+76>>2],D=Q[g+92>>2],k=Q[g+72>>2],I=Q[g+88>>2],c=Q[g+68>>2],a=Q[g+84>>2],y=Q[g+64>>2],w=Q[g+80>>2];;){if(14==(0|r)){for(Q[g+112>>2]=E,Q[g+64>>2]=y,Q[g+80>>2]=w,Q[g+96>>2]=M,Q[g+84>>2]=a,Q[g+116>>2]=o,Q[g+68>>2]=c,Q[g+100>>2]=n,Q[g+88>>2]=I,Q[g+120>>2]=C,Q[g+72>>2]=k,Q[g+104>>2]=t,Q[g+92>>2]=D,Q[g+124>>2]=f,Q[g+76>>2]=F,Q[g+108>>2]=h,E=0,r=0;;){if(16==(0|r)){for(;8!=(0|E);)Q[(I=(E<<2)+A|0)>>2]=Q[I>>2]^Q[32+(((3&E)<<2)+A|0)>>2],E=E+1|0;break}Q[(I=((7&r)<<2)+A|0)>>2]=Q[I>>2]^Q[(g- -64|0)+(r<<2)>>2],r=r+1|0}break}G=i[(B=1152+(r<<4)|0)+10|0]<<2,u=i[B+11|0]<<2,N=Q[G+1376>>2]^Q[u+g>>2],s=t,S=C,C=i[B+5|0]<<2,t=i[B+4|0]<<2,H=U(S^(k=((Q[C+1376>>2]^Q[t+g>>2])+I|0)+k|0),16),I=U(I^(R=s+H|0),20),H=U((k=(I+k|0)+(Q[t+1376>>2]^Q[g+C>>2])|0)^H,24),I=U(I^(C=R+H|0),25),s=n,t=i[B+3|0]<<2,n=i[B+2|0]<<2,R=U((c=((Q[t+1376>>2]^Q[n+g>>2])+a|0)+c|0)^o,16),a=((t=((Y=U((o=s+R|0)^a,20))+c|0)+(Q[n+1376>>2]^Q[g+t>>2])|0)+I|0)+(Q[u+1376>>2]^Q[g+G>>2])|0,s=E,E=i[B+1|0]<<2,n=i[0|B]<<2,y=U(s^(c=((Q[E+1376>>2]^Q[n+g>>2])+w|0)+y|0),16),u=a+N|0,s=I,I=a,w=U(w^(M=y+M|0),20),n=U((a=(w+c|0)+(Q[n+1376>>2]^Q[g+E>>2])|0)^y,24),I=U(I^n,16),S=h,c=f,E=i[B+7|0]<<2,f=i[B+6|0]<<2,c=S+(F=U(c^(h=((Q[E+1376>>2]^Q[f+g>>2])+D|0)+F|0),16))|0,S=F,D=U(D^c,20),f=U(S^(F=(D+h|0)+(Q[f+1376>>2]^Q[g+E>>2])|0),24),y=U(s^(h=I+(G=c+f|0)|0),20),E=U((c=u+y|0)^I,24),I=U((h=E+h|0)^y,25),y=i[B+8|0]<<2,u=i[B+9|0]<<2,N=Q[y+1376>>2]^Q[u+g>>2],s=C,S=f,C=U(t^R,24),f=U((R=C+o|0)^Y,25),o=s+(t=U(S^(a=(f+a|0)+(Q[u+1376>>2]^Q[g+y>>2])|0),16))|0,s=a+N|0,a=U(o^f,20),f=U(t^(y=s+a|0),24),a=U((t=o+f|0)^a,25),o=i[B+12|0]<<2,u=i[B+13|0]<<2,N=Q[o+1376>>2]^Q[u+g>>2],D=U(D^G,25),G=U((o=(D+k|0)+(Q[u+1376>>2]^Q[g+o>>2])|0)^C,16),D=U((C=G+(n=n+M|0)|0)^D,20),o=U(G^(k=D+(o+N|0)|0),24),D=U((M=C+o|0)^D,25),C=i[B+14|0]<<2,B=i[B+15|0]<<2,G=Q[C+1376>>2]^Q[B+g>>2],w=U(n^w,25),n=U((C=(w+F|0)+(Q[B+1376>>2]^Q[g+C>>2])|0)^H,16),w=U((B=n+R|0)^w,20),C=U(n^(F=w+(C+G|0)|0),24),w=U((n=B+C|0)^w,25),r=r+1|0}break}B=i[0|(B=(o=r<<2)+I|0)]|i[B+1|0]<<8|i[B+2|0]<<16|i[B+3|0]<<24,Q[g+o>>2]=B<<8&16711680|B<<24|B>>>8&65280|B>>>24,r=r+1|0}}function w(A,I,g){var C=0,Q=0,E=0,o=0,n=0,r=0;for(C=67;7!=(0|r);){for(Q=0,o=(0|(n=C>>1))>0?n:0,E=(r<<6)+g|0;(0|Q)!=(0|o);)u((Q<<5)+I|0,(Q<<6)+I|0,E),Q=Q+1|0;1&C?(o=i[(Q=((C<<5)+I|0)-32|0)+4|0]|i[Q+5|0]<<8|i[Q+6|0]<<16|i[Q+7|0]<<24,E=(n<<5)+I|0,C=i[0|Q]|i[Q+1|0]<<8|i[Q+2|0]<<16|i[Q+3|0]<<24,B[0|E]=C,B[E+1|0]=C>>>8,B[E+2|0]=C>>>16,B[E+3|0]=C>>>24,B[E+4|0]=o,B[E+5|0]=o>>>8,B[E+6|0]=o>>>16,B[E+7|0]=o>>>24,o=i[Q+28|0]|i[Q+29|0]<<8|i[Q+30|0]<<16|i[Q+31|0]<<24,C=i[Q+24|0]|i[Q+25|0]<<8|i[Q+26|0]<<16|i[Q+27|0]<<24,B[E+24|0]=C,B[E+25|0]=C>>>8,B[E+26|0]=C>>>16,B[E+27|0]=C>>>24,B[E+28|0]=o,B[E+29|0]=o>>>8,B[E+30|0]=o>>>16,B[E+31|0]=o>>>24,o=i[Q+20|0]|i[Q+21|0]<<8|i[Q+22|0]<<16|i[Q+23|0]<<24,C=i[Q+16|0]|i[Q+17|0]<<8|i[Q+18|0]<<16|i[Q+19|0]<<24,B[E+16|0]=C,B[E+17|0]=C>>>8,B[E+18|0]=C>>>16,B[E+19|0]=C>>>24,B[E+20|0]=o,B[E+21|0]=o>>>8,B[E+22|0]=o>>>16,B[E+23|0]=o>>>24,o=i[Q+12|0]|i[Q+13|0]<<8|i[Q+14|0]<<16|i[Q+15|0]<<24,C=i[Q+8|0]|i[Q+9|0]<<8|i[Q+10|0]<<16|i[Q+11|0]<<24,B[E+8|0]=C,B[E+9|0]=C>>>8,B[E+10|0]=C>>>16,B[E+11|0]=C>>>24,B[E+12|0]=o,B[E+13|0]=o>>>8,B[E+14|0]=o>>>16,B[E+15|0]=o>>>24,C=n+1|0):C=n,r=r+1|0}C=i[I+4|0]|i[I+5|0]<<8|i[I+6|0]<<16|i[I+7|0]<<24,g=i[0|I]|i[I+1|0]<<8|i[I+2|0]<<16|i[I+3|0]<<24,B[0|A]=g,B[A+1|0]=g>>>8,B[A+2|0]=g>>>16,B[A+3|0]=g>>>24,B[A+4|0]=C,B[A+5|0]=C>>>8,B[A+6|0]=C>>>16,B[A+7|0]=C>>>24,C=i[I+28|0]|i[I+29|0]<<8|i[I+30|0]<<16|i[I+31|0]<<24,g=i[I+24|0]|i[I+25|0]<<8|i[I+26|0]<<16|i[I+27|0]<<24,B[A+24|0]=g,B[A+25|0]=g>>>8,B[A+26|0]=g>>>16,B[A+27|0]=g>>>24,B[A+28|0]=C,B[A+29|0]=C>>>8,B[A+30|0]=C>>>16,B[A+31|0]=C>>>24,C=i[I+20|0]|i[I+21|0]<<8|i[I+22|0]<<16|i[I+23|0]<<24,g=i[I+16|0]|i[I+17|0]<<8|i[I+18|0]<<16|i[I+19|0]<<24,B[A+16|0]=g,B[A+17|0]=g>>>8,B[A+18|0]=g>>>16,B[A+19|0]=g>>>24,B[A+20|0]=C,B[A+21|0]=C>>>8,B[A+22|0]=C>>>16,B[A+23|0]=C>>>24,g=i[I+12|0]|i[I+13|0]<<8|i[I+14|0]<<16|i[I+15|0]<<24,I=i[I+8|0]|i[I+9|0]<<8|i[I+10|0]<<16|i[I+11|0]<<24,B[A+8|0]=I,B[A+9|0]=I>>>8,B[A+10|0]=I>>>16,B[A+11|0]=I>>>24,B[A+12|0]=g,B[A+13|0]=g>>>8,B[A+14|0]=g>>>16,B[A+15|0]=g>>>24}function s(A,I,g){var C,o,n=0,r=0,t=0,a=0;for(e=C=e-48|0;32!=(0|n);)B[n+C|0]=i[I+n|0],n=n+1|0;for(a=(I=Q[g>>2])>>31,o=I,I=Q[g+8>>2],n=Q[g+12>>2]<<4|I>>>28,n|=a,a=I=o|I<<4,I=Q[g+16>>2]<<27|n;8!=(0|r)|t;)g=31&(n=(g=r)<<3),B[32+(r+C|0)|0]=(63&n)>>>0>=32?I>>>g|0:((1<<g)-1&I)<<32-g|a>>>g,t=(g=r+1|0)?t:t+1|0,r=g;e=I=e-128|0,Q[I+32>>2]=0,Q[I+36>>2]=0,Q[I+24>>2]=528734635,Q[I+28>>2]=1541459225,Q[I+16>>2]=1359893119,Q[I+20>>2]=-1694144372,Q[I+8>>2]=1013904242,Q[I+12>>2]=-1521486534,Q[I>>2]=1779033703,Q[I+4>>2]=-1150833019,Q[I+40>>2]=0,Q[I+44>>2]=0,Q[I+48>>2]=0,Q[I+52>>2]=0,Q[I+56>>2]=0,Q[I+60>>2]=0,G(I,C,320,0),e=g=e-16|0,B[g+7|0]=1,B[g+6|0]=129,r=Q[I+52>>2],n=(a=Q[I+48>>2])+(t=Q[I+56>>2])|0,B[g+15|0]=n,B[g+14|0]=n>>>8,B[g+13|0]=n>>>16,B[g+12|0]=n>>>24,r=r+(n>>>0<t>>>0)|0,B[g+11|0]=r,B[g+10|0]=r>>>8,B[g+9|0]=r>>>16,B[g+8|0]=r>>>24,440!=(0|t)?((0|t)<=439?(t||(Q[I+60>>2]=1),Q[I+48>>2]=n-440,G(I,1440,440-t|0,0)):(Q[I+48>>2]=n-512,G(I,1440,t=512-t|0,t>>31),Q[I+48>>2]=Q[I+48>>2]-440,G(I,1441,440,0),Q[I+60>>2]=1),G(I,g+7|0,8,0),r=Q[I+48>>2]-8|0):(Q[I+48>>2]=a-8,G(I,g+6|0,8,0),r=Q[I+48>>2]),Q[I+48>>2]=r+-64,G(I,g+8|0,64,0),B[0|A]=i[I+3|0],B[A+1|0]=E[I+2>>1],B[A+2|0]=Q[I>>2]>>>8,B[A+3|0]=Q[I>>2],B[A+4|0]=i[I+7|0],B[A+5|0]=E[I+6>>1],B[A+6|0]=Q[I+4>>2]>>>8,B[A+7|0]=Q[I+4>>2],B[A+8|0]=i[I+11|0],B[A+9|0]=E[I+10>>1],B[A+10|0]=Q[I+8>>2]>>>8,B[A+11|0]=Q[I+8>>2],B[A+12|0]=i[I+15|0],B[A+13|0]=E[I+14>>1],B[A+14|0]=Q[I+12>>2]>>>8,B[A+15|0]=Q[I+12>>2],B[A+16|0]=i[I+19|0],B[A+17|0]=E[I+18>>1],B[A+18|0]=Q[I+16>>2]>>>8,B[A+19|0]=Q[I+16>>2],B[A+20|0]=i[I+23|0],B[A+21|0]=E[I+22>>1],B[A+22|0]=Q[I+20>>2]>>>8,B[A+23|0]=Q[I+20>>2],B[A+24|0]=i[I+27|0],B[A+25|0]=E[I+26>>1],B[A+26|0]=Q[I+24>>2]>>>8,B[A+27|0]=Q[I+24>>2],B[A+28|0]=i[I+31|0],B[A+29|0]=E[I+30>>1],B[A+30|0]=Q[I+28>>2]>>>8,B[A+31|0]=Q[I+28>>2],e=g+16|0,e=I+128|0,e=C+48|0}function h(A,I){var g,C=0,E=0,o=0,n=0,r=0,t=0,a=0,D=0,c=0,f=0,y=0,w=0,s=0,h=0,F=0,k=0,G=0,u=0,R=0,M=0,S=0,N=0,H=0;for(g=e+-64|0;;){if(16==(0|n)){for(o=Q[g+44>>2],D=Q[g+60>>2],n=Q[g+28>>2],c=Q[g+12>>2],E=Q[g+40>>2],s=Q[g+56>>2],C=Q[g+24>>2],r=Q[g+8>>2],G=Q[g+36>>2],f=Q[g+52>>2],I=Q[g+20>>2],u=Q[g+4>>2],y=Q[g+32>>2],w=Q[g+48>>2],a=Q[g+16>>2],h=Q[g>>2],R=12;;){if(!R){for(Q[g+48>>2]=w,Q[g+16>>2]=a,Q[g>>2]=h,Q[g+32>>2]=y,Q[g+52>>2]=f,Q[g+20>>2]=I,Q[g+4>>2]=u,Q[g+36>>2]=G,Q[g+56>>2]=s,Q[g+24>>2]=C,Q[g+8>>2]=r,Q[g+40>>2]=E,Q[g+60>>2]=D,Q[g+28>>2]=n,Q[g+12>>2]=c,Q[g+44>>2]=o,n=0;16!=(0|n);)I=(C=n<<2)+A|0,C=Q[g+C>>2],B[0|I]=C,B[I+1|0]=C>>>8,B[I+2|0]=C>>>16,B[I+3|0]=C>>>24,n=n+1|0;break}t=o,D=U((o=n+c|0)^D,16),k=(n=U((F=t+D|0)^n,12))+o|0,t=a,o=U((a=a+h|0)^w,16),t=y=U(t^(c=o+y|0),12),w=U((h=a+y|0)^o,8),a=k+(c=U(t^(y=c+w|0),7))|0,t=E,E=U((o=C+r|0)^s,16),C=U((M=t+E|0)^C,12),S=U((r=E)^(E=C+o|0),8),o=U(a^S,16),t=I,s=U((I=I+u|0)^f,16),N=U(t^(r=s+G|0),12),t=a,a=r,r=U((I=N+I|0)^s,8),f=U((a=o+(H=a+r|0)|0)^c,12),s=U(o^(c=t+f|0),8),a=U((G=s+a|0)^f,7),t=r,r=E,D=U(D^k,8),E=U((o=D+F|0)^n,7),f=U(t^(r=r+E|0),16),E=U((n=f+y|0)^E,12),f=U(f^(r=E+r|0),8),n=U((y=n+f|0)^E,7),t=o,C=U((E=M+S|0)^C,7),w=U((o=C+I|0)^w,16),C=U((I=t+w|0)^C,12),w=U(w^(u=C+o|0),8),C=U((o=I+w|0)^C,7),I=E,t=D,D=U(N^H,7),F=U(t^(E=D+h|0),16),k=U((I=I+F|0)^D,12),D=U(F^(h=k+E|0),8),I=U((E=I+D|0)^k,7),R=R-2|0}break}E=(C=n<<2)+g|0,C=I+C|0,Q[E>>2]=i[0|C]|i[C+1|0]<<8|i[C+2|0]<<16|i[C+3|0]<<24,n=n+1|0}}function F(A,I,g,C){var E,o,n=0,r=0,t=0,a=0,D=0;for(e=E=e-256|0,n=Q[g+20>>2],t=Q[g+16>>2],Q[E+248>>2]=t,Q[E+252>>2]=n,n=Q[g+12>>2],Q[E+240>>2]=Q[g+8>>2],Q[E+244>>2]=n,n=Q[g+4>>2],Q[E+232>>2]=Q[g>>2],Q[E+236>>2]=n,o=t+32|0,g=0;;){if((0|t)>=(0|o)){for(;32!=(0|a);)B[A+a|0]=i[(E+32|0)+a|0],a=a+1|0;break}for(e=n=e-2176|0,s(r=n+2144|0,I,E+232|0),Y(n,r,C),w((E+32|0)+(g<<5)|0,n,C),e=n+2176|0,n=0,Q[(g<<2)+E>>2]=0,g=g+1|0;!(g>>>0<2||Q[(D=((r=g-2|0)<<2)+E|0)>>2]!=(0|n));)u(r=(E+32|0)+(r<<5)|0,r,448+((n<<6)+C|0)|0),n=n+1|0,Q[D>>2]=n,g=g-1|0;t=t+1|0,Q[E+248>>2]=t}e=E+256|0}function k(A,I,g,B){var C=0,i=0,E=0,o=0,n=0;for((C=Q[A+112>>2])>>>0<8||(0==(0|(E=(i=128-(C>>=3)|0)>>31))&(127&((7&B)<<29|g>>>3))>>>0<i>>>0|E>>>0>o>>>0?n=C:(H((E=A+120|0)+C|0,I,i),C=Q[A+100>>2],C=(o=Q[A+96>>2]+1024|0)>>>0<1024?C+1|0:C,Q[A+96>>2]=o,Q[A+100>>2]=C,D(A,E),I=I+i|0,g=(C=g)-(i<<=3)|0,B=B-((i>>31)+(C>>>0<i>>>0)|0)|0));!(!B&g>>>0<1024);)C=Q[A+100>>2],C=(i=Q[A+96>>2]+1024|0)>>>0<1024?C+1|0:C,Q[A+96>>2]=i,Q[A+100>>2]=C,D(A,I),g=(C=g)-1024|0,B=B-(C>>>0<1024)|0,I=I+128|0;g|B?(H(120+(A+n|0)|0,I,g>>>3|0),I=g+(n<<3)|0):I=0,Q[A+112>>2]=I}function G(A,I,g,B){var C=0,i=0,E=0,o=0;for((C=Q[A+56>>2])>>>0<8||(0==(0|(E=(i=64-(C>>=3)|0)>>31))&(63&((7&B)<<29|g>>>3))>>>0<i>>>0|E>>>0>o>>>0?o=C:(H(C+(E=A- -64|0)|0,I,i),C=Q[A+48>>2]+512|0,Q[A+48>>2]=C,C||(Q[A+52>>2]=Q[A+52>>2]+1),y(A,E),I=I+i|0,g=(C=g)-(i<<=3)|0,B=B-((i>>31)+(C>>>0<i>>>0)|0)|0));!B&g>>>0>=512|B;)C=Q[A+48>>2]+512|0,Q[A+48>>2]=C,C||(Q[A+52>>2]=Q[A+52>>2]+1),y(A,I),g=(C=g)-512|0,B=B-(C>>>0<512)|0,I=I- -64|0;g|B?(H((A+o|0)- -64|0,I,(7&B)<<29|g>>>3),I=(o<<3)+g|0):I=0,Q[A+56>>2]=I}function u(A,I,g){var C,Q=0,E=0;for(e=C=e+-64|0;64!=(0|Q);)B[Q+C|0]=i[g+Q|0]^i[I+Q|0],Q=Q+1|0;for(I=0,e=g=e+-64|0;32!=(0|I);)Q=i[I+C|0],B[(E=I+g|0)+32|0]=i[I+1106|0],B[0|E]=Q,I=I+1|0;for(h(g,g),I=0;32!=(0|I);)B[0|(Q=I+g|0)]=i[32+(I+C|0)|0]^i[0|Q],I=I+1|0;for(h(g,g),I=0;32!=(0|I);)B[A+I|0]=i[I+g|0],I=I+1|0;e=g- -64|0,e=C- -64|0}function R(A,I,g){var B=0,C=0,Q=0,i=0;return C=31&(Q=i=63&g),Q=Q>>>0>=32?-1>>>C|0:(B=-1>>>C|0)|(1<<C)-1<<32-C,Q&=A,B&=I,C=31&i,i>>>0>=32?(B=Q<<C,i=0):(B=(1<<C)-1&Q>>>32-C|B<<C,i=Q<<C),Q=B,B=31&(C=0-g&63),C>>>0>=32?(B=-1<<B,g=0):B=(g=-1<<B)|(1<<B)-1&-1>>>32-B,A&=g,I&=B,B=31&C,C>>>0>=32?(g=0,A=I>>>B|0):(g=I>>>B|0,A=((1<<B)-1&I)<<32-B|A>>>B),a=g|Q,A|=i}function M(A,I,g,C){for(var Q=0,E=0,o=0;;){if(32==(0|Q)){for(Q=0,E=(I=(0|C)>0?C:0)>>>0<16?I:16;(0|Q)!=(0|E);){for(o=(Q<<5)+g|0,I=0,e=C=e-32|0;32!=(0|I);)B[I+C|0]=i[I+o|0]^i[A+I|0],I=I+1|0;S(A,C),e=C+32|0,Q=Q+1|0}break}B[A+Q|0]=i[I+Q|0],Q=Q+1|0}}function S(A,I){var g,C=0,Q=0,E=0;for(e=g=e+-64|0;32!=(0|C);)E=i[I+C|0],B[(Q=C+g|0)+32|0]=i[C+1106|0],B[0|Q]=E,C=C+1|0;for(h(g,g),C=0;32!=(0|C);)B[A+C|0]=i[C+g|0],C=C+1|0;e=g- -64|0}function N(A){var I,B;return(A=(I=Q[521])+(B=A+3&-4)|0)>>>0<=I>>>0&&B||A>>>0>(g.byteLength/65536|0)<<16>>>0&&!(0|t(0|A))?(Q[714]=48,-1):(Q[521]=A,I)}function H(A,I,g){var C=0;if(g)for(C=A;B[0|C]=i[0|I],C=C+1|0,I=I+1|0,g=g-1|0;);return A}function Y(A,I,g){var B=0;for(l(A,I),I=0;67!=(0|I);)M(B=(I<<5)+A|0,B,g,15),I=I+1|0}function p(A,I){for(var g=0,C=0;I|g;)B[0|A]=0,A=A+1|0,C=I,I=I-1|0,g=g-!C|0}function U(A,I){var g=0;return(-1>>>(g=31&I)&A)<<g|((g=A)&-1<<(A=0-I&31))>>>A}function d(A,I,g,B){c(A,I,g,B)}function l(A,I){f(A,2144,I)}C(I=i,1024,"cmFuZG9tYnl0ZXMAbGlic29kaXVtL3NyYy9saWJzb2RpdW0vcmFuZG9tYnl0ZXMvcmFuZG9tYnl0ZXMuYwBidWZfbGVuIDw9IFNJWkVfTUFYAGV4cGFuZCAzMi1ieXRlIHRvIDY0LWJ5dGUgc3RhdGUh"),C(I,1153,""),C(I,1505,""),C(I,2084,"IA2A");var q,J=((q=[]).set=function(A,I){this[A]=I},q.get=function(A){return this[A]},q);return{d:function(){},e:J,f:function(){var A;e=A=e-16|0,B[A+15|0]=0,r(2124,A+15|0,0),e=A+16|0},g:function(){return 1056},h:function(){return 1088},i:function(){return 41e3},j:function(A,I){A|=0,I|=0;var g,C=0,i=0,E=0;for(e=g=e-32|0;1088!=(0|i);)e=C=e-16|0,B[C+15|0]=0,E=0|r(2088,C+15|0,0),e=C+16|0,B[I+i|0]=E,i=i+1|0;return A=H(A,I+32|0,1024),Q[g+24>>2]=0,Q[g+16>>2]=0,Q[g+20>>2]=0,Q[g+8>>2]=11,F(A+1024|0,I,g+8|0,A),e=g+32|0,0},k:function(A,I,g,C,E){g|=0,E|=0;var o,n,r,t=0,a=0,D=0,c=0,f=0,y=0,s=0,h=0,F=0,k=0,G=0;o=A|=0,r=I|=0,e=n=e-44336|0,A=-1;A:if(!((C|=0)>>>0<41e3)){for(;1056!=(0|a)|t;)B[a+(n- -64|0)|0]=i[E+a|0],t=(A=a+1|0)?t:t+1|0,a=A;for(a=0,t=0;32!=(0|a)|t;)B[a+(n+42192|0)|0]=i[g+a|0],A=t,a=I=a+1|0,t=A=I?A:A+1|0;for(H(n+1120|0,g,41e3),H(o+1088|0,g+41e3|0,C-41e3|0),A=Q[(I=n+42216|0)+4>>2],I=Q[I>>2],B[o+24|0]=I,B[o+25|0]=I>>>8,B[o+26|0]=I>>>16,B[o+27|0]=I>>>24,B[o+28|0]=A,B[o+29|0]=A>>>8,B[o+30|0]=A>>>16,B[o+31|0]=A>>>24,A=Q[(I=n+42208|0)+4>>2],I=Q[I>>2],B[o+16|0]=I,B[o+17|0]=I>>>8,B[o+18|0]=I>>>16,B[o+19|0]=I>>>24,B[o+20|0]=A,B[o+21|0]=A>>>8,B[o+22|0]=A>>>16,B[o+23|0]=A>>>24,A=Q[n+42204>>2],I=Q[n+42200>>2],B[o+8|0]=I,B[o+9|0]=I>>>8,B[o+10|0]=I>>>16,B[o+11|0]=I>>>24,B[o+12|0]=A,B[o+13|0]=A>>>8,B[o+14|0]=A>>>16,B[o+15|0]=A>>>24,A=Q[n+42196>>2],I=Q[n+42192>>2],B[0|o]=I,B[o+1|0]=I>>>8,B[o+2|0]=I>>>16,B[o+3|0]=I>>>24,B[o+4|0]=A,B[o+5|0]=A>>>8,B[o+6|0]=A>>>16,B[o+7|0]=A>>>24,H(o+32|0,n- -64|0,1056),d(n,o,I=C-39912|0,A=I>>31),E=n+1152|0,a=0,t=0;8!=(0|a)|t;)I=i[E+a|0],A=31&(g=(A=a)<<3),(63&g)>>>0>=32?(g=I<<A,A=0):(g=(1<<A)-1&I>>>32-A,A=I<<A),y^=A,f^=g,t=(A=a+1|0)?t:t+1|0,a=A;for(a=n+42128|0,e=A=e-1024|0,F=(t=n- -64|0)+576|0,E=(h=n+1160|0)+2048|0,k=A+32|0;;){I:{g:{B:{if(32!=(0|c)){D=i[(I=(c<<1)+n|0)+1|0]<<8;C:{if(!(1&(I=i[0|I])))for(S(A,E),g=0;;){if(32==(0|g))break C;B[(s=g+32|0)+A|0]=i[E+s|0],g=g+1|0}for(S(k,E),g=0;;){if(32==(0|g))break C;B[A+g|0]=i[32+(g+E|0)|0],g=g+1|0}}for(I|=D,E=E- -64|0,D=1;10!=(0|D);){g=(t+(D<<6)|0)-64|0;C:{if(!(2&I))for(u(A,A,g),g=0;;){if(32==(0|g))break C;B[32+(A+g|0)|0]=i[g+E|0],g=g+1|0}for(u(k,A,g),g=0;;){if(32==(0|g))break C;B[A+g|0]=i[g+E|0],g=g+1|0}}I=I>>>1|0,D=D+1|0,E=E+32|0}for(u(A,A,F),I=I<<4&1048544,g=0;;){if(32==(0|g))break g;if(D=I+g|0,s=A+g|0,g=g+1|0,i[D+h|0]!=i[0|s])break}for(g=0;;){if(32==(0|g))break B;B[g+a|0]=0,g=g+1|0}}else I=t+640|0,g=0;for(;32!=(0|g);)u((g<<5)+A|0,h+(g<<6)|0,I),g=g+1|0;for(I=t+704|0,g=0;;){if(16==(0|g)){for(I=t+768|0,g=0;;){if(8==(0|g)){for(I=t+832|0,g=0;;){if(4==(0|g)){for(I=t+896|0,g=0;2!=(0|g);)u((g<<5)+A|0,(g<<6)+A|0,I),g=g+1|0;u(a,A,t+960|0);break}u((g<<5)+A|0,(g<<6)+A|0,I),g=g+1|0}break}u((g<<5)+A|0,(g<<6)+A|0,I),g=g+1|0}break}u((g<<5)+A|0,(g<<6)+A|0,I),g=g+1|0}}e=A+1024|0;break I}c=c+1|0;continue}break}for(g=n+14472|0,a=0,t=0;;){if(!t&12==(0|a)){a=C-41e3|0,t=0-(C>>>0<41e3)|0,y=0,f=0;I:{g:{for(;;){if(!f&32==(0|y))break g;if(A=f,y=g=(I=y)+1|0,f=A=g?A:A+1|0,i[I+(n+42128|0)|0]!=i[1088+(I+n|0)|0])break}for(Q[r>>2]=a,Q[r+4>>2]=t,y=0,f=0;;){if((0|t)==(0|f)&a>>>0<=y>>>0|t>>>0<f>>>0)break I;B[o+y|0]=0,t=f,y=A=y+1|0,f=t=A?t:t+1|0,a=Q[r>>2],t=Q[r+4>>2]}}for(Q[r>>2]=a,Q[r+4>>2]=t,y=0,f=0;;){if((0|t)==(0|f)&a>>>0<=y>>>0|t>>>0<f>>>0){A=0;break A}B[0|(A=o+y|0)]=i[A+1088|0],f=(A=y+1|0)?f:f+1|0,y=A,a=Q[r>>2],t=Q[r+4>>2]}}Q[r>>2]=-1,Q[r+4>>2]=-1;break}for(E=n+42192|0,k=n+42128|0,h=n- -64|0,A=0,c=0,e=I=e-272|0;;){if(A>>>0>63){for(A=64;;){if(67==(0|A)){for(A=0;67!=(0|A);)M(c=(D=A<<5)+E|0,s=g+D|0,h+((D=Q[I+(A<<2)>>2])<<5)|0,15-D|0),A=A+1|0;e=I+272|0;break}Q[I+(A<<2)>>2]=15&c,A=A+1|0,c>>=4}break}D=A<<2,s=15&(F=i[k+(A>>>1|0)|0]),Q[D+I>>2]=s,G=I+(4|D)|0,D=F>>>4|0,Q[G>>2]=D,c=((15^s)+c|0)+(15^D)|0,A=A+2|0}w(c=n+42160|0,E,h),D=g+2144|0,A=0,e=I=e+-64|0;I:{if(!(1&(E=31&y)))for(;;)if(32==(0|A))for(A=0;;){if(32==(0|A))break I;B[32+(A+I|0)|0]=i[A+D|0],A=A+1|0}else B[A+I|0]=i[A+c|0],A=A+1|0;for(;;)if(32==(0|A))for(A=0;;){if(32==(0|A))break I;B[A+I|0]=i[A+D|0],A=A+1|0}else B[32+(A+I|0)|0]=i[A+c|0],A=A+1|0}for(F=I+32|0,c=0;4!=(0|c);){D=D+32|0,A=448+(h+(c<<6)|0)|0;I:{if(2&E)for(u(F,I,A),A=0;;){if(32==(0|A))break I;B[A+I|0]=i[A+D|0],A=A+1|0}for(u(I,I,A),A=0;;){if(32==(0|A))break I;B[32+(A+I|0)|0]=i[A+D|0],A=A+1|0}}E=E>>>1|0,c=c+1|0}u(k,I,h+704|0),e=I- -64|0,A=t,a=I=a+1|0,t=A=I?A:A+1|0,y=(31&f)<<27|y>>>5,f=f>>>5|0,g=g+2304|0}A=-1}return e=n+44336|0,0|A},l:function(A,I,g,C,E){A|=0,I|=0,g|=0,E|=0;var o,r,t=0,a=0,D=0,y=0,h=0,k=0,G=0,R=0,N=0,U=0;for(r=C|=0,e=o=e-2384|0;1088!=(0|k)|t;)B[o+k|0]=i[E+k|0],C=t,k=t=k+1|0,t=C=t?C:C+1|0;for(y=A+40968|0,k=r,t=0;t|k;)B[31+(y+k|0)|0]=i[(g+k|0)-1|0],k=(C=k)-1|0,t=t-!C|0;for(C=Q[o+1060>>2],g=Q[o+1056>>2],B[0|y]=g,B[y+1|0]=g>>>8,B[y+2|0]=g>>>16,B[y+3|0]=g>>>24,B[y+4|0]=C,B[y+5|0]=C>>>8,B[y+6|0]=C>>>16,B[y+7|0]=C>>>24,C=Q[(g=o+1080|0)+4>>2],g=Q[g>>2],B[y+24|0]=g,B[y+25|0]=g>>>8,B[y+26|0]=g>>>16,B[y+27|0]=g>>>24,B[y+28|0]=C,B[y+29|0]=C>>>8,B[y+30|0]=C>>>16,B[y+31|0]=C>>>24,C=Q[(g=o+1072|0)+4>>2],g=Q[g>>2],B[y+16|0]=g,B[y+17|0]=g>>>8,B[y+18|0]=g>>>16,B[y+19|0]=g>>>24,B[y+20|0]=C,B[y+21|0]=C>>>8,B[y+22|0]=C>>>16,B[y+23|0]=C>>>24,C=Q[(g=o+1064|0)+4>>2],g=Q[g>>2],B[y+8|0]=g,B[y+9|0]=g>>>8,B[y+10|0]=g>>>16,B[y+11|0]=g>>>24,B[y+12|0]=C,B[y+13|0]=C>>>8,B[y+14|0]=C>>>16,B[y+15|0]=C>>>24,t=0,c(o+2192|0,y,g=r+32|0,t=g>>>0<32?1:t),p(y,32),a=Q[(g=o+2224|0)+4>>2],C=o+2336|0,t=Q[g>>2],Q[C>>2]=t,Q[C+4>>2]=a,D=Q[(g=o+2232|0)+4>>2],C=o+2344|0,E=Q[g>>2],Q[C>>2]=E,Q[C+4>>2]=D,h=Q[o+2212>>2],C=Q[o+2208>>2],Q[o+2320>>2]=C,Q[o+2324>>2]=h,k=Q[(g=o+2216|0)+4>>2],g=Q[g>>2],Q[o+2328>>2]=g,Q[o+2332>>2]=k,G=Q[o+2192>>2],U=Q[o+2196>>2],B[0|(R=A+39936|0)]=E,B[R+1|0]=E>>>8,B[R+2|0]=E>>>16,B[R+3|0]=E>>>24,B[R+4|0]=D,B[R+5|0]=D>>>8,B[R+6|0]=D>>>16,B[R+7|0]=D>>>24,B[0|(E=A+39928|0)]=t,B[E+1|0]=t>>>8,B[E+2|0]=t>>>16,B[E+3|0]=t>>>24,B[E+4|0]=a,B[E+5|0]=a>>>8,B[E+6|0]=a>>>16,B[E+7|0]=a>>>24,B[0|(E=A+39920|0)]=g,B[E+1|0]=g>>>8,B[E+2|0]=g>>>16,B[E+3|0]=g>>>24,B[E+4|0]=k,B[E+5|0]=k>>>8,B[E+6|0]=k>>>16,B[E+7|0]=k>>>24,B[A+39912|0]=C,B[A+39913|0]=C>>>8,B[A+39914|0]=C>>>16,B[A+39915|0]=C>>>24,B[A+39916|0]=h,B[A+39917|0]=h>>>8,B[A+39918|0]=h>>>16,B[A+39919|0]=h>>>24,Q[o+1104>>2]=0,k=0,t=0,Q[o+1096>>2]=0,Q[o+1100>>2]=0,Q[o+1088>>2]=11,F(y,o,o+1088|0,H(A+39944|0,h=o+32|0,1024)),E=0,d(o+2256|0,A+39912|0,g=r+1088|0,E=g>>>0<1088?1:E),Q[o+2376>>2]=31&G,Q[o+2360>>2]=12,C=(E=268435455&U)>>>5|0,g=G,Q[o+2368>>2]=(31&E)<<27|g>>>5,Q[o+2372>>2]=C,Q[I>>2]=0,Q[I+4>>2]=0;32!=(0|k)|t;)B[A+k|0]=i[k+(o+2320|0)|0],t=(C=k+1|0)?t:t+1|0,k=C;for(t=Q[I+4>>2],t=(C=Q[I>>2]+32|0)>>>0<32?t+1|0:t,Q[I>>2]=C,Q[I+4>>2]=t,H(o+1088|0,h,1024),h=A+32|0,k=0,t=0;8!=(0|k)|t;)C=k,D=31&(C<<=3),B[k+h|0]=(63&C)>>>0>=32?E>>>D|0:((1<<D)-1&E)<<32-D|g>>>D,C=t,k=t=k+1|0,t=C=t?C:C+1|0;for(t=Q[I+4>>2],t=(g=Q[I>>2]+8|0)>>>0<8?t+1|0:t,Q[I>>2]=g,Q[I+4>>2]=t,s(C=o+2112|0,o,o+2360|0),U=A+40|0,D=o+2144|0,a=o+2184|0,h=o+1088|0,G=o+2256|0,g=0,e=R=e-6291424|0,f(R+4194272|0,2097152,C),A=0;;){if(65536==(0|A)){for(;;){if(16==(0|g)){for(A=0,g=2016;;){if(E=2048,2048==(0|A)){for(g=0;;){if(32==(0|g)){A:for(A=0;;){if(32==(0|A))break A;B[A+D|0]=i[A+R|0],A=A+1|0}break}for(C=(t=i[0|(A=G+(g<<1)|0)]|i[A+1|0]<<8)<<5,A=0;32!=(0|A);)B[E+U|0]=i[R+4194272+(A+C)|0],A=A+1|0,E=E+1|0;for(A=t+65535|0,k=0;10!=(0|k);){for(C=(t=(1&A?1:-1)+A|0)<<5,A=0;32!=(0|A);)B[E+U|0]=i[R+(A+C|0)|0],A=A+1|0,E=E+1|0;k=k+1|0,A=t-1>>>1|0}g=g+1|0}Q[a>>2]=13312,Q[a+4>>2]=0,e=R+6291424|0;break}B[A+U|0]=i[g+R|0],g=g+1|0,A=A+1|0}break}for(k=h+(g<<6)|0,E=(t=1<<15-g)+134217727|0,C=-1<<16-g^-1,A=0;(0|A)!=(0|t);)u(R+(A+E<<5)|0,R+(C+(A<<1)<<5)|0,k),A=A+1|0;g=g+1|0}break}S(2097120+((C=A<<5)+R|0)|0,C+(R+4194272|0)|0),A=A+1|0}for(E=Q[o+2188>>2]+Q[I+4>>2]|0,C=(g=Q[o+2184>>2])+(A=Q[I>>2])|0,Q[I>>2]=C,Q[I+4>>2]=A>>>0>C>>>0?E+1|0:E,A=g+U|0,k=0,t=0;12!=(0|k)|t;){for(Q[o+2360>>2]=k,s(U=o+2112|0,o,h=o+2360|0),G=o+2144|0,y=o+1088|0,g=0,E=0,e=R=e-272|0;;){if(g>>>0>63){for(g=64;67!=(0|g);)Q[R+(g<<2)>>2]=15&E,g=g+1|0,E>>=4;for(l(A,U),g=0;67!=(0|g);)M(C=(g<<5)+A|0,C,y,Q[R+(g<<2)>>2]),g=g+1|0;e=R+272|0;break}a=g<<2,D=15&(C=i[G+(g>>>1|0)|0]),Q[a+R>>2]=D,C=C>>>4|0,Q[R+(4|a)>>2]=C,E=((15^D)+E|0)+(15^C)|0,g=g+2|0}for(C=Q[I+4>>2],C=(g=Q[I>>2]+2144|0)>>>0<2144?C+1|0:C,Q[I>>2]=g,Q[I+4>>2]=C,U=A+2144|0,g=0,E=0,e=N=e-71712|0,C=Q[h+20>>2],Q[(D=N+71704|0)>>2]=Q[h+16>>2],Q[D+4>>2]=C,C=Q[h+12>>2],Q[(D=N+71696|0)>>2]=Q[h+8>>2],Q[D+4>>2]=C,C=Q[h+4>>2],Q[N+71688>>2]=Q[h>>2],Q[N+71692>>2]=C;;){if(Q[N+71704>>2]=g,32==(0|g)){for(;;){if(32==(0|E)){for(C=N+70656|0,R=0,g=0;;){if(E=32,32==(0|g)){for(;6!=(0|R);){for(a=448+(y+(R<<6)|0)|0,D=(g=N+69632|0)+(E<<5)|0,C=g+(E<<4&992)|0,g=0;g>>>0<E>>>0;)u(C+(g<<4)|0,D+(g<<5)|0,a),g=g+2|0;E=E>>>1|0,R=R+1|0}for(E=Q[h+16>>2],g=0;5!=(0|g);)D=i[(a=((N+69632|0)+(32>>>g<<5)|0)+(E>>g<<5^32)|0)+12|0]|i[a+13|0]<<8|i[a+14|0]<<16|i[a+15|0]<<24,C=U+(g<<5)|0,h=i[a+8|0]|i[a+9|0]<<8|i[a+10|0]<<16|i[a+11|0]<<24,B[C+8|0]=h,B[C+9|0]=h>>>8,B[C+10|0]=h>>>16,B[C+11|0]=h>>>24,B[C+12|0]=D,B[C+13|0]=D>>>8,B[C+14|0]=D>>>16,B[C+15|0]=D>>>24,D=i[a+4|0]|i[a+5|0]<<8|i[a+6|0]<<16|i[a+7|0]<<24,h=i[0|a]|i[a+1|0]<<8|i[a+2|0]<<16|i[a+3|0]<<24,B[0|C]=h,B[C+1|0]=h>>>8,B[C+2|0]=h>>>16,B[C+3|0]=h>>>24,B[C+4|0]=D,B[C+5|0]=D>>>8,B[C+6|0]=D>>>16,B[C+7|0]=D>>>24,D=i[a+28|0]|i[a+29|0]<<8|i[a+30|0]<<16|i[a+31|0]<<24,h=i[a+24|0]|i[a+25|0]<<8|i[a+26|0]<<16|i[a+27|0]<<24,B[C+24|0]=h,B[C+25|0]=h>>>8,B[C+26|0]=h>>>16,B[C+27|0]=h>>>24,B[C+28|0]=D,B[C+29|0]=D>>>8,B[C+30|0]=D>>>16,B[C+31|0]=D>>>24,D=i[a+20|0]|i[a+21|0]<<8|i[a+22|0]<<16|i[a+23|0]<<24,h=i[a+16|0]|i[a+17|0]<<8|i[a+18|0]<<16|i[a+19|0]<<24,B[C+16|0]=h,B[C+17|0]=h>>>8,B[C+18|0]=h>>>16,B[C+19|0]=h>>>24,B[C+20|0]=D,B[C+21|0]=D>>>8,B[C+22|0]=D>>>16,B[C+23|0]=D>>>24,g=g+1|0;C=Q[N+69668>>2],g=Q[N+69664>>2],B[0|G]=g,B[G+1|0]=g>>>8,B[G+2|0]=g>>>16,B[G+3|0]=g>>>24,B[G+4|0]=C,B[G+5|0]=C>>>8,B[G+6|0]=C>>>16,B[G+7|0]=C>>>24,C=Q[(g=N+69688|0)+4>>2],g=Q[g>>2],B[G+24|0]=g,B[G+25|0]=g>>>8,B[G+26|0]=g>>>16,B[G+27|0]=g>>>24,B[G+28|0]=C,B[G+29|0]=C>>>8,B[G+30|0]=C>>>16,B[G+31|0]=C>>>24,C=Q[(g=N+69680|0)+4>>2],g=Q[g>>2],B[G+16|0]=g,B[G+17|0]=g>>>8,B[G+18|0]=g>>>16,B[G+19|0]=g>>>24,B[G+20|0]=C,B[G+21|0]=C>>>8,B[G+22|0]=C>>>16,B[G+23|0]=C>>>24,C=Q[(g=N+69672|0)+4>>2],g=Q[g>>2],B[G+8|0]=g,B[G+9|0]=g>>>8,B[G+10|0]=g>>>16,B[G+11|0]=g>>>24,B[G+12|0]=C,B[G+13|0]=C>>>8,B[G+14|0]=C>>>16,B[G+15|0]=C>>>24,e=N+71712|0;break}w(C+(g<<5)|0,N+n(g,2144)|0,y),g=g+1|0}break}Y(N+n(E,2144)|0,(N+68608|0)+(E<<5)|0,y),E=E+1|0}break}s((N+68608|0)+(g<<5)|0,o,N+71688|0),g=g+1|0}E=Q[I+4>>2],E=(g=Q[I>>2]+160|0)>>>0<160?E+1|0:E,Q[I>>2]=g,Q[I+4>>2]=E,E=(C=Q[o+2372>>2])>>>5|0,g=Q[o+2368>>2],Q[o+2368>>2]=(31&C)<<27|g>>>5,Q[o+2372>>2]=E,Q[o+2376>>2]=31&g,t=(g=k+1|0)?t:t+1|0,k=g,A=A+2304|0}return p(o,1088),g=Q[I+4>>2],g=(A=r+Q[I>>2]|0)>>>0<r>>>0?g+1|0:g,Q[I>>2]=A,Q[I+4>>2]=g,e=o+2384|0,0},m:function(A){var I,g=0,B=0,C=0,E=0,n=0,r=0,t=0,a=0,D=0,c=0;e=I=e-16|0;A:{I:{g:{B:{C:{Q:{i:{E:{o:{n:{r:{if((A|=0)>>>0<=244){if(3&(g=(E=Q[715])>>>(B=(t=A>>>0<11?16:A+11&-8)>>>3|0)|0)){g=(A=(B=B+(1&(-1^g))|0)<<3)+2900|0,C=Q[A+2908>>2],(0|g)!=(0|(A=Q[C+8>>2]))?(Q[A+12>>2]=g,Q[g+8>>2]=A):Q[715]=U(-2,B)&E,A=C+8|0,g=B<<3,Q[C+4>>2]=3|g,Q[(g=g+C|0)+4>>2]=1|Q[g+4>>2];break A}if((c=Q[717])>>>0>=t>>>0)break r;if(g){B=A=(g=(0-(A=(0-(A=2<<B)|A)&g<<B)&A)-1|0)>>>12&16,B|=A=(g=g>>>A|0)>>>5&8,B|=A=(g=g>>>A|0)>>>2&4,g=(A=(C=((B|=A=(g=g>>>A|0)>>>1&2)|(A=(g=g>>>A|0)>>>1&1))+(g>>>A|0)|0)<<3)+2900|0,r=Q[A+2908>>2],(0|g)!=(0|(A=Q[r+8>>2]))?(Q[A+12>>2]=g,Q[g+8>>2]=A):(E=U(-2,C)&E,Q[715]=E),Q[r+4>>2]=3|t,C=(A=C<<3)-t|0,Q[(B=r+t|0)+4>>2]=1|C,Q[A+r>>2]=C,c&&(g=2900+(-8&c)|0,n=Q[720],(A=1<<(c>>>3))&E?A=Q[g+8>>2]:(Q[715]=A|E,A=g),Q[g+8>>2]=n,Q[A+12>>2]=n,Q[n+12>>2]=g,Q[n+8>>2]=A),A=r+8|0,Q[720]=B,Q[717]=C;break A}if(!(D=Q[716]))break r;for(B=A=(g=(0-D&D)-1|0)>>>12&16,B|=A=(g=g>>>A|0)>>>5&8,B|=A=(g=g>>>A|0)>>>2&4,B=Q[3164+(((B|=A=(g=g>>>A|0)>>>1&2)|(A=(g=g>>>A|0)>>>1&1))+(g>>>A|0)<<2)>>2],n=(-8&Q[B+4>>2])-t|0,g=B;(A=Q[g+16>>2])||(A=Q[g+20>>2]);)n=(C=(g=(-8&Q[A+4>>2])-t|0)>>>0<n>>>0)?g:n,B=C?A:B,g=A;if(a=Q[B+24>>2],(0|(C=Q[B+12>>2]))!=(0|B)){A=Q[B+8>>2],Q[A+12>>2]=C,Q[C+8>>2]=A;break I}if(!(A=Q[(g=B+20|0)>>2])){if(!(A=Q[B+16>>2]))break n;g=B+16|0}for(;r=g,C=A,(A=Q[(g=A+20|0)>>2])||(g=C+16|0,A=Q[C+16>>2]););Q[r>>2]=0;break I}if(t=-1,!(A>>>0>4294967231)&&(t=-8&(A=A+11|0),D=Q[716])){n=0-t|0,E=0,t>>>0<256||(E=31,t>>>0>16777215||(A=A>>>8|0,A<<=r=A+1048320>>>16&8,E=28+((A=((A<<=B=A+520192>>>16&4)<<(g=A+245760>>>16&2)>>>15|0)-(g|B|r)|0)<<1|t>>>A+21&1)|0));t:{e:{if(g=Q[3164+(E<<2)>>2])for(A=0,B=t<<(31==(0|E)?0:25-(E>>>1|0)|0);;){if(!((r=(-8&Q[g+4>>2])-t|0)>>>0>=n>>>0||(C=g,n=r))){n=0,A=g;break e}if(r=Q[g+20>>2],g=Q[16+((B>>>29&4)+g|0)>>2],A=r?(0|r)==(0|g)?A:r:A,B<<=1,!g)break}else A=0;if(!(A|C)){if(C=0,!(A=(0-(A=2<<E)|A)&D))break r;B=A=(g=(A&0-A)-1|0)>>>12&16,B|=A=(g=g>>>A|0)>>>5&8,B|=A=(g=g>>>A|0)>>>2&4,A=Q[3164+(((B|=A=(g=g>>>A|0)>>>1&2)|(A=(g=g>>>A|0)>>>1&1))+(g>>>A|0)<<2)>>2]}if(!A)break t}for(;n=(B=(g=(-8&Q[A+4>>2])-t|0)>>>0<n>>>0)?g:n,C=B?A:C,A=(g=Q[A+16>>2])||Q[A+20>>2];);}if(!(!C|Q[717]-t>>>0<=n>>>0)){if(E=Q[C+24>>2],(0|C)!=(0|(B=Q[C+12>>2]))){A=Q[C+8>>2],Q[A+12>>2]=B,Q[B+8>>2]=A;break g}if(!(A=Q[(g=C+20|0)>>2])){if(!(A=Q[C+16>>2]))break o;g=C+16|0}for(;r=g,B=A,(A=Q[(g=A+20|0)>>2])||(g=B+16|0,A=Q[B+16>>2]););Q[r>>2]=0;break g}}}if((B=Q[717])>>>0>=t>>>0){C=Q[720],(g=B-t|0)>>>0>=16?(Q[717]=g,A=C+t|0,Q[720]=A,Q[A+4>>2]=1|g,Q[B+C>>2]=g,Q[C+4>>2]=3|t):(Q[720]=0,Q[717]=0,Q[C+4>>2]=3|B,Q[(A=B+C|0)+4>>2]=1|Q[A+4>>2]),A=C+8|0;break A}if((a=Q[718])>>>0>t>>>0){g=a-t|0,Q[718]=g,A=(B=Q[721])+t|0,Q[721]=A,Q[A+4>>2]=1|g,Q[B+4>>2]=3|t,A=B+8|0;break A}if(A=0,D=t+47|0,Q[833]?B=Q[835]:(Q[836]=-1,Q[837]=-1,Q[834]=4096,Q[835]=4096,Q[833]=I+12&-16^1431655768,Q[838]=0,Q[826]=0,B=4096),(g=(r=D+B|0)&(n=0-B|0))>>>0<=t>>>0)break A;if((C=Q[825])&&C>>>0<(E=(B=Q[823])+g|0)>>>0|B>>>0>=E>>>0)break A;if(4&i[3304])break Q;r:{t:{if(C=Q[721])for(A=3308;;){if((B=Q[A>>2])>>>0<=C>>>0&C>>>0<B+Q[A+4>>2]>>>0)break t;if(!(A=Q[A+8>>2]))break}if(-1==(0|(B=N(0))))break i;if(E=g,(A=(C=Q[834])-1|0)&B&&(E=(g-B|0)+(A+B&0-C)|0),E>>>0<=t>>>0|E>>>0>2147483646)break i;if((C=Q[825])&&C>>>0<(n=(A=Q[823])+E|0)>>>0|A>>>0>=n>>>0)break i;if((0|B)!=(0|(A=N(E))))break r;break C}if((E=n&r-a)>>>0>2147483646)break i;if((0|(B=N(E)))==(Q[A>>2]+Q[A+4>>2]|0))break E;A=B}if(!(-1==(0|A)|t+48>>>0<=E>>>0)){if((B=(B=Q[835])+(D-E|0)&0-B)>>>0>2147483646){B=A;break C}if(-1!=(0|N(B))){E=B+E|0,B=A;break C}N(0-E|0);break i}if(B=A,-1!=(0|A))break C;break i}C=0;break I}B=0;break g}if(-1!=(0|B))break C}Q[826]=4|Q[826]}if(g>>>0>2147483646)break B;if(-1==(0|(B=N(g)))|-1==(0|(A=N(0)))|A>>>0<=B>>>0)break B;if((E=A-B|0)>>>0<=t+40>>>0)break B}A=Q[823]+E|0,Q[823]=A,A>>>0>o[824]&&(Q[824]=A);C:{Q:{i:{if(r=Q[721]){for(A=3308;;){if(((C=Q[A>>2])+(g=Q[A+4>>2])|0)==(0|B))break i;if(!(A=Q[A+8>>2]))break}break Q}for((A=Q[719])>>>0<=B>>>0&&A||(Q[719]=B),A=0,Q[828]=E,Q[827]=B,Q[723]=-1,Q[724]=Q[833],Q[830]=0;g=(C=A<<3)+2900|0,Q[C+2908>>2]=g,Q[C+2912>>2]=g,32!=(0|(A=A+1|0)););g=(C=E-40|0)-(A=B+8&7?-8-B&7:0)|0,Q[718]=g,A=A+B|0,Q[721]=A,Q[A+4>>2]=1|g,Q[4+(B+C|0)>>2]=40,Q[722]=Q[837];break C}if(!(8&i[A+12|0]|C>>>0>r>>>0|B>>>0<=r>>>0)){Q[A+4>>2]=g+E,B=(A=r+8&7?-8-r&7:0)+r|0,Q[721]=B,A=(g=Q[718]+E|0)-A|0,Q[718]=A,Q[B+4>>2]=1|A,Q[4+(g+r|0)>>2]=40,Q[722]=Q[837];break C}}o[719]>B>>>0&&(Q[719]=B),g=B+E|0,A=3308;Q:{i:{E:{o:{n:{r:{for(;;){if((0|g)!=Q[A>>2]){if(A=Q[A+8>>2])continue;break r}break}if(!(8&i[A+12|0]))break n}for(A=3308;;){if((g=Q[A>>2])>>>0<=r>>>0&&(n=g+Q[A+4>>2]|0)>>>0>r>>>0)break o;A=Q[A+8>>2]}}if(Q[A>>2]=B,Q[A+4>>2]=Q[A+4>>2]+E,Q[(D=(B+8&7?-8-B&7:0)+B|0)+4>>2]=3|t,A=(E=g+(g+8&7?-8-g&7:0)|0)-(a=t+D|0)|0,(0|E)==(0|r)){Q[721]=a,A=Q[718]+A|0,Q[718]=A,Q[a+4>>2]=1|A;break i}if(Q[720]==(0|E)){Q[720]=a,A=Q[717]+A|0,Q[717]=A,Q[a+4>>2]=1|A,Q[A+a>>2]=A;break i}if(1==(3&(n=Q[E+4>>2]))){r=-8&n;n:if(n>>>0<=255){if(C=Q[E+8>>2],g=n>>>3|0,(0|(B=Q[E+12>>2]))==(0|C)){Q[715]=Q[715]&U(-2,g);break n}Q[C+12>>2]=B,Q[B+8>>2]=C}else{if(t=Q[E+24>>2],(0|E)==(0|(B=Q[E+12>>2])))if((g=Q[(n=E+20|0)>>2])||(g=Q[(n=E+16|0)>>2])){for(;C=n,B=g,(g=Q[(n=g+20|0)>>2])||(n=B+16|0,g=Q[B+16>>2]););Q[C>>2]=0}else B=0;else g=Q[E+8>>2],Q[g+12>>2]=B,Q[B+8>>2]=g;if(t){C=Q[E+28>>2];r:{if(Q[(g=3164+(C<<2)|0)>>2]==(0|E)){if(Q[g>>2]=B,B)break r;Q[716]=Q[716]&U(-2,C);break n}if(Q[t+(Q[t+16>>2]==(0|E)?16:20)>>2]=B,!B)break n}Q[B+24>>2]=t,(g=Q[E+16>>2])&&(Q[B+16>>2]=g,Q[g+24>>2]=B),(g=Q[E+20>>2])&&(Q[B+20>>2]=g,Q[g+24>>2]=B)}}n=Q[(E=E+r|0)+4>>2],A=A+r|0}if(Q[E+4>>2]=-2&n,Q[a+4>>2]=1|A,Q[A+a>>2]=A,A>>>0<=255){g=2900+(-8&A)|0,(B=Q[715])&(A=1<<(A>>>3))?A=Q[g+8>>2]:(Q[715]=A|B,A=g),Q[g+8>>2]=a,Q[A+12>>2]=a,Q[a+12>>2]=g,Q[a+8>>2]=A;break i}if(n=31,A>>>0<=16777215&&(g=A>>>8|0,g<<=n=g+1048320>>>16&8,n=28+((g=((g<<=C=g+520192>>>16&4)<<(B=g+245760>>>16&2)>>>15|0)-(B|C|n)|0)<<1|A>>>g+21&1)|0),Q[a+28>>2]=n,Q[a+16>>2]=0,Q[a+20>>2]=0,g=3164+(n<<2)|0,(C=Q[716])&(B=1<<n)){for(n=A<<(31==(0|n)?0:25-(n>>>1|0)|0),B=Q[g>>2];;){if((-8&Q[(g=B)+4>>2])==(0|A))break E;if(B=n>>>29|0,n<<=1,!(B=Q[(C=(4&B)+g|0)+16>>2]))break}Q[C+16>>2]=a}else Q[716]=B|C,Q[g>>2]=a;Q[a+24>>2]=g,Q[a+12>>2]=a,Q[a+8>>2]=a;break i}for(g=(C=E-40|0)-(A=B+8&7?-8-B&7:0)|0,Q[718]=g,A=A+B|0,Q[721]=A,Q[A+4>>2]=1|g,Q[4+(B+C|0)>>2]=40,Q[722]=Q[837],Q[(C=(A=(n+(n-39&7?39-n&7:0)|0)-47|0)>>>0<r+16>>>0?r:A)+4>>2]=27,A=Q[830],Q[C+16>>2]=Q[829],Q[C+20>>2]=A,A=Q[828],Q[C+8>>2]=Q[827],Q[C+12>>2]=A,Q[829]=C+8,Q[828]=E,Q[827]=B,Q[830]=0,A=C+24|0;Q[A+4>>2]=7,g=A+8|0,A=A+4|0,g>>>0<n>>>0;);if((0|C)==(0|r))break C;if(Q[C+4>>2]=-2&Q[C+4>>2],n=C-r|0,Q[r+4>>2]=1|n,Q[C>>2]=n,n>>>0<=255){g=2900+(-8&n)|0,(B=Q[715])&(A=1<<(n>>>3))?A=Q[g+8>>2]:(Q[715]=A|B,A=g),Q[g+8>>2]=r,Q[A+12>>2]=r,Q[r+12>>2]=g,Q[r+8>>2]=A;break C}if(A=31,n>>>0<=16777215&&(A=n>>>8|0,A<<=C=A+1048320>>>16&8,A=28+((A=((A<<=B=A+520192>>>16&4)<<(g=A+245760>>>16&2)>>>15|0)-(g|B|C)|0)<<1|n>>>A+21&1)|0),Q[r+28>>2]=A,Q[r+16>>2]=0,Q[r+20>>2]=0,g=3164+(A<<2)|0,(C=Q[716])&(B=1<<A)){for(A=n<<(31==(0|A)?0:25-(A>>>1|0)|0),C=Q[g>>2];;){if((0|n)==(-8&Q[(g=C)+4>>2]))break Q;if(B=A>>>29|0,A<<=1,!(C=Q[(B=(4&B)+g|0)+16>>2]))break}Q[B+16>>2]=r}else Q[716]=B|C,Q[g>>2]=r;Q[r+24>>2]=g,Q[r+12>>2]=r,Q[r+8>>2]=r;break C}A=Q[g+8>>2],Q[A+12>>2]=a,Q[g+8>>2]=a,Q[a+24>>2]=0,Q[a+12>>2]=g,Q[a+8>>2]=A}A=D+8|0;break A}A=Q[g+8>>2],Q[A+12>>2]=r,Q[g+8>>2]=r,Q[r+24>>2]=0,Q[r+12>>2]=g,Q[r+8>>2]=A}if(!((A=Q[718])>>>0<=t>>>0)){g=A-t|0,Q[718]=g,A=(B=Q[721])+t|0,Q[721]=A,Q[A+4>>2]=1|g,Q[B+4>>2]=3|t,A=B+8|0;break A}}Q[714]=48,A=0;break A}g:if(E){g=Q[C+28>>2];B:{if(Q[(A=3164+(g<<2)|0)>>2]==(0|C)){if(Q[A>>2]=B,B)break B;D=U(-2,g)&D,Q[716]=D;break g}if(Q[E+(Q[E+16>>2]==(0|C)?16:20)>>2]=B,!B)break g}Q[B+24>>2]=E,(A=Q[C+16>>2])&&(Q[B+16>>2]=A,Q[A+24>>2]=B),(A=Q[C+20>>2])&&(Q[B+20>>2]=A,Q[A+24>>2]=B)}g:if(n>>>0<=15)A=n+t|0,Q[C+4>>2]=3|A,Q[(A=A+C|0)+4>>2]=1|Q[A+4>>2];else if(Q[C+4>>2]=3|t,Q[(E=C+t|0)+4>>2]=1|n,Q[E+n>>2]=n,n>>>0<=255)g=2900+(-8&n)|0,(B=Q[715])&(A=1<<(n>>>3))?A=Q[g+8>>2]:(Q[715]=A|B,A=g),Q[g+8>>2]=E,Q[A+12>>2]=E,Q[E+12>>2]=g,Q[E+8>>2]=A;else{A=31,n>>>0<=16777215&&(A=n>>>8|0,A<<=r=A+1048320>>>16&8,A=28+((A=((A<<=B=A+520192>>>16&4)<<(g=A+245760>>>16&2)>>>15|0)-(g|B|r)|0)<<1|n>>>A+21&1)|0),Q[E+28>>2]=A,Q[E+16>>2]=0,Q[E+20>>2]=0,g=3164+(A<<2)|0;B:{if((B=1<<A)&D){for(A=n<<(31==(0|A)?0:25-(A>>>1|0)|0),t=Q[g>>2];;){if((-8&Q[(g=t)+4>>2])==(0|n))break B;if(B=A>>>29|0,A<<=1,!(t=Q[(B=(4&B)+g|0)+16>>2]))break}Q[B+16>>2]=E}else Q[716]=B|D,Q[g>>2]=E;Q[E+24>>2]=g,Q[E+12>>2]=E,Q[E+8>>2]=E;break g}A=Q[g+8>>2],Q[A+12>>2]=E,Q[g+8>>2]=E,Q[E+24>>2]=0,Q[E+12>>2]=g,Q[E+8>>2]=A}A=C+8|0;break A}I:if(a){g=Q[B+28>>2];g:{if(Q[(A=3164+(g<<2)|0)>>2]==(0|B)){if(Q[A>>2]=C,C)break g;Q[716]=U(-2,g)&D;break I}if(Q[a+(Q[a+16>>2]==(0|B)?16:20)>>2]=C,!C)break I}Q[C+24>>2]=a,(A=Q[B+16>>2])&&(Q[C+16>>2]=A,Q[A+24>>2]=C),(A=Q[B+20>>2])&&(Q[C+20>>2]=A,Q[A+24>>2]=C)}n>>>0<=15?(A=n+t|0,Q[B+4>>2]=3|A,Q[(A=A+B|0)+4>>2]=1|Q[A+4>>2]):(Q[B+4>>2]=3|t,Q[(C=B+t|0)+4>>2]=1|n,Q[C+n>>2]=n,c&&(g=2900+(-8&c)|0,r=Q[720],(A=1<<(c>>>3))&E?A=Q[g+8>>2]:(Q[715]=A|E,A=g),Q[g+8>>2]=r,Q[A+12>>2]=r,Q[r+12>>2]=g,Q[r+8>>2]=A),Q[720]=C,Q[717]=n),A=B+8|0}return e=I+16|0,0|A},n:function(A){var I=0,g=0,B=0,C=0,i=0,E=0,n=0;A:if(A|=0){i=(B=A-8|0)+(A=-8&(I=Q[A-4>>2]))|0;I:if(!(1&I)){if(!(3&I))break A;if((B=B-(I=Q[B>>2])|0)>>>0<o[719])break A;if(A=A+I|0,Q[720]==(0|B)){if(3==(3&(I=Q[i+4>>2])))return Q[717]=A,Q[i+4>>2]=-2&I,Q[B+4>>2]=1|A,void(Q[A+B>>2]=A)}else{if(I>>>0<=255){if(C=Q[B+8>>2],I=I>>>3|0,(0|(g=Q[B+12>>2]))==(0|C)){Q[715]=Q[715]&U(-2,I);break I}Q[C+12>>2]=g,Q[g+8>>2]=C;break I}if(n=Q[B+24>>2],(0|B)==(0|(I=Q[B+12>>2])))if((g=Q[(C=B+20|0)>>2])||(g=Q[(C=B+16|0)>>2])){for(;E=C,(g=Q[(C=(I=g)+20|0)>>2])||(C=I+16|0,g=Q[I+16>>2]););Q[E>>2]=0}else I=0;else g=Q[B+8>>2],Q[g+12>>2]=I,Q[I+8>>2]=g;if(!n)break I;C=Q[B+28>>2];g:{if(Q[(g=3164+(C<<2)|0)>>2]==(0|B)){if(Q[g>>2]=I,I)break g;Q[716]=Q[716]&U(-2,C);break I}if(Q[n+(Q[n+16>>2]==(0|B)?16:20)>>2]=I,!I)break I}if(Q[I+24>>2]=n,(g=Q[B+16>>2])&&(Q[I+16>>2]=g,Q[g+24>>2]=I),!(g=Q[B+20>>2]))break I;Q[I+20>>2]=g,Q[g+24>>2]=I}}if(!(B>>>0>=i>>>0)&&1&(I=Q[i+4>>2])){I:{if(!(2&I)){if(Q[721]==(0|i)){if(Q[721]=B,A=Q[718]+A|0,Q[718]=A,Q[B+4>>2]=1|A,Q[720]!=(0|B))break A;return Q[717]=0,void(Q[720]=0)}if(Q[720]==(0|i))return Q[720]=B,A=Q[717]+A|0,Q[717]=A,Q[B+4>>2]=1|A,void(Q[A+B>>2]=A);A=(-8&I)+A|0;g:if(I>>>0<=255){if(C=Q[i+8>>2],I=I>>>3|0,(0|(g=Q[i+12>>2]))==(0|C)){Q[715]=Q[715]&U(-2,I);break g}Q[C+12>>2]=g,Q[g+8>>2]=C}else{if(n=Q[i+24>>2],(0|i)==(0|(I=Q[i+12>>2])))if((g=Q[(C=i+20|0)>>2])||(g=Q[(C=i+16|0)>>2])){for(;E=C,(g=Q[(C=(I=g)+20|0)>>2])||(C=I+16|0,g=Q[I+16>>2]););Q[E>>2]=0}else I=0;else g=Q[i+8>>2],Q[g+12>>2]=I,Q[I+8>>2]=g;if(n){C=Q[i+28>>2];B:{if(Q[(g=3164+(C<<2)|0)>>2]==(0|i)){if(Q[g>>2]=I,I)break B;Q[716]=Q[716]&U(-2,C);break g}if(Q[n+(Q[n+16>>2]==(0|i)?16:20)>>2]=I,!I)break g}Q[I+24>>2]=n,(g=Q[i+16>>2])&&(Q[I+16>>2]=g,Q[g+24>>2]=I),(g=Q[i+20>>2])&&(Q[I+20>>2]=g,Q[g+24>>2]=I)}}if(Q[B+4>>2]=1|A,Q[A+B>>2]=A,Q[720]!=(0|B))break I;return void(Q[717]=A)}Q[i+4>>2]=-2&I,Q[B+4>>2]=1|A,Q[A+B>>2]=A}if(A>>>0<=255)return I=2900+(-8&A)|0,(g=Q[715])&(A=1<<(A>>>3))?A=Q[I+8>>2]:(Q[715]=A|g,A=I),Q[I+8>>2]=B,Q[A+12>>2]=B,Q[B+12>>2]=I,void(Q[B+8>>2]=A);C=31,A>>>0<=16777215&&(I=A>>>8|0,I<<=E=I+1048320>>>16&8,C=28+((I=((I<<=C=I+520192>>>16&4)<<(g=I+245760>>>16&2)>>>15|0)-(g|C|E)|0)<<1|A>>>I+21&1)|0),Q[B+28>>2]=C,Q[B+16>>2]=0,Q[B+20>>2]=0,E=3164+(C<<2)|0;I:{g:{if((g=Q[716])&(I=1<<C)){for(C=A<<(31==(0|C)?0:25-(C>>>1|0)|0),I=Q[E>>2];;){if(g=I,(-8&Q[I+4>>2])==(0|A))break g;if(I=C>>>29|0,C<<=1,!(I=Q[(E=g+(4&I)|0)+16>>2]))break}Q[E+16>>2]=B,Q[B+24>>2]=g}else Q[716]=I|g,Q[E>>2]=B,Q[B+24>>2]=E;Q[B+12>>2]=B,Q[B+8>>2]=B;break I}A=Q[g+8>>2],Q[A+12>>2]=B,Q[g+8>>2]=B,Q[B+24>>2]=0,Q[B+12>>2]=g,Q[B+8>>2]=A}A=Q[723]-1|0,Q[723]=A||-1}}}}}(A)}(Z)},instantiate:function(A,I){return{then:function(I){var g=new w.Module(A);I({instance:new w.Instance(g)})}}},RuntimeError:Error};D=[],"object"!=A(w)&&d("no native wasm support detected");var s,h,F,k,G,u=!1;var R,M=E.INITIAL_MEMORY||16777216;(f=E.wasmMemory?E.wasmMemory:new w.Memory({initial:M/65536,maximum:M/65536}))&&(s=f.buffer),M=s.byteLength,s=R=s,E.HEAP8=h=new Int8Array(R),E.HEAP16=new Int16Array(R),E.HEAP32=k=new Int32Array(R),E.HEAPU8=F=new Uint8Array(R),E.HEAPU16=new Uint16Array(R),E.HEAPU32=new Uint32Array(R),E.HEAPF32=new Float32Array(R),E.HEAPF64=G=new Float64Array(R);var S=[],N=[],H=[];var Y=0,p=null,U=null;function d(A){throw E.onAbort&&E.onAbort(A),c(A="Aborted("+A+")"),u=!0,1,A+=". Build with -sASSERTIONS for more info.",new w.RuntimeError(A)}var l,q,J="data:application/octet-stream;base64,";function L(A){return A.startsWith(J)}function K(A){return A.startsWith("file://")}function b(A){try{if(A==l&&D)return new Uint8Array(D);var I=P(A);if(I)return I;if(B)return B(A);throw"both async and sync fetching of the wasm failed"}catch(A){d(A)}}L(l="<<< WASM_BINARY_FILE >>>")||(q=l,l=E.locateFile?E.locateFile(q,a):a+q);var m={2088:function(){return E.getRandomValue()},2124:function(){if(void 0===E.getRandomValue)try{var I="object"===("undefined"==typeof window?"undefined":A(window))?window:self,g=void 0!==I.crypto?I.crypto:I.msCrypto,B=function(){var A=new Uint32Array(1);return g.getRandomValues(A),A[0]>>>0};B(),E.getRandomValue=B}catch(A){try{var C=eval("require")("crypto"),Q=function(){var A=C.randomBytes(4);return(A[0]<<24|A[1]<<16|A[2]<<8|A[3])>>>0};Q(),E.getRandomValue=Q}catch(A){throw"No secure random number generator found"}}}};function O(A){for(;A.length>0;)A.shift()(E)}var W=[];var j="function"==typeof atob?atob:function(A){var I,g,B,C,Q,i,E="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",o="",n=0;A=A.replace(/[^A-Za-z0-9\+\/\=]/g,"");do{I=E.indexOf(A.charAt(n++))<<2|(C=E.indexOf(A.charAt(n++)))>>4,g=(15&C)<<4|(Q=E.indexOf(A.charAt(n++)))>>2,B=(3&Q)<<6|(i=E.indexOf(A.charAt(n++))),o+=String.fromCharCode(I),64!==Q&&(o+=String.fromCharCode(g)),64!==i&&(o+=String.fromCharCode(B))}while(n<A.length);return o};function P(A){if(L(A))return function(A){if("boolean"==typeof e&&e){var I=Buffer.from(A,"base64");return new Uint8Array(I.buffer,I.byteOffset,I.byteLength)}try{for(var g=j(A),B=new Uint8Array(g.length),C=0;C<g.length;++C)B[C]=g.charCodeAt(C);return B}catch(A){throw new Error("Converting base64 string to bytes failed.")}}(A.slice(J.length))}var v,Z={b:function(A,I,g){var B=function(A,I){var g;for(W.length=0,I>>=2;g=F[A++];)I+=105!=g&I,W.push(105==g?k[I]:G[I++>>1]),++I;return W}(I,g);return m[A].apply(null,B)},c:function(A){F.length,d("OOM")},a:f};(function(){var A={a:Z};function I(A,I){var g,B=A.exports;E.asm=B,E.asm.e,g=E.asm.d,N.unshift(g),function(A){if(Y--,E.monitorRunDependencies&&E.monitorRunDependencies(Y),0==Y&&(null!==p&&(clearInterval(p),p=null),U)){var I=U;U=null,I()}}()}function B(A){I(A.instance)}function C(I){return function(){if(!D&&(r||t)){if("function"==typeof fetch&&!K(l))return fetch(l,{credentials:"same-origin"}).then((function(A){if(!A.ok)throw"failed to load wasm binary file at '"+l+"'";return A.arrayBuffer()})).catch((function(){return b(l)}));if(g)return new Promise((function(A,I){g(l,(function(I){A(new Uint8Array(I))}),I)}))}return Promise.resolve().then((function(){return b(l)}))}().then((function(I){return w.instantiate(I,A)})).then((function(A){return A})).then(I,(function(A){c("failed to asynchronously prepare wasm: "+A),d(A)}))}if(Y++,E.monitorRunDependencies&&E.monitorRunDependencies(Y),E.instantiateWasm)try{return E.instantiateWasm(A,I)}catch(A){return c("Module.instantiateWasm callback failed with error: "+A),!1}D||"function"!=typeof w.instantiateStreaming||L(l)||K(l)||e||"function"!=typeof fetch?C(B):fetch(l,{credentials:"same-origin"}).then((function(I){return w.instantiateStreaming(I,A).then(B,(function(A){return c("wasm streaming compile failed: "+A),c("falling back to ArrayBuffer instantiation"),C(B)}))}))})(),E.___wasm_call_ctors=function(){return(E.___wasm_call_ctors=E.asm.d).apply(null,arguments)},E._sphincsjs_init=function(){return(E._sphincsjs_init=E.asm.f).apply(null,arguments)},E._sphincsjs_public_key_bytes=function(){return(E._sphincsjs_public_key_bytes=E.asm.g).apply(null,arguments)},E._sphincsjs_secret_key_bytes=function(){return(E._sphincsjs_secret_key_bytes=E.asm.h).apply(null,arguments)},E._sphincsjs_signature_bytes=function(){return(E._sphincsjs_signature_bytes=E.asm.i).apply(null,arguments)},E._sphincsjs_keypair=function(){return(E._sphincsjs_keypair=E.asm.j).apply(null,arguments)},E._sphincsjs_open=function(){return(E._sphincsjs_open=E.asm.k).apply(null,arguments)},E._sphincsjs_sign=function(){return(E._sphincsjs_sign=E.asm.l).apply(null,arguments)},E._malloc=function(){return(E._malloc=E.asm.m).apply(null,arguments)},E._free=function(){return(E._free=E.asm.n).apply(null,arguments)};function X(A){this.name="ExitStatus",this.message="Program terminated with exit("+A+")",this.status=A}function z(A){function I(){v||(v=!0,E.calledRun=!0,u||(!0,O(N),E.onRuntimeInitialized&&E.onRuntimeInitialized(),function(){if(E.postRun)for("function"==typeof E.postRun&&(E.postRun=[E.postRun]);E.postRun.length;)A=E.postRun.shift(),H.unshift(A);var A;O(H)}()))}A=A||n,Y>0||(!function(){if(E.preRun)for("function"==typeof E.preRun&&(E.preRun=[E.preRun]);E.preRun.length;)A=E.preRun.shift(),S.unshift(A);var A;O(S)}(),Y>0||(E.setStatus?(E.setStatus("Running..."),setTimeout((function(){setTimeout((function(){E.setStatus("")}),1),I()}),1)):I()))}if(E.writeArrayToMemory=function(A,I){h.set(A,I)},U=function A(){v||z(),v||(U=A)},E.run=z,E.preInit)for("function"==typeof E.preInit&&(E.preInit=[E.preInit]);E.preInit.length>0;)E.preInit.pop()();return z(),new Promise((function(A,I){E.onAbort=I,E.onRuntimeInitialized=function(){A(E)}}))})).then((function(I){Object.keys(I).forEach((function(g){A[g]=I[g]}))})),A};function i(){I=Q(),A=I.ready.then((function(){I._sphincsjs_init(),g=I._sphincsjs_public_key_bytes(),B=I._sphincsjs_secret_key_bytes(),C=I._sphincsjs_signature_bytes()}))}function E(A,I){if(0===A)return I;throw new Error("SPHINCS error: "+A)}function o(A,g){return new Uint8Array(new Uint8Array(I.HEAPU8.buffer,A,g))}function n(A){try{"function"==typeof I._free&&I._free(A)}catch(A){i(),console.error("Re-initializing SPHINCS due to _free failure:",A)}}i();var r={publicKeyBytes:A.then((function(){return g})),privateKeyBytes:A.then((function(){return B})),bytes:A.then((function(){return C})),keyPair:function(C){return A.then((function(){try{var A=I._malloc(g),Q=I._malloc(B);return E(I._sphincsjs_keypair(A,Q),{publicKey:o(A,g),privateKey:o(Q,B)})}catch(A){if((C=C||0)>=2)throw A;return console.error("Ignoring error and retrying sphincs.keyPair:",A),i(),r.keyPair(C+1)}finally{n(A),n(Q)}}))},sign:function(g,Q,t){return A.then((function(){var A,e,a,D;try{var c=g.length+C;return A=I._malloc(c),e=I._malloc(8),a=I._malloc(g.length),D=I._malloc(B),I.writeArrayToMemory(g,a),I.writeArrayToMemory(Q,D),E(I._sphincsjs_sign(A,e,a,g.length,D),o(A,c))}catch(A){if((t=t||0)>=2)throw A;return console.error("Ignoring error and retrying sphincs.sign:",A),i(),r.sign(g,Q,t+1)}finally{n(A),n(e),n(a),n(D)}}))},signDetached:function(A,I){return r.sign(A,I).then((function(A){return new Uint8Array(A.buffer,0,C)}))},open:function(B,Q,t){return A.then((function(){var A,e,a,D;try{return A=I._malloc(B.length+C),e=I._malloc(8),a=I._malloc(B.length),D=I._malloc(g),I.writeArrayToMemory(B,a),I.writeArrayToMemory(Q,D),E(I._sphincsjs_open(A,e,a,B.length,D),o(A,B.length-C))}catch(A){if((t=t||0)>=2)throw A;return console.error("Ignoring error and retrying sphincs.open:",A),i(),r.open(B,Q,t+1)}finally{n(A),n(e),n(a),n(D)}}))},verifyDetached:function(I,g,B){return A.then((function(){var A=new Uint8Array(C+g.length);return A.set(I),A.set(g,C),r.open(A,B).catch((function(){})).then((function(I){try{return void 0!==I}finally{for(var g=I?[A,I]:[A],B=0;B<g.length;++B)for(var C=g[B],Q=0;Q<C.length;++Q)C[Q]=0}}))}))}};return r}(); true&&module.exports?(sphincs.sphincs=sphincs,module.exports=sphincs):self.sphincs=sphincs;
